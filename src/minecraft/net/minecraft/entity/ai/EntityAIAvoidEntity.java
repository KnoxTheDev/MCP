...
public class EntityAIAvoidEntity<T extends Entity> extends EntityAIBase
{
    ...
    {
        List<T> list = this.theEntity.worldObj.<T>getEntitiesWithinAABB(this.field_181064_i, this.theEntity.getEntityBoundingBox().expand((double)this.avoidDistance, 3.0D, (double)this.avoidDistance), Predicates.and(EntitySelectors.NOT_SPECTATING, this.canBeSeenSelector, this.avoidTargetSelector));
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    return this.entityPathEntity.isDestinationSame(vec3);
                }
            }
        }
    }
