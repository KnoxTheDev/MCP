         ...
         if (this.func_74860_a(p_74875_1_, p_74875_3_)) {
            ...
            for(int l = 1; l <= 13; ++l) {
               if ((l - 1) % 4 == 0) {
                  ...
                  this.func_175811_a(p_74875_1_, Blocks.field_150478_aa.func_176223_P(), 2, 3, l, p_74875_3_);
                  this.func_175811_a(p_74875_1_, Blocks.field_150478_aa.func_176223_P(), 11, 3, l, p_74875_3_);
                  if (this.field_75008_c) {
            ...
            if (this.field_75008_c) {
               ...
               int l1 = this.func_151555_a(Blocks.field_150468_ap, 3);
               this.func_175811_a(p_74875_1_, Blocks.field_150468_ap.func_176203_a(l1), 10, 1, 13, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_150468_ap.func_176203_a(l1), 10, 2, 13, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_150468_ap.func_176203_a(l1), 10, 3, 13, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_150468_ap.func_176203_a(l1), 10, 4, 13, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_150468_ap.func_176203_a(l1), 10, 5, 13, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_150468_ap.func_176203_a(l1), 10, 6, 13, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_150468_ap.func_176203_a(l1), 10, 7, 13, p_74875_3_);
               int i1 = 7;
               int j1 = 7;
               this.func_175811_a(p_74875_1_, Blocks.field_180407_aO.func_176223_P(), i1 - 1, 9, j1, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_180407_aO.func_176223_P(), i1, 9, j1, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_180407_aO.func_176223_P(), i1 - 1, 8, j1, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_180407_aO.func_176223_P(), i1, 8, j1, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_180407_aO.func_176223_P(), i1 - 1, 7, j1, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_180407_aO.func_176223_P(), i1, 7, j1, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_180407_aO.func_176223_P(), i1 - 2, 7, j1, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_180407_aO.func_176223_P(), i1 + 1, 7, j1, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_180407_aO.func_176223_P(), i1 - 1, 7, j1 - 1, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_180407_aO.func_176223_P(), i1 - 1, 7, j1 + 1, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_180407_aO.func_176223_P(), i1, 7, j1 - 1, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_180407_aO.func_176223_P(), i1, 7, j1 + 1, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_150478_aa.func_176223_P(), i1 - 2, 8, j1, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_150478_aa.func_176223_P(), i1 + 1, 8, j1, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_150478_aa.func_176223_P(), i1 - 1, 8, j1 - 1, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_150478_aa.func_176223_P(), i1 - 1, 8, j1 + 1, p_74875_3_);
   ...
   public static class PortalRoom extends StructureStrongholdPieces.Stronghold {
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         for(int k1 = 2; k1 < 9; k1 += 2) {
            this.func_175804_a(p_74875_1_, p_74875_3_, k1, 3, 15, k1, 4, 15, Blocks.field_150411_aY.func_176223_P(), Blocks.field_150411_aY.func_176223_P(), false);
         }

         int l1 = this.func_151555_a(Blocks.field_150390_bg, 3);
         ...
         for(int k = 4; k <= 6; ++k) {
            this.func_175811_a(p_74875_1_, Blocks.field_150390_bg.func_176203_a(l1), k, 1, 4, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150390_bg.func_176203_a(l1), k, 2, 5, p_74875_3_);
            this.func_175811_a(p_74875_1_, Blocks.field_150390_bg.func_176203_a(l1), k, 3, 6, p_74875_3_);
         }

         int i2 = EnumFacing.NORTH.func_176736_b();
         int l = EnumFacing.SOUTH.func_176736_b();
         int i1 = EnumFacing.EAST.func_176736_b();
         int j1 = EnumFacing.WEST.func_176736_b();
         if (this.field_74885_f != null) {
            switch(this.field_74885_f) {
            case SOUTH:
               i2 = EnumFacing.SOUTH.func_176736_b();
               l = EnumFacing.NORTH.func_176736_b();
               break;
            case WEST:
               i2 = EnumFacing.WEST.func_176736_b();
               l = EnumFacing.EAST.func_176736_b();
               i1 = EnumFacing.SOUTH.func_176736_b();
               j1 = EnumFacing.NORTH.func_176736_b();
               break;
            case EAST:
               i2 = EnumFacing.EAST.func_176736_b();
               l = EnumFacing.WEST.func_176736_b();
               i1 = EnumFacing.SOUTH.func_176736_b();
               j1 = EnumFacing.NORTH.func_176736_b();
            }
         }

         this.func_175811_a(p_74875_1_, Blocks.field_150378_br.func_176203_a(i2).func_177226_a(BlockEndPortalFrame.field_176507_b, Boolean.valueOf(p_74875_2_.nextFloat() > 0.9F)), 4, 3, 8, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150378_br.func_176203_a(i2).func_177226_a(BlockEndPortalFrame.field_176507_b, Boolean.valueOf(p_74875_2_.nextFloat() > 0.9F)), 5, 3, 8, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150378_br.func_176203_a(i2).func_177226_a(BlockEndPortalFrame.field_176507_b, Boolean.valueOf(p_74875_2_.nextFloat() > 0.9F)), 6, 3, 8, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150378_br.func_176203_a(l).func_177226_a(BlockEndPortalFrame.field_176507_b, Boolean.valueOf(p_74875_2_.nextFloat() > 0.9F)), 4, 3, 12, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150378_br.func_176203_a(l).func_177226_a(BlockEndPortalFrame.field_176507_b, Boolean.valueOf(p_74875_2_.nextFloat() > 0.9F)), 5, 3, 12, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150378_br.func_176203_a(l).func_177226_a(BlockEndPortalFrame.field_176507_b, Boolean.valueOf(p_74875_2_.nextFloat() > 0.9F)), 6, 3, 12, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150378_br.func_176203_a(i1).func_177226_a(BlockEndPortalFrame.field_176507_b, Boolean.valueOf(p_74875_2_.nextFloat() > 0.9F)), 3, 3, 9, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150378_br.func_176203_a(i1).func_177226_a(BlockEndPortalFrame.field_176507_b, Boolean.valueOf(p_74875_2_.nextFloat() > 0.9F)), 3, 3, 10, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150378_br.func_176203_a(i1).func_177226_a(BlockEndPortalFrame.field_176507_b, Boolean.valueOf(p_74875_2_.nextFloat() > 0.9F)), 3, 3, 11, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150378_br.func_176203_a(j1).func_177226_a(BlockEndPortalFrame.field_176507_b, Boolean.valueOf(p_74875_2_.nextFloat() > 0.9F)), 7, 3, 9, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150378_br.func_176203_a(j1).func_177226_a(BlockEndPortalFrame.field_176507_b, Boolean.valueOf(p_74875_2_.nextFloat() > 0.9F)), 7, 3, 10, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150378_br.func_176203_a(j1).func_177226_a(BlockEndPortalFrame.field_176507_b, Boolean.valueOf(p_74875_2_.nextFloat() > 0.9F)), 7, 3, 11, p_74875_3_);
         if (!this.field_75005_a) {
            ...
            if (p_74875_3_.func_175898_b(blockpos)) {
               ...
               if (tileentity instanceof TileEntityMobSpawner) {
                  ((TileEntityMobSpawner)tileentity).func_145881_a().func_98272_a("Silverfish");
               }
            }
         }
   ...
   public static class StairsStraight extends StructureStrongholdPieces.Stronghold {
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         if (this.func_74860_a(p_74875_1_, p_74875_3_)) {
            ...
            for(int j = 0; j < 6; ++j) {
               this.func_175811_a(p_74875_1_, Blocks.field_150446_ar.func_176203_a(i), 1, 6 - j, 1 + j, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_150446_ar.func_176203_a(i), 2, 6 - j, 1 + j, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_150446_ar.func_176203_a(i), 3, 6 - j, 1 + j, p_74875_3_);
               if (j < 5) {
                  this.func_175811_a(p_74875_1_, Blocks.field_150417_aV.func_176223_P(), 1, 5 - j, 1 + j, p_74875_3_);
                  this.func_175811_a(p_74875_1_, Blocks.field_150417_aV.func_176223_P(), 2, 5 - j, 1 + j, p_74875_3_);
                  this.func_175811_a(p_74875_1_, Blocks.field_150417_aV.func_176223_P(), 3, 5 - j, 1 + j, p_74875_3_);
               }
            }
