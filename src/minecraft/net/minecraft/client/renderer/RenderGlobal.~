...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener {
      ...
      if (!flag && this.field_147595_R) {
         ...
         while(!queue.isEmpty()) {
            ...
            for(EnumFacing enumfacing1 : EnumFacing.values()) {
               ...
               if ((!flag1 || !renderglobal$containerlocalrenderinformation1.field_178035_c.contains(enumfacing1.func_176734_d())) && (!flag1 || enumfacing2 == null || renderchunk3.func_178571_g().func_178495_a(enumfacing2.func_176734_d(), enumfacing1)) && renderchunk2 != null && renderchunk2.func_178577_a(p_174970_5_) && p_174970_4_.func_78546_a(renderchunk2.field_178591_c)) {
   ...
   private boolean func_174983_a(BlockPos p_174983_1_, RenderChunk p_174983_2_) {
      ...
      if (MathHelper.func_76130_a(p_174983_1_.func_177958_n() - blockpos.func_177958_n()) > 16) {
         return false;
      } else if (MathHelper.func_76130_a(p_174983_1_.func_177956_o() - blockpos.func_177956_o()) > 16) {
         return false;
      } else {
         return MathHelper.func_76130_a(p_174983_1_.func_177952_p() - blockpos.func_177952_p()) <= 16;
      }
   }
   ...
   public void func_174961_a(String p_174961_1_, BlockPos p_174961_2_) {
      ISound isound = this.field_147593_P.get(p_174961_2_);
      if (isound != null) {
      ...
      if (p_174961_1_ != null) {
         ...
         ISound positionedsoundrecord = PositionedSoundRecord.func_147675_a(new ResourceLocation(p_174961_1_), (float)p_174961_2_.func_177958_n(), (float)p_174961_2_.func_177956_o(), (float)p_174961_2_.func_177952_p());
      ...
      if (this.field_72777_q != null && this.field_72777_q.func_175606_aa() != null && this.field_72777_q.field_71452_i != null) {
         ...
         if (p_174974_2_) {
            ...
            if (d0 * d0 + d1 * d1 + d2 * d2 > 256.0D) {
               ...
               return i > 1 ? null : this.field_72777_q.field_71452_i.func_178927_a(p_174974_1_, p_174974_3_, p_174974_5_, p_174974_7_, p_174974_9_, p_174974_11_, p_174974_13_, p_174974_15_);
            }
         }
      } else {
         return null;
   ...
   public void func_180439_a(EntityPlayer p_180439_1_, int p_180439_2_, BlockPos p_180439_3_, int p_180439_4_) {
      ...
      case 2000:
         ...
         for(int k1 = 0; k1 < 10; ++k1) {
            ...
            this.func_174972_a(EnumParticleTypes.SMOKE_NORMAL, d21, d4, d6, d8, d10, d12);
         }
