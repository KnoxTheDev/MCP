...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener
{
    ...
    private boolean isPositionInRenderChunk(BlockPos pos, RenderChunk renderChunkIn)
    {
        ...
        else if (MathHelper.abs_int(pos.getY() - blockpos.getY()) > 16)
        {
            return false;
        }
        else
        {
            return MathHelper.abs_int(pos.getZ() - blockpos.getZ()) <= 16;
        }
    }
    ...
    private RenderChunk getRenderChunkOffset(BlockPos playerPos, RenderChunk renderChunkBase, EnumFacing facing)
    {
        ...
        if (MathHelper.abs_int(playerPos.getX() - blockpos.getX()) > this.renderDistanceChunks * 16)
        {
            return null;
        }
        else if (blockpos.getY() >= 0 && blockpos.getY() < 256)
        {
            return MathHelper.abs_int(playerPos.getZ() - blockpos.getZ()) > this.renderDistanceChunks * 16 ? null : this.viewFrustum.getRenderChunk(blockpos);
        }
        else
        {
            return null;
    ...
    public void playRecord(String recordName, BlockPos blockPosIn)
    {
        ...
        if (recordName != null)
        {
            ...
            ISound positionedsoundrecord = PositionedSoundRecord.create(new ResourceLocation(recordName), (float)blockPosIn.getX(), (float)blockPosIn.getY(), (float)blockPosIn.getZ());
    ...
    private EntityFX spawnEntityFX(int p_174974_1_, boolean ignoreRange, double p_174974_3_, double p_174974_5_, double p_174974_7_, double p_174974_9_, double p_174974_11_, double p_174974_13_, int... p_174974_15_)
    {
        if (this.mc != null && this.mc.getRenderViewEntity() != null && this.mc.effectRenderer != null)
        {
            ...
            else
            {
                ...
                {
                    return i > 1 ? null : this.mc.effectRenderer.spawnEffectParticle(p_174974_1_, p_174974_3_, p_174974_5_, p_174974_7_, p_174974_9_, p_174974_11_, p_174974_13_, p_174974_15_);
                }
            }
        }
        else
        ...
        switch (sfxType)
        {
            ...
            case 2000:
                ...
                for (int k1 = 0; k1 < 10; ++k1)
                {
                    ...
                    this.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, d21, d4, d6, d8, d10, d12);
                }
            ...
            case 2002:
                ...
                {
                    this.spawnParticle(EnumParticleTypes.ITEM_CRACK, d13, d14, d16, random.nextGaussian() * 0.15D, random.nextDouble() * 0.2D, random.nextGaussian() * 0.15D, Item.getIdFromItem(Items.potionitem), p_180439_4_);
                }
                ...
                for (int l1 = 0; l1 < 100; ++l1)
                {
                    ...
                    EntityFX entityfx = this.spawnEntityFX(enumparticletypes.getParticleID(), enumparticletypes.getShouldIgnoreRange(), d13 + d24 * 0.1D, d14 + 0.3D, d16 + d11 * 0.1D, d24, d9, d11);
            ...
            case 2003:
                ...
                {
                    this.spawnParticle(EnumParticleTypes.PORTAL, d0 + Math.cos(d18) * 5.0D, d1 - 0.4D, d2 + Math.sin(d18) * 5.0D, Math.cos(d18) * -5.0D, 0.0D, Math.sin(d18) * -5.0D);
                    this.spawnParticle(EnumParticleTypes.PORTAL, d0 + Math.cos(d18) * 5.0D, d1 - 0.4D, d2 + Math.sin(d18) * 5.0D, Math.cos(d18) * -7.0D, 0.0D, Math.sin(d18) * -7.0D);
                }
    ...
    public void updateTileEntities(Collection<TileEntity> p_181023_1_, Collection<TileEntity> p_181023_2_)
    {
        synchronized (this.setTileEntities)
        {
