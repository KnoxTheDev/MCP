...
public class SpectatorMenu
{
    ...
    public ISpectatorMenuObject func_178643_a(int p_178643_1_)
    {
        ...
        {
            return i >= 0 && i < this.field_178659_h.func_178669_a().size() ? (ISpectatorMenuObject)Objects.firstNonNull(this.field_178659_h.func_178669_a().get(i), field_178657_a) : field_178657_a;
        }
    }
