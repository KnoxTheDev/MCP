...
public class KeyBinding implements Comparable<KeyBinding> {
   ...
   public int compareTo(KeyBinding p_compareTo_1_) {
      int i = I18n.func_135052_a(this.field_151471_f).compareTo(I18n.func_135052_a(p_compareTo_1_.field_151471_f));
      if (i == 0) {
         i = I18n.func_135052_a(this.field_74515_c).compareTo(I18n.func_135052_a(p_compareTo_1_.field_74515_c));
      }
