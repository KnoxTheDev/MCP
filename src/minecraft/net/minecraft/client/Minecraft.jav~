...
public class Minecraft implements IThreadListener, IPlayerUsage {
   ...
   private void func_71384_a() throws LWJGLException, IOException {
      ...
      AchievementList.field_76004_f.func_75988_a(new IStatStringFormat() {
         public String func_74535_a(String p_74535_1_) {
            try {
               return String.format(p_74535_1_, GameSettings.func_74298_c(Minecraft.this.field_71474_y.field_151445_Q.func_151463_i()));
   ...
   private void func_180510_a(TextureManager p_180510_1_) throws LWJGLException {
      ...
      try {
         ...
         field_147123_G.error("Unable to load logo: " + field_110444_H, (Throwable)ioexception);
      } finally {
         IOUtils.closeQuietly(inputstream);
      }
   ...
   public void func_70001_b(PlayerUsageSnooper p_70001_1_) {
      ...
      p_70001_1_.func_152767_b("gl_caps[gl_max_vertex_uniforms]", Integer.valueOf(GL11.glGetInteger(35658)));
      GL11.glGetError();
      p_70001_1_.func_152767_b("gl_caps[gl_max_fragment_uniforms]", Integer.valueOf(GL11.glGetInteger(35657)));
      GL11.glGetError();
      p_70001_1_.func_152767_b("gl_caps[gl_max_vertex_attribs]", Integer.valueOf(GL11.glGetInteger(34921)));
      GL11.glGetError();
      p_70001_1_.func_152767_b("gl_caps[gl_max_vertex_texture_image_units]", Integer.valueOf(GL11.glGetInteger(35660)));
      GL11.glGetError();
      p_70001_1_.func_152767_b("gl_caps[gl_max_texture_image_units]", Integer.valueOf(GL11.glGetInteger(34930)));
      GL11.glGetError();
