...
public class PlayerManager
{
    ...
    private final LongHashMap<PlayerManager.PlayerInstance> playerInstances = new LongHashMap<PlayerManager.PlayerInstance>();
    ...
    public void updatePlayerInstances()
    {
        ...
        else
        {
            ...
            {
                PlayerManager.PlayerInstance playermanager$playerinstance1 = this.playerInstancesToUpdate.get(k);
