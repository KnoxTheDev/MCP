...
public class BlockRailDetector extends BlockRailBase {
   ...
   public int func_176211_b(IBlockAccess p_176211_1_, BlockPos p_176211_2_, IBlockState p_176211_3_, EnumFacing p_176211_4_) {
      if (!((Boolean)p_176211_3_.func_177229_b(field_176574_M)).booleanValue()) {
         return 0;
      } else {
   ...
   public int func_180641_l(World p_180641_1_, BlockPos p_180641_2_) {
      if (((Boolean)p_180641_1_.func_180495_p(p_180641_2_).func_177229_b(field_176574_M)).booleanValue()) {
         List<EntityMinecartCommandBlock> list = this.<EntityMinecartCommandBlock>func_176571_a(p_180641_1_, p_180641_2_, EntityMinecartCommandBlock.class);
         if (!list.isEmpty()) {
            return ((EntityMinecartCommandBlock)list.get(0)).func_145822_e().func_145760_g();
         }

         List<EntityMinecart> list1 = this.<EntityMinecart>func_176571_a(p_180641_1_, p_180641_2_, EntityMinecart.class, EntitySelectors.field_96566_b);
         if (!list1.isEmpty()) {
