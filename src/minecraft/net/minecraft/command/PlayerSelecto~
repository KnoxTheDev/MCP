...
public class PlayerSelector {
   ...
   private static final Set<String> field_179666_d = Sets.newHashSet("x", "y", "z", "dx", "dy", "dz", "rm", "r");
         ...
         if (!p_179660_0_.containsKey("dx") && !p_179660_0_.containsKey("dy") && !p_179660_0_.containsKey("dz")) {
            ...
            if (flag && flag2 && !flag1) {
               Predicate<Entity> predicate2 = new Predicate<Entity>() {
                  public boolean apply(Entity p_apply_1_) {
                     if (p_apply_1_.field_70165_t >= axisalignedbb.field_72340_a && p_apply_1_.field_70163_u >= axisalignedbb.field_72338_b && p_apply_1_.field_70161_v >= axisalignedbb.field_72339_c) {
                        return p_apply_1_.field_70165_t < axisalignedbb.field_72336_d && p_apply_1_.field_70163_u < axisalignedbb.field_72337_e && p_apply_1_.field_70161_v < axisalignedbb.field_72334_f;
                     } else {
                        return false;
                     }
                  }
