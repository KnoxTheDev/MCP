...
public abstract class CommandBase implements ICommand
{
    ...
    {
        return (List<Entity>)(PlayerSelector.hasArguments(p_175763_1_) ? PlayerSelector.matchEntities(p_175763_0_, p_175763_1_, Entity.class) : Lists.newArrayList(func_175768_b(p_175763_0_, p_175763_1_)));
    }
