...
public class CommandScoreboard extends CommandBase {
   ...
   protected void func_147193_c(ICommandSender p_147193_1_, String[] p_147193_2_, int p_147193_3_) throws CommandException {
      ...
      Scoreboard scoreboard = this.func_147192_d();
      IScoreObjectiveCriteria iscoreobjectivecriteria = IScoreObjectiveCriteria.field_96643_a.get(s1);
   ...
   protected void func_147186_g(ICommandSender p_147186_1_, String[] p_147186_2_, int p_147186_3_) throws CommandException {
      ...
      if (p_147186_2_.length > p_147186_3_) {
         ...
         ChatComponentTranslation chatcomponenttranslation = new ChatComponentTranslation("commands.scoreboard.teams.list.player.count", new Object[]{collection.size(), scoreplayerteam.func_96661_b()});
         ...
         for(ScorePlayerTeam scoreplayerteam1 : collection1) {
            p_147186_1_.func_145747_a(new ChatComponentTranslation("commands.scoreboard.teams.list.entry", new Object[]{scoreplayerteam1.func_96661_b(), scoreplayerteam1.func_96669_c(), scoreplayerteam1.func_96670_d().size()}));
         }
      }
   ...
   protected void func_147190_h(ICommandSender p_147190_1_, String[] p_147190_2_, int p_147190_3_) throws CommandException {
      ...
      if (!set.isEmpty()) {
         ...
         func_152373_a(p_147190_1_, this, "commands.scoreboard.teams.join.success", new Object[]{set.size(), s, func_71527_a(set.toArray(new String[set.size()]))});
      }
   ...
   protected void func_147199_i(ICommandSender p_147199_1_, String[] p_147199_2_, int p_147199_3_) throws CommandException {
      ...
      if (!set.isEmpty()) {
         ...
         func_152373_a(p_147199_1_, this, "commands.scoreboard.teams.leave.success", new Object[]{set.size(), func_71527_a(set.toArray(new String[set.size()]))});
      }
   ...
   protected void func_147188_j(ICommandSender p_147188_1_, String[] p_147188_2_, int p_147188_3_) throws CommandException {
      ...
      if (scoreplayerteam != null) {
         ...
         if (collection.isEmpty()) {
            ...
            func_152373_a(p_147188_1_, this, "commands.scoreboard.teams.empty.success", new Object[]{collection.size(), scoreplayerteam.func_96661_b()});
         }
      }
   }
   ...
   protected void func_147195_l(ICommandSender p_147195_1_, String[] p_147195_2_, int p_147195_3_) throws CommandException {
      ...
      if (p_147195_2_.length > p_147195_3_) {
         ...
         for(Score score : map.values()) {
            p_147195_1_.func_145747_a(new ChatComponentTranslation("commands.scoreboard.players.list.player.entry", new Object[]{score.func_96652_c(), score.func_96645_d().func_96678_d(), score.func_96645_d().func_96679_b()}));
         }
      } else {
   ...
   protected void func_147197_m(ICommandSender p_147197_1_, String[] p_147197_2_, int p_147197_3_) throws CommandException {
      ...
      if (s1.length() > 40) {
         ...
         func_152373_a(p_147197_1_, this, "commands.scoreboard.players.set.success", new Object[]{scoreobjective.func_96679_b(), s1, score.func_96652_c()});
      }
   }
      ...
      if (s.length() > 40) {
         ...
         if (!scoreboard.func_178819_b(s, scoreobjective)) {
            ...
            if (score.func_96652_c() >= i && score.func_96652_c() <= j) {
               func_152373_a(p_175781_1_, this, "commands.scoreboard.players.test.success", new Object[]{score.func_96652_c(), i, j});
            } else {
   ...
   public boolean func_82358_a(String[] p_82358_1_, int p_82358_2_) {
      ...
      } else if (p_82358_1_.length > 1 && p_82358_1_[1].equalsIgnoreCase("operation")) {
