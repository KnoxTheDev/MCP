      ...
      if (p_71515_2_.length < 1) {
         ...
         if (p_71515_2_.length != 1 && p_71515_2_.length != 2) {
            if (p_71515_2_.length < i + 3) {
               ...
               CommandBase.CoordinateArg commandbase$coordinatearg1 = func_175767_a(entity.field_70163_u, p_71515_2_[j++], 0, 0, false);
               CommandBase.CoordinateArg commandbase$coordinatearg2 = func_175770_a(entity.field_70161_v, p_71515_2_[j++], true);
               CommandBase.CoordinateArg commandbase$coordinatearg3 = func_175770_a((double)entity.field_70177_z, p_71515_2_.length > j ? p_71515_2_[j++] : "~", false);
               CommandBase.CoordinateArg commandbase$coordinatearg4 = func_175770_a((double)entity.field_70125_A, p_71515_2_.length > j ? p_71515_2_[j] : "~", false);
               ...
               func_152373_a(p_71515_1_, this, "commands.tp.success.coordinates", new Object[]{entity.func_70005_c_(), commandbase$coordinatearg.func_179628_a(), commandbase$coordinatearg1.func_179628_a(), commandbase$coordinatearg2.func_179628_a()});
            }
         } else {
