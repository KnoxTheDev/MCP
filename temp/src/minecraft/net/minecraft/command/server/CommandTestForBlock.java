...
public class CommandTestForBlock extends CommandBase {
            ...
            if (!world.func_175667_e(blockpos)) {
               ...
               if (block1 != block) {
                  ...
                  if (i > -1) {
                     ...
                     if (j != i) {
                        throw new CommandException("commands.testforblock.failed.data", new Object[]{blockpos.func_177958_n(), blockpos.func_177956_o(), blockpos.func_177952_p(), j, i});
                     }
                  }
                  ...
                  func_152373_a(p_71515_1_, this, "commands.testforblock.success", new Object[]{blockpos.func_177958_n(), blockpos.func_177956_o(), blockpos.func_177952_p()});
               }
            }
         }
      }
   ...
   public List<String> func_180525_a(ICommandSender p_180525_1_, String[] p_180525_2_, BlockPos p_180525_3_) {
      if (p_180525_2_.length > 0 && p_180525_2_.length <= 3) {
         ...
         return p_180525_2_.length == 4 ? func_175762_a(p_180525_2_, Block.field_149771_c.func_148742_b()) : null;
      }
   }
}
