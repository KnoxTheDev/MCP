...
public class CommandListBans extends CommandBase {
   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) throws CommandException {
      if (p_71515_2_.length >= 1 && p_71515_2_[0].equalsIgnoreCase("ips")) {
         p_71515_1_.func_145747_a(new ChatComponentTranslation("commands.banlist.ips", new Object[]{MinecraftServer.func_71276_C().func_71203_ab().func_72363_f().func_152685_a().length}));
         ...
         p_71515_1_.func_145747_a(new ChatComponentTranslation("commands.banlist.players", new Object[]{MinecraftServer.func_71276_C().func_71203_ab().func_152608_h().func_152685_a().length}));
