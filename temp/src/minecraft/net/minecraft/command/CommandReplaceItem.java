      ...
      if (p_71515_2_.length < 1) {
         ...
         if (flag) {
            ...
            if (!entity.func_174820_d(j, itemstack)) {
               throw new CommandException("commands.replaceitem.failed", new Object[]{j, k, itemstack == null ? "Air" : itemstack.func_151000_E()});
            }
         ...
         func_152373_a(p_71515_1_, this, "commands.replaceitem.success", new Object[]{j, k, itemstack == null ? "Air" : itemstack.func_151000_E()});
      }
   }
