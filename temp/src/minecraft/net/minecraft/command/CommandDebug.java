...
public class CommandDebug extends CommandBase {
   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) throws CommandException {
      if (p_71515_2_.length < 1) {
         ...
         if (p_71515_2_[0].equals("start")) {
            ...
            func_152373_a(p_71515_1_, this, "commands.debug.stop", new Object[]{(float)k / 1000.0F, l});
         }
   ...
   private String func_147204_b(long p_147204_1_, int p_147204_3_) {
      ...
      stringbuilder.append("// This is approximately ").append(String.format("%.2f", (float)p_147204_3_ / ((float)p_147204_1_ / 1000.0F))).append(" ticks per second. It should be ").append((int)20).append(" ticks per second\n\n");
