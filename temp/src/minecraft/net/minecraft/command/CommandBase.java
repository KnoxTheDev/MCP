...
public abstract class CommandBase implements ICommand {
   ...
   public static double func_175756_a(String p_175756_0_, double p_175756_1_, double p_175756_3_) throws NumberInvalidException {
      ...
      if (d0 < p_175756_1_) {
         throw new NumberInvalidException("commands.generic.double.tooSmall", new Object[]{d0, p_175756_1_});
      } else if (d0 > p_175756_3_) {
         throw new NumberInvalidException("commands.generic.double.tooBig", new Object[]{d0, p_175756_3_});
      } else {
         return d0;
      }
   }
   ...
   public static List<Entity> func_175763_c(ICommandSender p_175763_0_, String p_175763_1_) throws EntityNotFoundException {
      return (List<Entity>)(PlayerSelector.func_82378_b(p_175763_1_) ? PlayerSelector.func_179656_b(p_175763_0_, p_175763_1_, Entity.class) : Lists.newArrayList(func_175768_b(p_175763_0_, p_175763_1_)));
   }
      ...
      if (flag && Double.isNaN(p_175767_0_)) {
         ...
         if (p_175767_3_ != 0 || p_175767_4_ != 0) {
            if (d0 < (double)p_175767_3_) {
               throw new NumberInvalidException("commands.generic.double.tooSmall", new Object[]{d0, p_175767_3_});
            }

            if (d0 > (double)p_175767_4_) {
               throw new NumberInvalidException("commands.generic.double.tooBig", new Object[]{d0, p_175767_4_});
            }
         }
      ...
      if (flag && Double.isNaN(p_175769_0_)) {
         ...
         if (p_175769_3_ != 0 || p_175769_4_ != 0) {
            if (d0 < (double)p_175769_3_) {
               throw new NumberInvalidException("commands.generic.double.tooSmall", new Object[]{d0, p_175769_3_});
            }

            if (d0 > (double)p_175769_4_) {
               throw new NumberInvalidException("commands.generic.double.tooBig", new Object[]{d0, p_175769_4_});
            }
         }
   ...
   public static IChatComponent func_180530_a(List<IChatComponent> p_180530_0_) {
      ...
      for(int i = 0; i < p_180530_0_.size(); ++i) {
         ...
         ichatcomponent.func_150257_a(p_180530_0_.get(i));
      }
