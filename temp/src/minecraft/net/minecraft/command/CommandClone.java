...
public class CommandClone extends CommandBase {
               ...
               if (structureboundingbox.field_78895_b >= 0 && structureboundingbox.field_78894_e < 256 && structureboundingbox1.field_78895_b >= 0 && structureboundingbox1.field_78894_e < 256) {
                  ...
                  if (world.func_175711_a(structureboundingbox) && world.func_175711_a(structureboundingbox1)) {
                     ...
                     if (i <= 0) {
                        ...
                        func_152373_a(p_71515_1_, this, "commands.clone.success", new Object[]{i});
                     }
                  } else {
   ...
   public List<String> func_180525_a(ICommandSender p_180525_1_, String[] p_180525_2_, BlockPos p_180525_3_) {
      ...
      } else if (p_180525_2_.length == 10) {
         return func_71530_a(p_180525_2_, new String[]{"replace", "masked", "filtered"});
      } else if (p_180525_2_.length == 11) {
         return func_71530_a(p_180525_2_, new String[]{"normal", "force", "move"});
      } else {
         return p_180525_2_.length == 12 && "filtered".equals(p_180525_2_[9]) ? func_175762_a(p_180525_2_, Block.field_149771_c.func_148742_b()) : null;
      }
   }
