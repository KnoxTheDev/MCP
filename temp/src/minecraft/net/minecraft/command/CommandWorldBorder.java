...
public class CommandWorldBorder extends CommandBase {
      ...
      if (p_71515_2_.length < 1) {
         ...
         if (p_71515_2_[0].equals("set")) {
            ...
            if (i > 0L) {
               ...
               if (d0 > d2) {
                  func_152373_a(p_71515_1_, this, "commands.worldborder.setSlowly.shrink.success", new Object[]{String.format("%.1f", d2), String.format("%.1f", d0), Long.toString(i / 1000L)});
               } else {
                  func_152373_a(p_71515_1_, this, "commands.worldborder.setSlowly.grow.success", new Object[]{String.format("%.1f", d2), String.format("%.1f", d0), Long.toString(i / 1000L)});
               }
            } else {
               worldborder.func_177750_a(d2);
               func_152373_a(p_71515_1_, this, "commands.worldborder.set.success", new Object[]{String.format("%.1f", d2), String.format("%.1f", d0)});
            }
            ...
            if (i1 > 0L) {
               ...
               if (d4 > d8) {
                  func_152373_a(p_71515_1_, this, "commands.worldborder.setSlowly.shrink.success", new Object[]{String.format("%.1f", d8), String.format("%.1f", d4), Long.toString(i1 / 1000L)});
               } else {
                  func_152373_a(p_71515_1_, this, "commands.worldborder.setSlowly.grow.success", new Object[]{String.format("%.1f", d8), String.format("%.1f", d4), Long.toString(i1 / 1000L)});
               }
            } else {
               worldborder.func_177750_a(d8);
               func_152373_a(p_71515_1_, this, "commands.worldborder.set.success", new Object[]{String.format("%.1f", d8), String.format("%.1f", d4)});
            }
            ...
            func_152373_a(p_71515_1_, this, "commands.worldborder.center.success", new Object[]{d1, d3});
            ...
            if (p_71515_2_[1].equals("buffer")) {
               ...
               func_152373_a(p_71515_1_, this, "commands.worldborder.damage.buffer.success", new Object[]{String.format("%.1f", d5), String.format("%.1f", d9)});
               ...
               func_152373_a(p_71515_1_, this, "commands.worldborder.damage.amount.success", new Object[]{String.format("%.2f", d6), String.format("%.2f", d10)});
            }
            ...
            if (p_71515_2_[1].equals("time")) {
               ...
               func_152373_a(p_71515_1_, this, "commands.worldborder.warning.time.success", new Object[]{j, k});
               ...
               func_152373_a(p_71515_1_, this, "commands.worldborder.warning.distance.success", new Object[]{j, l});
            }
         } else {
            ...
            p_71515_1_.func_145747_a(new ChatComponentTranslation("commands.worldborder.get.success", new Object[]{String.format("%.0f", d7)}));
         }
   ...
   public List<String> func_180525_a(ICommandSender p_180525_1_, String[] p_180525_2_, BlockPos p_180525_3_) {
      if (p_180525_2_.length == 1) {
         return func_71530_a(p_180525_2_, new String[]{"set", "center", "damage", "warning", "add", "get"});
      } else if (p_180525_2_.length == 2 && p_180525_2_[0].equals("damage")) {
         return func_71530_a(p_180525_2_, new String[]{"buffer", "amount"});
      } else if (p_180525_2_.length >= 2 && p_180525_2_.length <= 3 && p_180525_2_[0].equals("center")) {
         return func_181043_b(p_180525_2_, 1, p_180525_3_);
      } else {
         return p_180525_2_.length == 2 && p_180525_2_[0].equals("warning") ? func_71530_a(p_180525_2_, new String[]{"time", "distance"}) : null;
      }
   }
}
