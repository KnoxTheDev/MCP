...
public class CommandSetSpawnpoint extends CommandBase {
   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) throws CommandException {
      if (p_71515_2_.length > 1 && p_71515_2_.length < 4) {
         ...
         if (entityplayermp.field_70170_p != null) {
            ...
            func_152373_a(p_71515_1_, this, "commands.spawnpoint.success", new Object[]{entityplayermp.func_70005_c_(), blockpos.func_177958_n(), blockpos.func_177956_o(), blockpos.func_177952_p()});
         }
   ...
   public List<String> func_180525_a(ICommandSender p_180525_1_, String[] p_180525_2_, BlockPos p_180525_3_) {
      if (p_180525_2_.length == 1) {
         ...
         return p_180525_2_.length > 1 && p_180525_2_.length <= 4 ? func_175771_a(p_180525_2_, 1, p_180525_3_) : null;
      }
   }
