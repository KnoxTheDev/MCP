...
public class CommandSpreadPlayers extends CommandBase {
   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) throws CommandException {
      if (p_71515_2_.length < 6) {
         ...
         if (list.isEmpty()) {
            ...
            p_71515_1_.func_145747_a(new ChatComponentTranslation("commands.spreadplayers.spreading." + (flag ? "teams" : "players"), new Object[]{list.size(), d3, d0, d1, d2}));
            this.func_110669_a(p_71515_1_, list, new CommandSpreadPlayers.Position(d0, d1), d2, d3, (list.get(0)).field_70170_p, flag);
         }
      }
   }
   ...
   private void func_110669_a(ICommandSender p_110669_1_, List<Entity> p_110669_2_, CommandSpreadPlayers.Position p_110669_3_, double p_110669_4_, double p_110669_6_, World p_110669_8_, boolean p_110669_9_) throws CommandException {
      ...
      if (acommandspreadplayers$position.length > 1) {
         p_110669_1_.func_145747_a(new ChatComponentTranslation("commands.spreadplayers.info." + (p_110669_9_ ? "teams" : "players"), new Object[]{String.format("%.2f", d4), i}));
      }
