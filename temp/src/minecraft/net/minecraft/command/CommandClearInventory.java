   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) throws CommandException {
      ...
      if (p_71515_2_.length >= 2 && item == null) {
         ...
         if (k == 0) {
            ...
            if (j == 0) {
               p_71515_1_.func_145747_a(new ChatComponentTranslation("commands.clear.testing", new Object[]{entityplayermp.func_70005_c_(), k}));
            } else {
               func_152373_a(p_71515_1_, this, "commands.clear.success", new Object[]{entityplayermp.func_70005_c_(), k});
            }
