...
public class BlockSponge extends Block {
   ...
   public void func_180655_c(World p_180655_1_, BlockPos p_180655_2_, IBlockState p_180655_3_, Random p_180655_4_) {
      if (((Boolean)p_180655_3_.func_177229_b(field_176313_a)).booleanValue()) {
         ...
         if (enumfacing != EnumFacing.UP && !World.func_175683_a(p_180655_1_, p_180655_2_.func_177972_a(enumfacing))) {
            ...
            p_180655_1_.func_175688_a(EnumParticleTypes.DRIP_WATER, d0, d1, d2, 0.0D, 0.0D, 0.0D);
         }
      }
   }
}
