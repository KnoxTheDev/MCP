...
public class Block {
   ...
   public boolean func_176225_a(IBlockAccess p_176225_1_, BlockPos p_176225_2_, EnumFacing p_176225_3_) {
      if (p_176225_3_ == EnumFacing.DOWN && this.field_149760_C > 0.0D) {
         return true;
      } else if (p_176225_3_ == EnumFacing.UP && this.field_149756_F < 1.0D) {
         return true;
      } else if (p_176225_3_ == EnumFacing.NORTH && this.field_149754_D > 0.0D) {
         return true;
      } else if (p_176225_3_ == EnumFacing.SOUTH && this.field_149757_G < 1.0D) {
         return true;
      } else if (p_176225_3_ == EnumFacing.WEST && this.field_149759_B > 0.0D) {
         return true;
      } else if (p_176225_3_ == EnumFacing.EAST && this.field_149755_E < 1.0D) {
         return true;
      } else {
         return !p_176225_1_.func_180495_p(p_176225_2_).func_177230_c().func_149662_c();
      }
   }
   ...
   public float func_180647_a(EntityPlayer p_180647_1_, World p_180647_2_, BlockPos p_180647_3_) {
      ...
      if (f < 0.0F) {
         ...
         return !p_180647_1_.func_146099_a(this) ? p_180647_1_.func_180471_a(this) / f / 100.0F : p_180647_1_.func_180471_a(this) / f / 30.0F;
      }
   }
   ...
   private boolean func_149654_a(Vec3 p_149654_1_) {
      if (p_149654_1_ == null) {
         ...
         return p_149654_1_.field_72448_b >= this.field_149760_C && p_149654_1_.field_72448_b <= this.field_149756_F && p_149654_1_.field_72449_c >= this.field_149754_D && p_149654_1_.field_72449_c <= this.field_149757_G;
      }
   }
   ...
   private boolean func_149687_b(Vec3 p_149687_1_) {
      if (p_149687_1_ == null) {
         ...
         return p_149687_1_.field_72450_a >= this.field_149759_B && p_149687_1_.field_72450_a <= this.field_149755_E && p_149687_1_.field_72449_c >= this.field_149754_D && p_149687_1_.field_72449_c <= this.field_149757_G;
      }
   }
   ...
   private boolean func_149661_c(Vec3 p_149661_1_) {
      if (p_149661_1_ == null) {
         ...
         return p_149661_1_.field_72450_a >= this.field_149759_B && p_149661_1_.field_72450_a <= this.field_149755_E && p_149661_1_.field_72448_b >= this.field_149760_C && p_149661_1_.field_72448_b <= this.field_149756_F;
      }
   }
