...
public class BlockPistonStructureHelper {
   ...
   public boolean func_177253_a() {
      ...
      Block block = this.field_177261_a.func_180495_p(this.field_177260_c).func_177230_c();
   ...
   private boolean func_177251_a(BlockPos p_177251_1_) {
      ...
      if (block.func_149688_o() == Material.field_151579_a) {
         return true;
      } else if (!BlockPistonBase.func_180696_a(block, this.field_177261_a, p_177251_1_, this.field_177257_d, false)) {
         return true;
         ...
         if (i + this.field_177258_e.size() > 12) {
            ...
            while(true) {
               ...
               if (!BlockPistonBase.func_180696_a(block, this.field_177261_a, blockpos1, this.field_177257_d, true) || blockpos1.equals(this.field_177259_b)) {
                  return false;
               }
