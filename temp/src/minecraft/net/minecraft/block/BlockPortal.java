...
public class BlockPortal extends BlockBreakable {
   ...
   public boolean func_176225_a(IBlockAccess p_176225_1_, BlockPos p_176225_2_, EnumFacing p_176225_3_) {
      ...
      if (flag4 && p_176225_3_ == EnumFacing.WEST) {
         return true;
      } else if (flag4 && p_176225_3_ == EnumFacing.EAST) {
         return true;
      } else if (flag5 && p_176225_3_ == EnumFacing.NORTH) {
         return true;
      } else {
         return flag5 && p_176225_3_ == EnumFacing.SOUTH;
      }
   }
   ...
   public void func_180655_c(World p_180655_1_, BlockPos p_180655_2_, IBlockState p_180655_3_, Random p_180655_4_) {
      ...
      for(int i = 0; i < 4; ++i) {
         ...
         p_180655_1_.func_175688_a(EnumParticleTypes.PORTAL, d0, d1, d2, d3, d4, d5);
      }
