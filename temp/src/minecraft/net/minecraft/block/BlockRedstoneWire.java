...
public class BlockRedstoneWire extends Block {
   ...
   private boolean func_176339_d(IBlockAccess p_176339_1_, BlockPos p_176339_2_, EnumFacing p_176339_3_) {
      ...
      if (!flag1 && flag && func_176340_e(p_176339_1_, blockpos.func_177984_a())) {
         ...
         return true;
      } else if (block == Blocks.field_150416_aS && iblockstate.func_177229_b(BlockRedstoneDiode.field_176387_N) == p_176339_3_) {
         return true;
      } else {
   ...
   public void func_180655_c(World p_180655_1_, BlockPos p_180655_2_, IBlockState p_180655_3_, Random p_180655_4_) {
      ...
      if (i != 0) {
         ...
         p_180655_1_.func_175688_a(EnumParticleTypes.REDSTONE, d0, d1, d2, (double)f1, (double)f2, (double)f3);
      }
   }
