...
public abstract class BlockSlab extends Block {
   ...
   public boolean func_176225_a(IBlockAccess p_176225_1_, BlockPos p_176225_2_, EnumFacing p_176225_3_) {
      if (this.func_176552_j()) {
         ...
         if (flag1) {
            if (p_176225_3_ == EnumFacing.DOWN) {
               return true;
            } else if (p_176225_3_ == EnumFacing.UP && super.func_176225_a(p_176225_1_, p_176225_2_, p_176225_3_)) {
               return true;
            } else {
               return !func_150003_a(iblockstate.func_177230_c()) || !flag;
            }
         } else if (p_176225_3_ == EnumFacing.UP) {
            return true;
         } else if (p_176225_3_ == EnumFacing.DOWN && super.func_176225_a(p_176225_1_, p_176225_2_, p_176225_3_)) {
            return true;
         } else {
            return !func_150003_a(iblockstate.func_177230_c()) || flag;
         }
