...
public class BlockFire extends Block {
   ...
   public IBlockState func_176221_a(IBlockState p_176221_1_, IBlockAccess p_176221_2_, BlockPos p_176221_3_) {
      int i = p_176221_3_.func_177958_n();
         ...
         if (!flag && p_180650_1_.func_72896_J() && this.func_176537_d(p_180650_1_, p_180650_2_)) {
            ...
            if (!flag) {
               if (!this.func_176533_e(p_180650_1_, p_180650_2_)) {
                  if (!World.func_175683_a(p_180650_1_, p_180650_2_.func_177977_b()) || i > 3) {
                     p_180650_1_.func_175698_g(p_180650_2_);
                  }
   ...
   public void func_180655_c(World p_180655_1_, BlockPos p_180655_2_, IBlockState p_180655_3_, Random p_180655_4_) {
      ...
      if (!World.func_175683_a(p_180655_1_, p_180655_2_.func_177977_b()) && !Blocks.field_150480_ab.func_176535_e(p_180655_1_, p_180655_2_.func_177977_b())) {
         if (Blocks.field_150480_ab.func_176535_e(p_180655_1_, p_180655_2_.func_177976_e())) {
            for(int j = 0; j < 2; ++j) {
               double d3 = (double)p_180655_2_.func_177958_n() + p_180655_4_.nextDouble() * 0.10000000149011612D;
               double d8 = (double)p_180655_2_.func_177956_o() + p_180655_4_.nextDouble();
               double d13 = (double)p_180655_2_.func_177952_p() + p_180655_4_.nextDouble();
               p_180655_1_.func_175688_a(EnumParticleTypes.SMOKE_LARGE, d3, d8, d13, 0.0D, 0.0D, 0.0D);
            }
         }

         if (Blocks.field_150480_ab.func_176535_e(p_180655_1_, p_180655_2_.func_177974_f())) {
            for(int k = 0; k < 2; ++k) {
               double d4 = (double)(p_180655_2_.func_177958_n() + 1) - p_180655_4_.nextDouble() * 0.10000000149011612D;
               double d9 = (double)p_180655_2_.func_177956_o() + p_180655_4_.nextDouble();
               double d14 = (double)p_180655_2_.func_177952_p() + p_180655_4_.nextDouble();
               p_180655_1_.func_175688_a(EnumParticleTypes.SMOKE_LARGE, d4, d9, d14, 0.0D, 0.0D, 0.0D);
            }
         }

         if (Blocks.field_150480_ab.func_176535_e(p_180655_1_, p_180655_2_.func_177978_c())) {
            for(int l = 0; l < 2; ++l) {
               double d5 = (double)p_180655_2_.func_177958_n() + p_180655_4_.nextDouble();
               double d10 = (double)p_180655_2_.func_177956_o() + p_180655_4_.nextDouble();
               double d15 = (double)p_180655_2_.func_177952_p() + p_180655_4_.nextDouble() * 0.10000000149011612D;
               p_180655_1_.func_175688_a(EnumParticleTypes.SMOKE_LARGE, d5, d10, d15, 0.0D, 0.0D, 0.0D);
            }
         }

         if (Blocks.field_150480_ab.func_176535_e(p_180655_1_, p_180655_2_.func_177968_d())) {
            for(int i1 = 0; i1 < 2; ++i1) {
               double d6 = (double)p_180655_2_.func_177958_n() + p_180655_4_.nextDouble();
               double d11 = (double)p_180655_2_.func_177956_o() + p_180655_4_.nextDouble();
               double d16 = (double)(p_180655_2_.func_177952_p() + 1) - p_180655_4_.nextDouble() * 0.10000000149011612D;
               p_180655_1_.func_175688_a(EnumParticleTypes.SMOKE_LARGE, d6, d11, d16, 0.0D, 0.0D, 0.0D);
            }
         }

         if (Blocks.field_150480_ab.func_176535_e(p_180655_1_, p_180655_2_.func_177984_a())) {
            for(int j1 = 0; j1 < 2; ++j1) {
               double d7 = (double)p_180655_2_.func_177958_n() + p_180655_4_.nextDouble();
               double d12 = (double)(p_180655_2_.func_177956_o() + 1) - p_180655_4_.nextDouble() * 0.10000000149011612D;
               double d17 = (double)p_180655_2_.func_177952_p() + p_180655_4_.nextDouble();
               p_180655_1_.func_175688_a(EnumParticleTypes.SMOKE_LARGE, d7, d12, d17, 0.0D, 0.0D, 0.0D);
            }
         }
      } else {
         for(int i = 0; i < 3; ++i) {
            double d0 = (double)p_180655_2_.func_177958_n() + p_180655_4_.nextDouble();
            double d1 = (double)p_180655_2_.func_177956_o() + p_180655_4_.nextDouble() * 0.5D + 0.5D;
            double d2 = (double)p_180655_2_.func_177952_p() + p_180655_4_.nextDouble();
            p_180655_1_.func_175688_a(EnumParticleTypes.SMOKE_LARGE, d0, d1, d2, 0.0D, 0.0D, 0.0D);
         }
      }
