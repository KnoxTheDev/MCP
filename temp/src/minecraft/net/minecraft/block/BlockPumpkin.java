...
public class BlockPumpkin extends BlockDirectional {
   ...
   private void func_180673_e(World p_180673_1_, BlockPos p_180673_2_) {
      ...
      if ((blockpattern$patternhelper = this.func_176391_l().func_177681_a(p_180673_1_, p_180673_2_)) != null) {
         ...
         for(int i1 = 0; i1 < this.func_176391_l().func_177685_b(); ++i1) {
            ...
            p_180673_1_.func_175722_b(blockworldstate1.func_177508_d(), Blocks.field_150350_a);
         }
      } else if ((blockpattern$patternhelper = this.func_176388_T().func_177681_a(p_180673_1_, p_180673_2_)) != null) {
         for(int k = 0; k < this.func_176388_T().func_177684_c(); ++k) {
            for(int l = 0; l < this.func_176388_T().func_177685_b(); ++l) {
               p_180673_1_.func_180501_a(blockpattern$patternhelper.func_177670_a(k, l, 0).func_177508_d(), Blocks.field_150350_a.func_176223_P(), 2);
            }
         }
         ...
         for(int k1 = 0; k1 < this.func_176388_T().func_177684_c(); ++k1) {
            for(int l1 = 0; l1 < this.func_176388_T().func_177685_b(); ++l1) {
               ...
               p_180673_1_.func_175722_b(blockworldstate2.func_177508_d(), Blocks.field_150350_a);
            }
         }
      }
