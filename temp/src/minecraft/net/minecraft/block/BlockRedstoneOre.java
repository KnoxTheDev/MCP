...
public class BlockRedstoneOre extends Block {
   ...
   private void func_180691_e(World p_180691_1_, BlockPos p_180691_2_) {
      ...
      for(int i = 0; i < 6; ++i) {
         ...
         if (i == 0 && !p_180691_1_.func_180495_p(p_180691_2_.func_177984_a()).func_177230_c().func_149662_c()) {
            d2 = (double)p_180691_2_.func_177956_o() + d0 + 1.0D;
         }

         if (i == 1 && !p_180691_1_.func_180495_p(p_180691_2_.func_177977_b()).func_177230_c().func_149662_c()) {
            d2 = (double)p_180691_2_.func_177956_o() - d0;
         }

         if (i == 2 && !p_180691_1_.func_180495_p(p_180691_2_.func_177968_d()).func_177230_c().func_149662_c()) {
            d3 = (double)p_180691_2_.func_177952_p() + d0 + 1.0D;
         }

         if (i == 3 && !p_180691_1_.func_180495_p(p_180691_2_.func_177978_c()).func_177230_c().func_149662_c()) {
            d3 = (double)p_180691_2_.func_177952_p() - d0;
         }

         if (i == 4 && !p_180691_1_.func_180495_p(p_180691_2_.func_177974_f()).func_177230_c().func_149662_c()) {
            d1 = (double)p_180691_2_.func_177958_n() + d0 + 1.0D;
         }

         if (i == 5 && !p_180691_1_.func_180495_p(p_180691_2_.func_177976_e()).func_177230_c().func_149662_c()) {
            d1 = (double)p_180691_2_.func_177958_n() - d0;
         }
