...
public class BlockFence extends Block {
   ...
   public boolean func_176524_e(IBlockAccess p_176524_1_, BlockPos p_176524_2_) {
      ...
      if (block == Blocks.field_180401_cv) {
         return false;
      } else if ((!(block instanceof BlockFence) || block.field_149764_J != this.field_149764_J) && !(block instanceof BlockFenceGate)) {
         if (block.field_149764_J.func_76218_k() && block.func_149686_d()) {
            return block.field_149764_J != Material.field_151572_C;
         } else {
            return false;
         }
      } else {
