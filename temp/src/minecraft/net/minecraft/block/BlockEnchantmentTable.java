            ...
            if (p_180655_4_.nextInt(16) == 0) {
               for(int k = 0; k <= 1; ++k) {
                  ...
                  if (p_180655_1_.func_180495_p(blockpos).func_177230_c() == Blocks.field_150342_X) {
                     ...
                     p_180655_1_.func_175688_a(EnumParticleTypes.ENCHANTMENT_TABLE, (double)p_180655_2_.func_177958_n() + 0.5D, (double)p_180655_2_.func_177956_o() + 2.0D, (double)p_180655_2_.func_177952_p() + 0.5D, (double)((float)i + p_180655_4_.nextFloat()) - 0.5D, (double)((float)k - p_180655_4_.nextFloat() - 1.0F), (double)((float)j + p_180655_4_.nextFloat()) - 0.5D);
                  }
               }
            }
         }
