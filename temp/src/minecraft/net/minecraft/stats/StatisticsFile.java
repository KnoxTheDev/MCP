   ...
   public void func_150882_a() {
      if (this.field_150887_d.isFile()) {
         try {
            ...
            field_150889_b.error("Couldn't read statistics file " + this.field_150887_d, (Throwable)ioexception);
         } catch (JsonParseException jsonparseexception) {
            field_150889_b.error("Couldn't parse statistics file " + this.field_150887_d, (Throwable)jsonparseexception);
         }
      }
