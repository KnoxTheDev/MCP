...
public class RealmsScreen {
   ...
   public static void bindFace(String p_bindFace_0_, String p_bindFace_1_) {
      ResourceLocation resourcelocation = AbstractClientPlayer.func_110311_f(p_bindFace_1_);
      if (resourcelocation == null) {
         resourcelocation = DefaultPlayerSkin.func_177334_a(UUIDTypeAdapter.fromString(p_bindFace_0_));
      }

      AbstractClientPlayer.func_110304_a(resourcelocation, p_bindFace_1_);
   ...
   public static String getLocalizedString(String p_getLocalizedString_0_) {
      return I18n.func_135052_a(p_getLocalizedString_0_);
   }
