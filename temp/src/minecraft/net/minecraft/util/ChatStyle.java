         ...
         if (p_deserialize_1_.isJsonObject()) {
            ...
            if (jsonobject == null) {
               ...
               if (jsonobject.has("bold")) {
                  chatstyle.field_150248_c = jsonobject.get("bold").getAsBoolean();
               }

               if (jsonobject.has("italic")) {
                  chatstyle.field_150245_d = jsonobject.get("italic").getAsBoolean();
               }

               if (jsonobject.has("underlined")) {
                  chatstyle.field_150246_e = jsonobject.get("underlined").getAsBoolean();
               }

               if (jsonobject.has("strikethrough")) {
                  chatstyle.field_150243_f = jsonobject.get("strikethrough").getAsBoolean();
               }

               if (jsonobject.has("obfuscated")) {
                  chatstyle.field_150244_g = jsonobject.get("obfuscated").getAsBoolean();
               }
