...
public class HttpUtil {
   ...
   private static String func_151225_a(URL p_151225_0_, String p_151225_1_, boolean p_151225_2_) {
      try {
         ...
         if (!p_151225_2_) {
            field_151227_b.error("Could not post to " + p_151225_0_, (Throwable)exception);
         }
         ...
         public void run() {
            ...
            try {
               try {
                  ...
                  if (p_180192_4_ != null) {
                     p_180192_4_.func_73719_c(String.format("Downloading file (%.2f MB)...", f1 / 1000.0F / 1000.0F));
                  }
                  ...
                  if (p_180192_0_.exists()) {
                     ...
                     HttpUtil.field_151227_b.warn("Deleting " + p_180192_0_ + " as it does not match what we currently have (" + i + " vs our " + j + ").");
