...
public class MerchantRecipeList extends ArrayList<MerchantRecipe> {
   ...
   public MerchantRecipe func_77203_a(ItemStack p_77203_1_, ItemStack p_77203_2_, int p_77203_3_) {
      if (p_77203_3_ > 0 && p_77203_3_ < this.size()) {
         ...
         return !this.func_181078_a(p_77203_1_, merchantrecipe1.func_77394_a()) || (p_77203_2_ != null || merchantrecipe1.func_77398_c()) && (!merchantrecipe1.func_77398_c() || !this.func_181078_a(p_77203_2_, merchantrecipe1.func_77396_b())) || p_77203_1_.field_77994_a < merchantrecipe1.func_77394_a().field_77994_a || merchantrecipe1.func_77398_c() && p_77203_2_.field_77994_a < merchantrecipe1.func_77396_b().field_77994_a ? null : merchantrecipe1;
      } else {
         for(int i = 0; i < this.size(); ++i) {
            MerchantRecipe merchantrecipe = (MerchantRecipe)this.get(i);
            if (this.func_181078_a(p_77203_1_, merchantrecipe.func_77394_a()) && p_77203_1_.field_77994_a >= merchantrecipe.func_77394_a().field_77994_a && (!merchantrecipe.func_77398_c() && p_77203_2_ == null || merchantrecipe.func_77398_c() && this.func_181078_a(p_77203_2_, merchantrecipe.func_77396_b()) && p_77203_2_.field_77994_a >= merchantrecipe.func_77396_b().field_77994_a)) {
