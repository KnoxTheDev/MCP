...
public class Village {
   ...
   private TreeMap<String, Integer> field_82693_j = new TreeMap<String, Integer>();
   private List<Village.VillageAggressor> field_75589_i = Lists.<Village.VillageAggressor>newArrayList();
   ...
   public void func_75560_a(int p_75560_1_) {
      ...
      if (this.field_75587_j < i && this.field_75584_b.size() > 20 && this.field_75586_a.field_73012_v.nextInt(7000) == 0) {
         Vec3 vec3 = this.func_179862_a(this.field_75582_d, 2, 4, 2);
         if (vec3 != null) {
   ...
   public EntityLivingBase func_75571_b(EntityLivingBase p_75571_1_) {
      ...
      return village$villageaggressor != null ? village$villageaggressor.field_75592_a : null;
   }
   ...
   private boolean func_179860_f(BlockPos p_179860_1_) {
      Block block = this.field_75586_a.func_180495_p(p_179860_1_).func_177230_c();
   ...
   public void func_82690_a(NBTTagCompound p_82690_1_) {
      ...
      for(int j = 0; j < nbttaglist1.func_74745_c(); ++j) {
         ...
         if (nbttagcompound1.func_74764_b("UUID")) {
            PlayerProfileCache playerprofilecache = MinecraftServer.func_71276_C().func_152358_ax();
