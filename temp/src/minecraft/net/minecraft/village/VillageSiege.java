...
public class VillageSiege {
      ...
      while(true) {
         ...
         if (!entityplayer.func_175149_v()) {
            ...
            if (this.field_75531_f != null && this.field_75531_f.func_75567_c() >= 10 && this.field_75531_f.func_75561_d() >= 20 && this.field_75531_f.func_75562_e() >= 20) {
               ...
               for(int i = 0; i < 10; ++i) {
                  float f1 = this.field_75537_a.field_73012_v.nextFloat() * 3.1415927F * 2.0F;
   ...
   private Vec3 func_179867_a(BlockPos p_179867_1_) {
      for(int i = 0; i < 10; ++i) {
         ...
         if (this.field_75531_f.func_179866_a(blockpos) && SpawnerAnimals.func_180267_a(EntityLiving.SpawnPlacementType.ON_GROUND, this.field_75537_a, blockpos)) {
