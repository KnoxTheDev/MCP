...
public class ScoreboardSaveData extends WorldSavedData {
   ...
   protected void func_96498_a(NBTTagList p_96498_1_) {
      for(int i = 0; i < p_96498_1_.func_74745_c(); ++i) {
         ...
         if (nbttagcompound.func_150297_b("TeamColor", 8)) {
            scoreplayerteam.func_178774_a(EnumChatFormatting.func_96300_b(nbttagcompound.func_74779_i("TeamColor")));
         }
   ...
   protected void func_96501_b(NBTTagList p_96501_1_) {
      for(int i = 0; i < p_96501_1_.func_74745_c(); ++i) {
         ...
         IScoreObjectiveCriteria iscoreobjectivecriteria = IScoreObjectiveCriteria.field_96643_a.get(nbttagcompound.func_74779_i("CriteriaName"));
         if (iscoreobjectivecriteria != null) {
            ...
            ScoreObjective scoreobjective = this.field_96507_a.func_96535_a(s, iscoreobjectivecriteria);
            scoreobjective.func_96681_a(nbttagcompound.func_74779_i("DisplayName"));
            scoreobjective.func_178767_a(IScoreObjectiveCriteria.EnumRenderType.func_178795_a(nbttagcompound.func_74779_i("RenderType")));
         }
      }
