...
public class Scoreboard {
   ...
   private final Map<IScoreObjectiveCriteria, List<ScoreObjective>> field_96543_b = Maps.<IScoreObjectiveCriteria, List<ScoreObjective>>newHashMap();
      ...
      default:
         if (p_96517_0_ >= 3 && p_96517_0_ <= 18) {
            ...
            if (enumchatformatting != null && enumchatformatting != EnumChatFormatting.RESET) {
               return "sidebar.team." + enumchatformatting.func_96297_d();
            }
         }
   ...
   public static int func_96537_j(String p_96537_0_) {
      if (p_96537_0_.equalsIgnoreCase("list")) {
         ...
         if (p_96537_0_.startsWith("sidebar.team.")) {
            ...
            EnumChatFormatting enumchatformatting = EnumChatFormatting.func_96300_b(s);
            if (enumchatformatting != null && enumchatformatting.func_175746_b() >= 0) {
               return enumchatformatting.func_175746_b() + 3;
            }
         }
   ...
   public void func_181140_a(Entity p_181140_1_) {
      if (p_181140_1_ != null && !(p_181140_1_ instanceof EntityPlayer) && !p_181140_1_.func_70089_S()) {
         String s = p_181140_1_.func_110124_au().toString();
