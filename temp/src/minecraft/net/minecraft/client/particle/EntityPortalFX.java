...
public class EntityPortalFX extends EntityFX {
   ...
   public void func_70071_h_() {
      ...
      float f1 = -f + f * f * 2.0F;
      float f2 = 1.0F - f1;
      this.field_70165_t = this.field_70574_aq + this.field_70159_w * (double)f2;
      this.field_70163_u = this.field_70573_ar + this.field_70181_x * (double)f2 + (double)(1.0F - f);
      this.field_70161_v = this.field_70572_as + this.field_70179_y * (double)f2;
