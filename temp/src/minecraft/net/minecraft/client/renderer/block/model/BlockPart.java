...
public class BlockPart {
   ...
   private float[] func_178236_a(EnumFacing p_178236_1_) {
      ...
      case DOWN:
      case UP:
         afloat = new float[]{this.field_178241_a.x, this.field_178241_a.z, this.field_178239_b.x, this.field_178239_b.z};
         break;
      case NORTH:
      case SOUTH:
         afloat = new float[]{this.field_178241_a.x, 16.0F - this.field_178239_b.y, this.field_178239_b.x, 16.0F - this.field_178241_a.y};
         break;
      case WEST:
      case EAST:
         afloat = new float[]{this.field_178241_a.z, 16.0F - this.field_178239_b.y, this.field_178239_b.z, 16.0F - this.field_178241_a.y};
         break;
      default:
   ...
   static class Deserializer implements JsonDeserializer<BlockPart> {
      ...
      private EnumFacing.Axis func_178252_c(JsonObject p_178252_1_) {
         ...
         EnumFacing.Axis enumfacing$axis = EnumFacing.Axis.func_176717_a(s.toLowerCase());
