...
public class ModelBlockDefinition {
   ...
   public ModelBlockDefinition.Variants func_178330_b(String p_178330_1_) {
      ModelBlockDefinition.Variants modelblockdefinition$variants = this.field_178332_b.get(p_178330_1_);
   ...
   public static class Variants {
      ...
      public boolean equals(Object p_equals_1_) {
         if (this == p_equals_1_) {
            ...
            if (!this.field_178423_a.equals(modelblockdefinition$variants.field_178423_a)) {
               return false;
            } else {
               return this.field_178422_b.equals(modelblockdefinition$variants.field_178422_b);
            }
         }
      }
