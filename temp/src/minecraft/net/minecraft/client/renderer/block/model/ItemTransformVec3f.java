...
public class ItemTransformVec3f {
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         if (!this.field_178364_b.equals(itemtransformvec3f.field_178364_b)) {
            return false;
         } else if (!this.field_178363_d.equals(itemtransformvec3f.field_178363_d)) {
            return false;
         } else {
            return this.field_178365_c.equals(itemtransformvec3f.field_178365_c);
         }
      }
   }
   ...
   static class Deserializer implements JsonDeserializer<ItemTransformVec3f> {
      ...
      public ItemTransformVec3f deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
         ...
         vector3f1.x = MathHelper.func_76131_a(vector3f1.x, -1.5F, 1.5F);
         vector3f1.y = MathHelper.func_76131_a(vector3f1.y, -1.5F, 1.5F);
         vector3f1.z = MathHelper.func_76131_a(vector3f1.z, -1.5F, 1.5F);
