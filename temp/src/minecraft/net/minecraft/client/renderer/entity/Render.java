...
public abstract class Render<T extends Entity> {
   ...
   public boolean func_177071_a(T p_177071_1_, ICamera p_177071_2_, double p_177071_3_, double p_177071_5_, double p_177071_7_) {
      AxisAlignedBB axisalignedbb = p_177071_1_.func_174813_aQ();
   ...
   private void func_76977_a(Entity p_76977_1_, double p_76977_2_, double p_76977_4_, double p_76977_6_, float p_76977_8_) {
      ...
      while(f3 > 0.0F) {
         ...
         worldrenderer.func_181662_b((double)(f1 - f2), (double)(0.0F - f4), (double)f5).func_181673_a((double)f8, (double)f9).func_181675_d();
         worldrenderer.func_181662_b((double)(-f1 - f2), (double)(0.0F - f4), (double)f5).func_181673_a((double)f6, (double)f9).func_181675_d();
         worldrenderer.func_181662_b((double)(-f1 - f2), (double)(1.4F - f4), (double)f5).func_181673_a((double)f6, (double)f7).func_181675_d();
         worldrenderer.func_181662_b((double)(f1 - f2), (double)(1.4F - f4), (double)f5).func_181673_a((double)f8, (double)f7).func_181675_d();
         f3 -= 0.45F;
         f4 -= 0.45F;
         f1 *= 0.9F;
         f5 += 0.03F;
   ...
   private void func_180549_a(Block p_180549_1_, double p_180549_2_, double p_180549_4_, double p_180549_6_, BlockPos p_180549_8_, float p_180549_9_, float p_180549_10_, double p_180549_11_, double p_180549_13_, double p_180549_15_) {
      if (p_180549_1_.func_149686_d()) {
         Tessellator tessellator = Tessellator.func_178181_a();
         WorldRenderer worldrenderer = tessellator.func_178180_c();
         double d0 = ((double)p_180549_9_ - (p_180549_4_ - ((double)p_180549_8_.func_177956_o() + p_180549_13_)) / 2.0D) * 0.5D * (double)this.func_76982_b().func_175724_o(p_180549_8_);
         if (d0 >= 0.0D) {
            if (d0 > 1.0D) {
               d0 = 1.0D;
            }

            double d1 = (double)p_180549_8_.func_177958_n() + p_180549_1_.func_149704_x() + p_180549_11_;
            double d2 = (double)p_180549_8_.func_177958_n() + p_180549_1_.func_149753_y() + p_180549_11_;
            double d3 = (double)p_180549_8_.func_177956_o() + p_180549_1_.func_149665_z() + p_180549_13_ + 0.015625D;
            double d4 = (double)p_180549_8_.func_177952_p() + p_180549_1_.func_149706_B() + p_180549_15_;
            double d5 = (double)p_180549_8_.func_177952_p() + p_180549_1_.func_149693_C() + p_180549_15_;
            ...
            worldrenderer.func_181662_b(d1, d3, d4).func_181673_a((double)f, (double)f2).func_181666_a(1.0F, 1.0F, 1.0F, (float)d0).func_181675_d();
            worldrenderer.func_181662_b(d1, d3, d5).func_181673_a((double)f, (double)f3).func_181666_a(1.0F, 1.0F, 1.0F, (float)d0).func_181675_d();
            worldrenderer.func_181662_b(d2, d3, d5).func_181673_a((double)f1, (double)f3).func_181666_a(1.0F, 1.0F, 1.0F, (float)d0).func_181675_d();
            worldrenderer.func_181662_b(d2, d3, d4).func_181673_a((double)f1, (double)f2).func_181666_a(1.0F, 1.0F, 1.0F, (float)d0).func_181675_d();
         }
      }
   }
   ...
   public static void func_76978_a(AxisAlignedBB p_76978_0_, double p_76978_1_, double p_76978_3_, double p_76978_5_) {
      ...
      WorldRenderer worldrenderer = tessellator.func_178180_c();
      GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, 1.0F);
      worldrenderer.func_178969_c(p_76978_1_, p_76978_3_, p_76978_5_);
      worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181708_h);
      worldrenderer.func_181662_b(p_76978_0_.field_72340_a, p_76978_0_.field_72337_e, p_76978_0_.field_72339_c).func_181663_c(0.0F, 0.0F, -1.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72336_d, p_76978_0_.field_72337_e, p_76978_0_.field_72339_c).func_181663_c(0.0F, 0.0F, -1.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72336_d, p_76978_0_.field_72338_b, p_76978_0_.field_72339_c).func_181663_c(0.0F, 0.0F, -1.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72340_a, p_76978_0_.field_72338_b, p_76978_0_.field_72339_c).func_181663_c(0.0F, 0.0F, -1.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72340_a, p_76978_0_.field_72338_b, p_76978_0_.field_72334_f).func_181663_c(0.0F, 0.0F, 1.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72336_d, p_76978_0_.field_72338_b, p_76978_0_.field_72334_f).func_181663_c(0.0F, 0.0F, 1.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72336_d, p_76978_0_.field_72337_e, p_76978_0_.field_72334_f).func_181663_c(0.0F, 0.0F, 1.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72340_a, p_76978_0_.field_72337_e, p_76978_0_.field_72334_f).func_181663_c(0.0F, 0.0F, 1.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72340_a, p_76978_0_.field_72338_b, p_76978_0_.field_72339_c).func_181663_c(0.0F, -1.0F, 0.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72336_d, p_76978_0_.field_72338_b, p_76978_0_.field_72339_c).func_181663_c(0.0F, -1.0F, 0.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72336_d, p_76978_0_.field_72338_b, p_76978_0_.field_72334_f).func_181663_c(0.0F, -1.0F, 0.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72340_a, p_76978_0_.field_72338_b, p_76978_0_.field_72334_f).func_181663_c(0.0F, -1.0F, 0.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72340_a, p_76978_0_.field_72337_e, p_76978_0_.field_72334_f).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72336_d, p_76978_0_.field_72337_e, p_76978_0_.field_72334_f).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72336_d, p_76978_0_.field_72337_e, p_76978_0_.field_72339_c).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72340_a, p_76978_0_.field_72337_e, p_76978_0_.field_72339_c).func_181663_c(0.0F, 1.0F, 0.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72340_a, p_76978_0_.field_72338_b, p_76978_0_.field_72334_f).func_181663_c(-1.0F, 0.0F, 0.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72340_a, p_76978_0_.field_72337_e, p_76978_0_.field_72334_f).func_181663_c(-1.0F, 0.0F, 0.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72340_a, p_76978_0_.field_72337_e, p_76978_0_.field_72339_c).func_181663_c(-1.0F, 0.0F, 0.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72340_a, p_76978_0_.field_72338_b, p_76978_0_.field_72339_c).func_181663_c(-1.0F, 0.0F, 0.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72336_d, p_76978_0_.field_72338_b, p_76978_0_.field_72339_c).func_181663_c(1.0F, 0.0F, 0.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72336_d, p_76978_0_.field_72337_e, p_76978_0_.field_72339_c).func_181663_c(1.0F, 0.0F, 0.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72336_d, p_76978_0_.field_72337_e, p_76978_0_.field_72334_f).func_181663_c(1.0F, 0.0F, 0.0F).func_181675_d();
      worldrenderer.func_181662_b(p_76978_0_.field_72336_d, p_76978_0_.field_72338_b, p_76978_0_.field_72334_f).func_181663_c(1.0F, 0.0F, 0.0F).func_181675_d();
      tessellator.func_78381_a();
