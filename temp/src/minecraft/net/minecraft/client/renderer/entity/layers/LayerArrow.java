...
public class LayerArrow implements LayerRenderer<EntityLivingBase> {
   ...
   public void func_177141_a(EntityLivingBase p_177141_1_, float p_177141_2_, float p_177141_3_, float p_177141_4_, float p_177141_5_, float p_177141_6_, float p_177141_7_, float p_177141_8_) {
      ...
      if (i > 0) {
         Entity entity = new EntityArrow(p_177141_1_.field_70170_p, p_177141_1_.field_70165_t, p_177141_1_.field_70163_u, p_177141_1_.field_70161_v);
         ...
         for(int j = 0; j < i; ++j) {
            ...
            entity.field_70126_B = entity.field_70177_z = (float)(Math.atan2((double)f, (double)f2) * 180.0D / 3.1415927410125732D);
            entity.field_70127_C = entity.field_70125_A = (float)(Math.atan2((double)f1, (double)f6) * 180.0D / 3.1415927410125732D);
            double d0 = 0.0D;
            double d1 = 0.0D;
            double d2 = 0.0D;
            this.field_177168_a.func_177068_d().func_147940_a(entity, d0, d1, d2, 0.0F, p_177141_4_);
