...
public class EntityRenderer implements IResourceManagerReloadListener {
   ...
   private void func_175069_a(ResourceLocation p_175069_1_) {
      try {
         ...
         field_147710_q.warn("Failed to load shader: " + p_175069_1_, (Throwable)ioexception);
         this.field_147713_ae = field_147708_e;
         this.field_175083_ad = false;
      } catch (JsonSyntaxException jsonsyntaxexception) {
         field_147710_q.warn("Failed to load shader: " + p_175069_1_, (Throwable)jsonsyntaxexception);
         this.field_147713_ae = field_147708_e;
         this.field_175083_ad = false;
      }
