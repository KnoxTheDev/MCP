...
public class TileEntityBannerRenderer extends TileEntitySpecialRenderer<TileEntityBanner> {
   ...
   private ResourceLocation func_178463_a(TileEntityBanner p_178463_1_) {
      ...
      if (s.isEmpty()) {
         ...
         TileEntityBannerRenderer.TimedBannerTexture tileentitybannerrenderer$timedbannertexture = field_178466_c.get(s);
         if (tileentitybannerrenderer$timedbannertexture == null) {
            if (field_178466_c.size() >= 256) {
               ...
               while(iterator.hasNext()) {
                  ...
                  TileEntityBannerRenderer.TimedBannerTexture tileentitybannerrenderer$timedbannertexture1 = field_178466_c.get(s1);
