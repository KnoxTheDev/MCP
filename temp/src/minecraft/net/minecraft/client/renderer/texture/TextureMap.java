   ...
   public void func_110571_b(IResourceManager p_110571_1_) {
      ...
      for(Entry<String, TextureAtlasSprite> entry : this.field_110574_e.entrySet()) {
         ...
         try {
               ...
               while(iterator.hasNext()) {
                  ...
                  if (i2 > 0 && i2 < abufferedimage.length - 1 && abufferedimage[i2] == null) {
                     ...
                     try {
                        ...
                        field_147635_d.error("Unable to load miplevel {} from: {}", i2, resourcelocation2, ioexception);
                     }
                  }
               }
            }
            ...
            field_147635_d.error("Unable to parse metadata from " + resourcelocation1, (Throwable)runtimeexception);
            continue;
         } catch (IOException ioexception1) {
            field_147635_d.error("Using missing texture, unable to load " + resourcelocation1, (Throwable)ioexception1);
            continue;
         }
