      ...
      for(final SoundList.SoundEntry soundlist$soundentry : p_147693_2_.func_148570_a()) {
         ...
         case FILE:
            ...
            try {
               ...
               field_147698_b.warn("File {} does not exist, cannot add it to event {}", resourcelocation1, p_147693_1_);
               continue;
            } catch (IOException ioexception) {
               field_147698_b.warn("Could not load sound file " + resourcelocation1 + ", cannot add it to event " + p_147693_1_, (Throwable)ioexception);
               continue;
            } finally {
               IOUtils.closeQuietly(inputstream);
            }

            lvt_10_1_ = new SoundEventAccessor(new SoundPoolEntry(resourcelocation1, (double)soundlist$soundentry.func_148560_c(), (double)soundlist$soundentry.func_148558_b(), soundlist$soundentry.func_148552_f()), soundlist$soundentry.func_148555_d());
            break;
         case SOUND_EVENT:
         ...
         soundeventaccessorcomposite.func_148727_a((ISoundEventAccessor)lvt_10_1_);
      }
