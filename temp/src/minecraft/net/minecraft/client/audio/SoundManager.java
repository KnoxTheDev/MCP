      ...
      if (this.field_148617_f) {
         if (p_148601_1_ == SoundCategory.MASTER) {
            ...
            for(String s : this.field_148628_k.get(p_148601_1_)) {
               ...
               float f = this.func_148594_a(isound, this.field_148627_j.get(isound), p_148601_1_);
               if (f <= 0.0F) {
   ...
   public void func_148605_d() {
      ...
      for(ITickableSound itickablesound : this.field_148625_l) {
         ...
         if (itickablesound.func_147667_k()) {
            ...
            this.field_148620_e.setVolume(s, this.func_148594_a(itickablesound, this.field_148627_j.get(itickablesound), this.field_148622_c.func_147680_a(itickablesound.func_147650_b()).func_148728_d()));
            this.field_148620_e.setPitch(s, this.func_148606_a(itickablesound, this.field_148627_j.get(itickablesound)));
   ...
   public void func_148611_c(ISound p_148611_1_) {
      if (this.field_148617_f) {
         if (this.field_148620_e.getMasterVolume() <= 0.0F) {
            field_148621_b.debug(field_148623_a, "Skipped playing soundEvent: {}, master volume was zero", p_148611_1_.func_147650_b());
         } else {
            ...
            if (soundeventaccessorcomposite == null) {
               field_148621_b.warn(field_148623_a, "Unable to play unknown soundEvent: {}", p_148611_1_.func_147650_b());
            } else {
               SoundPoolEntry soundpoolentry = soundeventaccessorcomposite.func_148720_g();
               if (soundpoolentry == SoundHandler.field_147700_a) {
                  field_148621_b.warn(field_148623_a, "Unable to play empty soundEvent: {}", soundeventaccessorcomposite.func_148729_c());
               } else {
                  ...
                  if (f2 == 0.0F) {
                     field_148621_b.debug(field_148623_a, "Skipped playing sound {}, volume was zero.", resourcelocation);
                  } else {
                     ...
                     field_148621_b.debug(field_148623_a, "Playing sound {} for event {} as channel {}", soundpoolentry.func_148652_a(), soundeventaccessorcomposite.func_148729_c(), s);
