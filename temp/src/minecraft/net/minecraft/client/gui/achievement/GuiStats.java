...
public class GuiStats extends GuiScreen implements IProgressMeter {
   ...
   public void func_146541_h() {
      ...
      GuiButton guibutton;
      this.field_146292_n.add(guibutton = new GuiButton(2, this.field_146294_l / 2 - 80, this.field_146295_m - 52, 80, 20, I18n.func_135052_a("stat.blocksButton")));
      GuiButton guibutton1;
      this.field_146292_n.add(guibutton1 = new GuiButton(3, this.field_146294_l / 2, this.field_146295_m - 52, 80, 20, I18n.func_135052_a("stat.itemsButton")));
      GuiButton guibutton2;
      this.field_146292_n.add(guibutton2 = new GuiButton(4, this.field_146294_l / 2 + 80, this.field_146295_m - 52, 80, 20, I18n.func_135052_a("stat.mobsButton")));
   ...
   class StatsGeneral extends GuiSlot {
      ...
      protected void func_180791_a(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
         StatBase statbase = StatList.field_75941_c.get(p_180791_1_);
   ...
   class StatsMobsList extends GuiSlot {
      ...
      protected void func_180791_a(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
         EntityList.EntityEggInfo entitylist$entityegginfo = this.field_148222_l.get(p_180791_1_);
         String s = I18n.func_135052_a("entity." + EntityList.func_75617_a(entitylist$entityegginfo.field_75613_a) + ".name");
