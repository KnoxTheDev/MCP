...
public class GuiTwitchUserMode extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      int j = i - 130;
      this.field_146292_n.add(new GuiButton(1, i * 0 + j / 2, this.field_146295_m - 70, 130, 20, I18n.func_135052_a("stream.userinfo.timeout")));
      this.field_146292_n.add(new GuiButton(0, i * 1 + j / 2, this.field_146295_m - 70, 130, 20, I18n.func_135052_a("stream.userinfo.ban")));
      this.field_146292_n.add(new GuiButton(2, i * 2 + j / 2, this.field_146295_m - 70, 130, 20, I18n.func_135052_a("stream.userinfo.mod")));
      this.field_146292_n.add(new GuiButton(5, i * 0 + j / 2, this.field_146295_m - 45, 130, 20, I18n.func_135052_a("gui.cancel")));
      this.field_146292_n.add(new GuiButton(3, i * 1 + j / 2, this.field_146295_m - 45, 130, 20, I18n.func_135052_a("stream.userinfo.unban")));
      this.field_146292_n.add(new GuiButton(4, i * 2 + j / 2, this.field_146295_m - 45, 130, 20, I18n.func_135052_a("stream.userinfo.unmod")));
      int k = 0;
