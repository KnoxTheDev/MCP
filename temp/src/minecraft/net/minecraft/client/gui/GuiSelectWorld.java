...
public class GuiSelectWorld extends GuiScreen implements GuiYesNoCallback {
   ...
   public void func_73866_w_() {
      ...
      try {
         ...
         field_146629_g.error("Couldn't load level list", (Throwable)anvilconverterexception);
   ...
   protected String func_146614_d(int p_146614_1_) {
      ...
      if (StringUtils.isEmpty(s)) {
         s = I18n.func_135052_a("selectWorld.world") + " " + (p_146614_1_ + 1);
      }
   ...
   public static GuiYesNo func_152129_a(GuiYesNoCallback p_152129_0_, String p_152129_1_, int p_152129_2_) {
      String s = I18n.func_135052_a("selectWorld.deleteQuestion");
      String s1 = "'" + p_152129_1_ + "' " + I18n.func_135052_a("selectWorld.deleteWarning");
      String s2 = I18n.func_135052_a("selectWorld.deleteButton");
   ...
   class List extends GuiSlot {
      ...
      protected void func_180791_a(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
         SaveFormatComparator saveformatcomparator = GuiSelectWorld.this.field_146639_s.get(p_180791_1_);
         ...
         if (saveformatcomparator.func_75785_d()) {
            ...
            if (saveformatcomparator.func_75789_g()) {
               s2 = EnumChatFormatting.DARK_RED + I18n.func_135052_a("gameMode.hardcore") + EnumChatFormatting.RESET;
            }
