...
public class GuiScreenAddServer extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      (this.field_146292_n.get(0)).field_146124_l = this.field_146308_f.func_146179_b().length() > 0 && this.field_146308_f.func_146179_b().split(":").length > 0 && this.field_146309_g.func_146179_b().length() > 0;
   }
