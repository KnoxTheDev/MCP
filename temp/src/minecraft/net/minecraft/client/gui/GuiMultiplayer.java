...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
   ...
   public void func_73876_c() {
      ...
      if (this.field_146799_A.func_77553_a()) {
         List<LanServerDetector.LanServer> list = this.field_146799_A.func_77554_c();
   ...
   public void func_146796_h() {
      ...
      if (guilistextended$iguilistentry instanceof ServerListEntryNormal) {
         ...
         LanServerDetector.LanServer lanserverdetector$lanserver = ((ServerListEntryLanDetected)guilistextended$iguilistentry).func_148289_a();
         this.func_146791_a(new ServerData(lanserverdetector$lanserver.func_77487_a(), lanserverdetector$lanserver.func_77488_b(), true));
      }
