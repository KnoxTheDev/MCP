...
public class GuiCreateFlatWorld extends GuiScreen {
   ...
   class Details extends GuiSlot {
      ...
      private void func_148224_c(int p_148224_1_, int p_148224_2_, int p_148224_3_, int p_148224_4_) {
         ...
         worldrenderer.func_181662_b((double)(p_148224_1_ + 0), (double)(p_148224_2_ + 18), (double)GuiCreateFlatWorld.this.field_73735_i).func_181673_a((double)((float)(p_148224_3_ + 0) * 0.0078125F), (double)((float)(p_148224_4_ + 18) * 0.0078125F)).func_181675_d();
         worldrenderer.func_181662_b((double)(p_148224_1_ + 18), (double)(p_148224_2_ + 18), (double)GuiCreateFlatWorld.this.field_73735_i).func_181673_a((double)((float)(p_148224_3_ + 18) * 0.0078125F), (double)((float)(p_148224_4_ + 18) * 0.0078125F)).func_181675_d();
         worldrenderer.func_181662_b((double)(p_148224_1_ + 18), (double)(p_148224_2_ + 0), (double)GuiCreateFlatWorld.this.field_73735_i).func_181673_a((double)((float)(p_148224_3_ + 18) * 0.0078125F), (double)((float)(p_148224_4_ + 0) * 0.0078125F)).func_181675_d();
         worldrenderer.func_181662_b((double)(p_148224_1_ + 0), (double)(p_148224_2_ + 0), (double)GuiCreateFlatWorld.this.field_73735_i).func_181673_a((double)((float)(p_148224_3_ + 0) * 0.0078125F), (double)((float)(p_148224_4_ + 0) * 0.0078125F)).func_181675_d();
      ...
      protected void func_180791_a(int p_180791_1_, int p_180791_2_, int p_180791_3_, int p_180791_4_, int p_180791_5_, int p_180791_6_) {
         FlatLayerInfo flatlayerinfo = (FlatLayerInfo)GuiCreateFlatWorld.this.field_146387_g.func_82650_c().get(GuiCreateFlatWorld.this.field_146387_g.func_82650_c().size() - p_180791_1_ - 1);
         IBlockState iblockstate = flatlayerinfo.func_175900_c();
         Block block = iblockstate.func_177230_c();
         Item item = Item.func_150898_a(block);
         ItemStack itemstack = block != Blocks.field_150350_a && item != null ? new ItemStack(item, 1, block.func_176201_c(iblockstate)) : null;
         String s = itemstack == null ? "Air" : item.func_77653_i(itemstack);
         if (item == null) {
            ...
            if (item != null) {
               itemstack = new ItemStack(item, 1, block.func_176201_c(iblockstate));
               s = block.func_149732_F();
            }
         }

         this.func_148225_a(p_180791_2_, p_180791_3_, itemstack);
         GuiCreateFlatWorld.this.field_146289_q.func_78276_b(s, p_180791_2_ + 18 + 5, p_180791_3_ + 3, 16777215);
         String s1;
         if (p_180791_1_ == 0) {
         ...
         GuiCreateFlatWorld.this.field_146289_q.func_78276_b(s1, p_180791_2_ + 2 + 213 - GuiCreateFlatWorld.this.field_146289_q.func_78256_a(s1), p_180791_3_ + 3, 16777215);
      }
