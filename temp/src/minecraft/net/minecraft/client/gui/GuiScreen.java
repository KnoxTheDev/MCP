      ...
      if (p_175272_1_ != null && p_175272_1_.func_150256_b().func_150210_i() != null) {
         ...
         if (hoverevent.func_150701_a() == HoverEvent.Action.SHOW_ITEM) {
            ...
            if (statbase != null) {
               ...
               List<String> list = Lists.newArrayList(ichatcomponent.func_150254_d(), ichatcomponent1.func_150254_d());
               if (s1 != null) {
         ...
         if (func_146272_n()) {
            ...
            if (clickevent.func_150669_a() == ClickEvent.Action.OPEN_URL) {
               ...
               try {
                  ...
                  field_175287_a.error("Can't open url for " + clickevent, (Throwable)urisyntaxexception);
               }
