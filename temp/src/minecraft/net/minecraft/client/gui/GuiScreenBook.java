...
public class GuiScreenBook extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      int j = 2;
      this.field_146292_n.add(this.field_146470_A = new GuiScreenBook.NextPageButton(1, i + 120, j + 154, true));
      this.field_146292_n.add(this.field_146471_B = new GuiScreenBook.NextPageButton(2, i + 38, j + 154, false));
      this.func_146464_h();
   }
         ...
         if (this.field_146483_y != null) {
            ...
            if (p_146462_1_) {
               ...
               for(int i = 0; i < this.field_146483_y.func_74745_c(); ++i) {
                  String s1 = this.field_146483_y.func_150307_f(i);
                  IChatComponent ichatcomponent = new ChatComponentText(s1);
                  s1 = IChatComponent.Serializer.func_150696_a(ichatcomponent);
                  this.field_146483_y.func_150304_a(i, new NBTTagString(s1));
               }
            ...
            this.field_146297_k.func_147114_u().func_147297_a(new C17PacketCustomPayload(s2, packetbuffer));
         }
   ...
   private void func_146459_b(String p_146459_1_) {
      ...
      int i = this.field_146289_q.func_78267_b(s1 + "" + EnumChatFormatting.BLACK + "_", 118);
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      int i = (this.field_146294_l - this.field_146478_u) / 2;
      int j = 2;
      this.func_73729_b(i, j, 0, 0, this.field_146478_u, this.field_146477_v);
      if (this.field_146480_s) {
         ...
         this.field_146289_q.func_78276_b(s1, i + 36 + (116 - k) / 2, j + 16 + 16, 0);
         int l = this.field_146289_q.func_78256_a(s);
         this.field_146289_q.func_78276_b(s, i + 36 + (116 - l) / 2, j + 48, 0);
         String s2 = I18n.func_135052_a("book.byAuthor", this.field_146468_g.func_70005_c_());
         int i1 = this.field_146289_q.func_78256_a(s2);
         this.field_146289_q.func_78276_b(EnumChatFormatting.DARK_GRAY + s2, i + 36 + (116 - i1) / 2, j + 48 + 10, 0);
         String s3 = I18n.func_135052_a("book.finalizeWarning");
         this.field_146289_q.func_78279_b(s3, i + 36, j + 80, 116, 0);
      } else {
         ...
         if (this.field_146475_i) {
            ...
            if (ItemEditableBook.func_77828_a(this.field_146474_h.func_77978_p())) {
               try {
                  IChatComponent ichatcomponent = IChatComponent.Serializer.func_150699_a(s5);
                  this.field_175386_A = ichatcomponent != null ? GuiUtilRenderComponents.func_178908_a(ichatcomponent, 116, this.field_146289_q, true, true) : null;
         ...
         this.field_146289_q.func_78276_b(s4, i - j1 + this.field_146478_u - 44, j + 16, 0);
         if (this.field_175386_A == null) {
            this.field_146289_q.func_78279_b(s5, i + 36, j + 16 + 16, 116, 0);
         } else {
            ...
            for(int l1 = 0; l1 < k1; ++l1) {
               ...
               this.field_146289_q.func_78276_b(ichatcomponent2.func_150260_c(), i + 36, j + 16 + 16 + l1 * this.field_146289_q.field_78288_b, 0);
            }

            IChatComponent ichatcomponent1 = this.func_175385_b(p_73863_1_, p_73863_2_);
            if (ichatcomponent1 != null) {
               this.func_175272_a(ichatcomponent1, p_73863_1_, p_73863_2_);
            }
         }
      }
   ...
   protected void func_73864_a(int p_73864_1_, int p_73864_2_, int p_73864_3_) throws IOException {
      if (p_73864_3_ == 0) {
         IChatComponent ichatcomponent = this.func_175385_b(p_73864_1_, p_73864_2_);
   ...
   protected boolean func_175276_a(IChatComponent p_175276_1_) {
      ClickEvent clickevent = p_175276_1_ == null ? null : p_175276_1_.func_150256_b().func_150235_h();
      if (clickevent == null) {
         return false;
   ...
   public IChatComponent func_175385_b(int p_175385_1_, int p_175385_2_) {
      if (this.field_175386_A == null) {
         ...
         int i = p_175385_1_ - (this.field_146294_l - this.field_146478_u) / 2 - 36;
               ...
               if (l >= 0 && l < this.field_175386_A.size()) {
                  ...
                  for(IChatComponent ichatcomponent1 : ichatcomponent) {
                     if (ichatcomponent1 instanceof ChatComponentText) {
                        i1 += this.field_146297_k.field_71466_p.func_78256_a(((ChatComponentText)ichatcomponent1).func_150265_g());
                        if (i1 > i) {
