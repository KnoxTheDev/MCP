...
public class GuiNewChat extends Gui {
      ...
      if (this.field_146247_f.field_71474_y.field_74343_n != EntityPlayer.EnumChatVisibility.HIDDEN) {
         ...
         if (k > 0) {
               ...
               if (chatline != null) {
                  ...
                  if (j1 < 200 || flag) {
                     ...
                     if (l1 > 3) {
                        int i2 = 0;
                        int j2 = -i1 * 9;
                        func_73734_a(i2, j2 - 9, i2 + l + 4, j2, l1 / 2 << 24);
                        String s = chatline.func_151461_a().func_150254_d();
                        GlStateManager.func_179147_l();
                        this.field_146247_f.field_71466_p.func_175063_a(s, (float)i2, (float)(j2 - 8), 16777215 + (l1 << 24));
            ...
            if (flag) {
               ...
               int l2 = k * k2 + k;
               int i3 = j * k2 + j;
               int j3 = this.field_146250_j * i3 / k;
               int k1 = i3 * i3 / l2;
               if (l2 != i3) {
                  int k3 = j3 > 0 ? 170 : 96;
   ...
   private void func_146237_a(IChatComponent p_146237_1_, int p_146237_2_, int p_146237_3_, boolean p_146237_4_) {
      ...
      List<IChatComponent> list = GuiUtilRenderComponents.func_178908_a(p_146237_1_, i, this.field_146247_f.field_71466_p, false, false);
               ...
               if (i1 >= 0 && i1 < this.field_146253_i.size()) {
                  ...
                  for(IChatComponent ichatcomponent : chatline.func_151461_a()) {
                     if (ichatcomponent instanceof ChatComponentText) {
                        j1 += this.field_146247_f.field_71466_p.func_78256_a(GuiUtilRenderComponents.func_178909_a(((ChatComponentText)ichatcomponent).func_150265_g(), false));
                        if (j1 > j) {
   ...
   public static int func_146233_a(float p_146233_0_) {
      int i = 320;
      int j = 40;
      return MathHelper.func_76141_d(p_146233_0_ * (float)(i - j) + (float)j);
   }

   public static int func_146243_b(float p_146243_0_) {
      int i = 180;
      int j = 20;
      return MathHelper.func_76141_d(p_146243_0_ * (float)(i - j) + (float)j);
   }
