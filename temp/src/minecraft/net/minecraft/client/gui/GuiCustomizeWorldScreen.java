...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
   ...
   public void func_175319_a(int p_175319_1_, String p_175319_2_) {
      ...
      switch(p_175319_1_) {
      case 132:
         f1 = this.field_175336_F.field_177917_i = MathHelper.func_76131_a(f, 1.0F, 5000.0F);
         break;
      case 133:
         f1 = this.field_175336_F.field_177911_j = MathHelper.func_76131_a(f, 1.0F, 5000.0F);
         break;
      case 134:
         f1 = this.field_175336_F.field_177913_k = MathHelper.func_76131_a(f, 1.0F, 5000.0F);
         break;
      case 135:
         f1 = this.field_175336_F.field_177893_f = MathHelper.func_76131_a(f, 1.0F, 2000.0F);
         break;
      case 136:
         f1 = this.field_175336_F.field_177894_g = MathHelper.func_76131_a(f, 1.0F, 2000.0F);
         break;
      case 137:
         f1 = this.field_175336_F.field_177915_h = MathHelper.func_76131_a(f, 0.01F, 20.0F);
         break;
      case 138:
         f1 = this.field_175336_F.field_177907_l = MathHelper.func_76131_a(f, 1.0F, 25.0F);
         break;
      case 139:
         f1 = this.field_175336_F.field_177899_b = MathHelper.func_76131_a(f, 1.0F, 6000.0F);
         break;
      case 140:
         f1 = this.field_175336_F.field_177900_c = MathHelper.func_76131_a(f, 1.0F, 6000.0F);
         break;
      case 141:
         f1 = this.field_175336_F.field_177909_m = MathHelper.func_76131_a(f, 0.01F, 50.0F);
         break;
      case 142:
         f1 = this.field_175336_F.field_177896_d = MathHelper.func_76131_a(f, 1.0F, 5000.0F);
         break;
      case 143:
         f1 = this.field_175336_F.field_177898_e = MathHelper.func_76131_a(f, 1.0F, 5000.0F);
         break;
      case 144:
         f1 = this.field_175336_F.field_177903_n = MathHelper.func_76131_a(f, 1.0F, 20.0F);
         break;
      case 145:
         f1 = this.field_175336_F.field_177905_o = MathHelper.func_76131_a(f, 0.0F, 20.0F);
         break;
      case 146:
         f1 = this.field_175336_F.field_177933_p = MathHelper.func_76131_a(f, 1.0F, 20.0F);
         break;
      case 147:
         f1 = this.field_175336_F.field_177931_q = MathHelper.func_76131_a(f, 0.0F, 20.0F);
      }
   ...
   private String func_175330_b(int p_175330_1_, float p_175330_2_) {
      ...
      case 162:
         ...
         } else if ((int)p_175330_2_ >= BiomeGenBase.field_76778_j.field_76756_M) {
            BiomeGenBase biomegenbase1 = BiomeGenBase.func_150565_n()[(int)p_175330_2_ + 2];
            return biomegenbase1 != null ? biomegenbase1.field_76791_y : "?";
         } else {
            BiomeGenBase biomegenbase = BiomeGenBase.func_150565_n()[(int)p_175330_2_];
            return biomegenbase != null ? biomegenbase.field_76791_y : "?";
         }
      }
   }
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      if (this.field_175339_B != 0) {
         ...
         worldrenderer.func_181662_b((double)(this.field_146294_l / 2 - 90), 185.0D, 0.0D).func_181673_a(0.0D, 2.65625D).func_181669_b(64, 64, 64, 64).func_181675_d();
         worldrenderer.func_181662_b((double)(this.field_146294_l / 2 + 90), 185.0D, 0.0D).func_181673_a(5.625D, 2.65625D).func_181669_b(64, 64, 64, 64).func_181675_d();
         worldrenderer.func_181662_b((double)(this.field_146294_l / 2 + 90), 100.0D, 0.0D).func_181673_a(5.625D, 0.0D).func_181669_b(64, 64, 64, 64).func_181675_d();
         worldrenderer.func_181662_b((double)(this.field_146294_l / 2 - 90), 100.0D, 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(64, 64, 64, 64).func_181675_d();
         ...
         this.field_175352_x.func_146112_a(this.field_146297_k, p_73863_1_, p_73863_2_);
         this.field_175351_y.func_146112_a(this.field_146297_k, p_73863_1_, p_73863_2_);
      }
