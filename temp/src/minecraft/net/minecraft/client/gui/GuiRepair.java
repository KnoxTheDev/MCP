...
public class GuiRepair extends GuiContainer implements ICrafting {
      ...
      if (this.field_147092_v.field_82854_e > 0) {
         ...
         if (flag) {
            ...
            if (this.field_146289_q.func_82883_a()) {
               func_73734_a(k - 3, l - 2, this.field_146999_f - 7, l + 10, -16777216);
               func_73734_a(k - 2, l - 1, this.field_146999_f - 8, l + 9, -12895429);
            } else {
               this.field_146289_q.func_78276_b(s, k, l + 1, j);
               this.field_146289_q.func_78276_b(s, k + 1, l, j);
               this.field_146289_q.func_78276_b(s, k + 1, l + 1, j);
            }

            this.field_146289_q.func_78276_b(s, k, l, i);
         }
      }
   ...
   private void func_147090_g() {
      ...
      this.field_146297_k.field_71439_g.field_71174_a.func_147297_a(new C17PacketCustomPayload("MC|ItemName", (new PacketBuffer(Unpooled.buffer())).func_180714_a(s)));
   }
