...
public class GuiEnchantment extends GuiContainer {
   ...
   protected void func_146976_a(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
      ...
      for(int l = 0; l < 3; ++l) {
         ...
         int j1 = i1 + 20;
         int k1 = 86;
         String s = EnchantmentNameParts.func_178176_a().func_148334_a();
         this.field_73735_i = 0.0F;
         this.field_146297_k.func_110434_K().func_110577_a(field_147078_C);
         int l1 = this.field_147075_G.field_75167_g[l];
         GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, 1.0F);
         if (l1 == 0) {
            ...
            int i2 = 6839882;
            if ((k < l + 1 || this.field_146297_k.field_71439_g.field_71068_ca < l1) && !this.field_146297_k.field_71439_g.field_71075_bZ.field_75098_d) {
               this.func_73729_b(i1, j + 14 + 19 * l, 0, 185, 108, 19);
               this.func_73729_b(i1 + 1, j + 15 + 19 * l, 16 * l, 239, 16, 16);
               fontrenderer.func_78279_b(s, j1, j + 16 + 19 * l, k1, (i2 & 16711422) >> 1);
               i2 = 4226832;
            } else {
               ...
               fontrenderer.func_78279_b(s, j1, j + 16 + 19 * l, k1, i2);
               i2 = 8453920;
            }

            fontrenderer = this.field_146297_k.field_71466_p;
            fontrenderer.func_175063_a(s1, (float)(j1 + 86 - fontrenderer.func_78256_a(s1)), (float)(j + 16 + 19 * l + 7), i2);
         }
      }
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      for(int j = 0; j < 3; ++j) {
         ...
         int l = this.field_147075_G.field_178151_h[j];
         int i1 = j + 1;
         if (this.func_146978_c(60, 14 + 19 * j, 108, 17, p_73863_1_, p_73863_2_) && k > 0 && l >= 0) {
            List<String> list = Lists.<String>newArrayList();
            if (l >= 0 && Enchantment.func_180306_c(l & 255) != null) {
               String s = Enchantment.func_180306_c(l & 255).func_77316_c((l & '\uff00') >> 8);
               list.add(EnumChatFormatting.WHITE.toString() + EnumChatFormatting.ITALIC.toString() + I18n.func_135052_a("container.enchant.clue", s));
            }
            ...
            if (!flag) {
               ...
               if (this.field_146297_k.field_71439_g.field_71068_ca < k) {
                  list.add(EnumChatFormatting.RED.toString() + "Level Requirement: " + this.field_147075_G.field_75167_g[j]);
               } else {
                  String s1 = "";
                  if (i1 == 1) {
                     s1 = I18n.func_135052_a("container.enchant.lapis.one");
                  } else {
                     s1 = I18n.func_135052_a("container.enchant.lapis.many", i1);
                  }
                  ...
                  if (i1 == 1) {
                     s1 = I18n.func_135052_a("container.enchant.level.one");
                  } else {
                     s1 = I18n.func_135052_a("container.enchant.level.many", i1);
                  }
   ...
   public void func_147068_g() {
      ...
      float f = 0.2F;
      f1 = MathHelper.func_76131_a(f1, -f, f);
