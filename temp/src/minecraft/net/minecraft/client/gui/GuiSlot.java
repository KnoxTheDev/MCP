...
public abstract class GuiSlot {
   ...
   public void func_148128_a(int p_148128_1_, int p_148128_2_, float p_148128_3_) {
      if (this.field_178041_q) {
         ...
         worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
         worldrenderer.func_181662_b((double)this.field_148152_e, (double)(this.field_148153_b + i1), 0.0D).func_181673_a(0.0D, 1.0D).func_181669_b(0, 0, 0, 0).func_181675_d();
         worldrenderer.func_181662_b((double)this.field_148151_d, (double)(this.field_148153_b + i1), 0.0D).func_181673_a(1.0D, 1.0D).func_181669_b(0, 0, 0, 0).func_181675_d();
         worldrenderer.func_181662_b((double)this.field_148151_d, (double)this.field_148153_b, 0.0D).func_181673_a(1.0D, 0.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
         worldrenderer.func_181662_b((double)this.field_148152_e, (double)this.field_148153_b, 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
         tessellator.func_78381_a();
         worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
         worldrenderer.func_181662_b((double)this.field_148152_e, (double)this.field_148154_c, 0.0D).func_181673_a(0.0D, 1.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
         worldrenderer.func_181662_b((double)this.field_148151_d, (double)this.field_148154_c, 0.0D).func_181673_a(1.0D, 1.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
         worldrenderer.func_181662_b((double)this.field_148151_d, (double)(this.field_148154_c - i1), 0.0D).func_181673_a(1.0D, 0.0D).func_181669_b(0, 0, 0, 0).func_181675_d();
         worldrenderer.func_181662_b((double)this.field_148152_e, (double)(this.field_148154_c - i1), 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(0, 0, 0, 0).func_181675_d();
         tessellator.func_78381_a();
         ...
         if (j1 > 0) {
            ...
            worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
            worldrenderer.func_181662_b((double)i, (double)this.field_148154_c, 0.0D).func_181673_a(0.0D, 1.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
            worldrenderer.func_181662_b((double)j, (double)this.field_148154_c, 0.0D).func_181673_a(1.0D, 1.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
            worldrenderer.func_181662_b((double)j, (double)this.field_148153_b, 0.0D).func_181673_a(1.0D, 0.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
            worldrenderer.func_181662_b((double)i, (double)this.field_148153_b, 0.0D).func_181673_a(0.0D, 0.0D).func_181669_b(0, 0, 0, 255).func_181675_d();
            tessellator.func_78381_a();
            worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
   ...
   protected void func_148120_b(int p_148120_1_, int p_148120_2_, int p_148120_3_, int p_148120_4_) {
      ...
      for(int j = 0; j < i; ++j) {
         ...
         this.func_180791_a(j, p_148120_1_, k, l, p_148120_3_, p_148120_4_);
      }
   ...
   protected void func_148136_c(int p_148136_1_, int p_148136_2_, int p_148136_3_, int p_148136_4_) {
      ...
      float f = 32.0F;
      worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
      worldrenderer.func_181662_b((double)this.field_148152_e, (double)p_148136_2_, 0.0D).func_181673_a(0.0D, (double)((float)p_148136_2_ / 32.0F)).func_181669_b(64, 64, 64, p_148136_4_).func_181675_d();
      worldrenderer.func_181662_b((double)(this.field_148152_e + this.field_148155_a), (double)p_148136_2_, 0.0D).func_181673_a((double)((float)this.field_148155_a / 32.0F), (double)((float)p_148136_2_ / 32.0F)).func_181669_b(64, 64, 64, p_148136_4_).func_181675_d();
      worldrenderer.func_181662_b((double)(this.field_148152_e + this.field_148155_a), (double)p_148136_1_, 0.0D).func_181673_a((double)((float)this.field_148155_a / 32.0F), (double)((float)p_148136_1_ / 32.0F)).func_181669_b(64, 64, 64, p_148136_3_).func_181675_d();
      worldrenderer.func_181662_b((double)this.field_148152_e, (double)p_148136_1_, 0.0D).func_181673_a(0.0D, (double)((float)p_148136_1_ / 32.0F)).func_181669_b(64, 64, 64, p_148136_3_).func_181675_d();
      tessellator.func_78381_a();
   }
