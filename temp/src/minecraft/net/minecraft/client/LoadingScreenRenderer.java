      ...
      if (!this.field_73725_b.field_71425_J) {
         ...
         if (i - this.field_73723_d >= 100L) {
            ...
            if (p_73718_1_ >= 0) {
               ...
               worldrenderer.func_181662_b((double)k1, (double)l1, 0.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
               worldrenderer.func_181662_b((double)k1, (double)(l1 + j1), 0.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
               worldrenderer.func_181662_b((double)(k1 + i1), (double)(l1 + j1), 0.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
               worldrenderer.func_181662_b((double)(k1 + i1), (double)l1, 0.0D).func_181669_b(128, 128, 128, 255).func_181675_d();
               worldrenderer.func_181662_b((double)k1, (double)l1, 0.0D).func_181669_b(128, 255, 128, 255).func_181675_d();
               worldrenderer.func_181662_b((double)k1, (double)(l1 + j1), 0.0D).func_181669_b(128, 255, 128, 255).func_181675_d();
               worldrenderer.func_181662_b((double)(k1 + p_73718_1_), (double)(l1 + j1), 0.0D).func_181669_b(128, 255, 128, 255).func_181675_d();
               worldrenderer.func_181662_b((double)(k1 + p_73718_1_), (double)l1, 0.0D).func_181669_b(128, 255, 128, 255).func_181675_d();
               tessellator.func_78381_a();
