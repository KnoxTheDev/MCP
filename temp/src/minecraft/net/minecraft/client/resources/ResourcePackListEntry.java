...
public abstract class ResourcePackListEntry implements GuiListExtended.IGuiListEntry {
   ...
   public void func_180790_a(int p_180790_1_, int p_180790_2_, int p_180790_3_, int p_180790_4_, int p_180790_5_, int p_180790_6_, int p_180790_7_, boolean p_180790_8_) {
      ...
      for(int l = 0; l < 2 && l < list.size(); ++l) {
         this.field_148317_a.field_71466_p.func_175063_a(list.get(l), (float)(p_180790_2_ + 32 + 2), (float)(p_180790_3_ + 12 + 10 * l), 8421504);
      }
   ...
   public boolean func_148278_a(int p_148278_1_, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_, int p_148278_6_) {
      if (this.func_148310_d() && p_148278_5_ <= 32) {
         if (this.func_148309_e()) {
            ...
            if (j != 1) {
               String s1 = I18n.func_135052_a("resourcePack.incompatible.confirm.title");
               String s = I18n.func_135052_a("resourcePack.incompatible.confirm." + (j > 1 ? "new" : "old"));
