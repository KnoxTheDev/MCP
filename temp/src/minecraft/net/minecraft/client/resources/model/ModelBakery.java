...
public class ModelBakery {
   ...
   private RegistrySimple<ModelResourceLocation, IBakedModel> field_177605_n = new RegistrySimple<ModelResourceLocation, IBakedModel>();
   ...
   private void func_177577_b() {
      ...
      this.field_177612_i.put(field_177604_a, new ModelBlockDefinition.Variants(field_177604_a.func_177518_c(), Lists.newArrayList(new ModelBlockDefinition.Variant(new ResourceLocation(field_177604_a.func_110623_a()), ModelRotation.X0_Y0, false, 1))));
   ...
   private void func_177591_a(Collection<ModelResourceLocation> p_177591_1_) {
      for(ModelResourceLocation modelresourcelocation : p_177591_1_) {
         try {
            ...
            field_177603_c.warn("Unable to load definition " + modelresourcelocation, (Throwable)exception);
         }
      }
   ...
   private void func_177595_c() {
      for(ModelResourceLocation modelresourcelocation : this.field_177612_i.keySet()) {
         for(ModelBlockDefinition.Variant modelblockdefinition$variant : (this.field_177612_i.get(modelresourcelocation)).func_178420_b()) {
            ...
            if (this.field_177611_h.get(resourcelocation) == null) {
               try {
                  ...
                  field_177603_c.warn("Unable to load block model: '" + resourcelocation + "' for variant: '" + modelresourcelocation + "'", (Throwable)exception);
               }
            }
         }
      }
   ...
   private ModelBlock func_177594_c(ResourceLocation p_177594_1_) throws IOException {
      ...
      if ("builtin/generated".equals(s)) {
         ...
         if (s.startsWith("builtin/")) {
            ...
            String s2 = field_177600_d.get(s1);
            if (s2 == null) {
         ...
         for(String s : this.func_177596_a(item)) {
            ...
            if (this.field_177611_h.get(resourcelocation) == null) {
               try {
                  ...
                  field_177603_c.warn("Unable to load item model: '" + resourcelocation + "' for item: '" + Item.field_150901_e.func_177774_c(item) + "'", (Throwable)exception);
               }
            }
         }
      }
   ...
   private void func_177592_e() {
      ...
      this.field_177613_u.put(Items.field_151031_f, Lists.newArrayList("bow", "bow_pulling_0", "bow_pulling_1", "bow_pulling_2"));
      this.field_177613_u.put(Items.field_151044_h, Lists.newArrayList("coal", "charcoal"));
      this.field_177613_u.put(Items.field_151112_aM, Lists.newArrayList("fishing_rod", "fishing_rod_cast"));
      ...
      this.field_177613_u.put(Items.field_151068_bn, Lists.newArrayList("bottle_drinkable", "bottle_splash"));
      this.field_177613_u.put(Items.field_151144_bL, Lists.newArrayList("skull_skeleton", "skull_wither", "skull_zombie", "skull_char", "skull_creeper"));
   ...
   private void func_177588_f() {
      for(ModelResourceLocation modelresourcelocation : this.field_177612_i.keySet()) {
         ...
         for(ModelBlockDefinition.Variant modelblockdefinition$variant : (this.field_177612_i.get(modelresourcelocation)).func_178420_b()) {
            ModelBlock modelblock = this.field_177611_h.get(modelblockdefinition$variant.func_178431_a());
      ...
      for(Entry<String, ResourceLocation> entry : this.field_177615_s.entrySet()) {
         ...
         ModelBlock modelblock1 = this.field_177611_h.get(resourcelocation);
   ...
   private Set<ResourceLocation> func_177575_g() {
      ...
      for(ModelResourceLocation modelresourcelocation : list) {
         ModelBlockDefinition.Variants modelblockdefinition$variants = this.field_177612_i.get(modelresourcelocation);
   ...
   private void func_177574_i() {
      ...
      while(!deque.isEmpty()) {
         ...
         try {
            ...
            field_177603_c.warn("In parent chain: " + field_177601_e.join(this.func_177573_e(resourcelocation2)) + "; unable to load model: '" + resourcelocation2 + "'", (Throwable)exception);
         }
