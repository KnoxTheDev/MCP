...
public class IMetadataSerializer {
   private final IRegistry<String, IMetadataSerializer.Registration<? extends IMetadataSection>> field_110508_a = new RegistrySimple<String, IMetadataSerializer.Registration<? extends IMetadataSection>>();
