   ...
   public void func_135043_a(List<IResourcePack> p_135043_1_) {
      ...
      for(IResourcePack iresourcepack : p_135043_1_) {
         try {
            ...
            field_147648_b.warn("Unable to parse metadata section of resourcepack: " + iresourcepack.func_130077_b(), (Throwable)runtimeexception);
         } catch (IOException ioexception) {
            field_147648_b.warn("Unable to parse metadata section of resourcepack: " + iresourcepack.func_130077_b(), (Throwable)ioexception);
         }
      }
