...
public class ShaderLoader {
   ...
   public static ShaderLoader func_148057_a(IResourceManager p_148057_0_, ShaderLoader.ShaderType p_148057_1_, String p_148057_2_) throws IOException {
      ...
      if (shaderloader == null) {
         ...
         BufferedInputStream bufferedinputstream = new BufferedInputStream(p_148057_0_.func_110536_a(resourcelocation).func_110527_b());
         byte[] abyte = func_177064_a(bufferedinputstream);
