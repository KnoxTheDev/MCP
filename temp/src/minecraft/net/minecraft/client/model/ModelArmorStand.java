...
public class ModelArmorStand extends ModelArmorStandArmor {
   ...
   public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_) {
      ...
      if (p_78087_7_ instanceof EntityArmorStand) {
         ...
         float f = (entityarmorstand.func_175403_w().func_179415_b() + entityarmorstand.func_175407_x().func_179415_b()) / 2.0F;
         float f1 = (entityarmorstand.func_175403_w().func_179416_c() + entityarmorstand.func_175407_x().func_179416_c()) / 2.0F;
         float f2 = (entityarmorstand.func_175403_w().func_179413_d() + entityarmorstand.func_175407_x().func_179413_d()) / 2.0F;
   ...
   public void func_178718_a(float p_178718_1_) {
      boolean flag = this.field_178723_h.field_78806_j;
      this.field_178723_h.field_78806_j = true;
      super.func_178718_a(p_178718_1_);
      this.field_178723_h.field_78806_j = flag;
   }
}
