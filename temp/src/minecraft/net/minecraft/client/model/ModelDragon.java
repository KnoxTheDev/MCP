...
public class ModelDragon extends ModelBase {
   ...
   public ModelDragon(float p_i46360_1_) {
      ...
      this.field_78221_a.func_78786_a("upperlip", -6.0F, -1.0F, -8.0F + f, 12, 5, 16);
      this.field_78221_a.func_78786_a("upperhead", -8.0F, -8.0F, 6.0F + f, 16, 16, 16);
      this.field_78221_a.field_78809_i = true;
      this.field_78221_a.func_78786_a("scale", -5.0F, -12.0F, 12.0F + f, 2, 4, 6);
      this.field_78221_a.func_78786_a("nostril", -5.0F, -3.0F, -6.0F + f, 2, 2, 4);
      this.field_78221_a.field_78809_i = false;
      this.field_78221_a.func_78786_a("scale", 3.0F, -12.0F, 12.0F + f, 2, 4, 6);
      this.field_78221_a.func_78786_a("nostril", 3.0F, -3.0F, -6.0F + f, 2, 2, 4);
      this.field_78220_c = new ModelRenderer(this, "jaw");
      this.field_78220_c.func_78793_a(0.0F, 4.0F, 8.0F + f);
   ...
   public void func_78088_a(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_) {
      ...
      this.field_78220_c.field_78795_f = (float)(Math.sin((double)(f * 3.1415927F * 2.0F)) + 1.0D) * 0.2F;
      float f1 = (float)(Math.sin((double)(f * 3.1415927F * 2.0F - 1.0F)) + 1.0D);
      ...
      for(int i = 0; i < 5; ++i) {
         ...
         this.field_78219_b.field_78796_g = this.func_78214_a(adouble1[0] - adouble[0]) * 3.1415927F / 180.0F * f5;
         this.field_78219_b.field_78795_f = f9 + (float)(adouble1[1] - adouble[1]) * 3.1415927F / 180.0F * f5 * 5.0F;
         this.field_78219_b.field_78808_h = -this.func_78214_a(adouble1[0] - (double)f7) * 3.1415927F / 180.0F * f5;
      ...
      this.field_78221_a.field_78796_g = this.func_78214_a(adouble2[0] - adouble[0]) * 3.1415927F / 180.0F * 1.0F;
      this.field_78221_a.field_78808_h = -this.func_78214_a(adouble2[0] - (double)f7) * 3.1415927F / 180.0F * 1.0F;
      this.field_78221_a.func_78785_a(p_78088_7_);
      GlStateManager.func_179094_E();
      GlStateManager.func_179109_b(0.0F, 1.0F, 0.0F);
      GlStateManager.func_179114_b(-f6 * f5 * 1.0F, 0.0F, 0.0F, 1.0F);
      GlStateManager.func_179109_b(0.0F, -1.0F, 0.0F);
      ...
      float f10 = -((float)Math.sin((double)(f * 3.1415927F * 2.0F))) * 0.0F;
      ...
      for(int k = 0; k < 12; ++k) {
         ...
         this.field_78219_b.field_78796_g = (this.func_78214_a(adouble2[0] - adouble[0]) * f5 + 180.0F) * 3.1415927F / 180.0F;
         this.field_78219_b.field_78795_f = f10 + (float)(adouble2[1] - adouble[1]) * 3.1415927F / 180.0F * f5 * 5.0F;
         this.field_78219_b.field_78808_h = this.func_78214_a(adouble2[0] - (double)f7) * 3.1415927F / 180.0F * f5;
         this.field_78219_b.field_78797_d = f2;
         this.field_78219_b.field_78798_e = f3;
         this.field_78219_b.field_78800_c = f4;
         f2 = (float)((double)f2 + Math.sin((double)this.field_78219_b.field_78795_f) * 10.0D);
