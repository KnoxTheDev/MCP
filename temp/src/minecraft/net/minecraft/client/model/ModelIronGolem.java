...
public class ModelIronGolem extends ModelBase {
   ...
   public ModelIronGolem(float p_i46362_1_, float p_i46362_2_) {
      int i = 128;
      int j = 128;
      this.field_78178_a = (new ModelRenderer(this)).func_78787_b(i, j);
      ...
      this.field_78176_b = (new ModelRenderer(this)).func_78787_b(i, j);
      ...
      this.field_78177_c = (new ModelRenderer(this)).func_78787_b(i, j);
      ...
      this.field_78174_d = (new ModelRenderer(this)).func_78787_b(i, j);
      ...
      this.field_78175_e = (new ModelRenderer(this, 0, 22)).func_78787_b(i, j);
      ...
      this.field_78173_f = (new ModelRenderer(this, 0, 22)).func_78787_b(i, j);
