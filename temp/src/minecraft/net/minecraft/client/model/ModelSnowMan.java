...
public class ModelSnowMan extends ModelBase {
   ...
   public ModelSnowMan() {
      ...
      this.field_78195_c.func_78790_a(-4.0F, -8.0F, -4.0F, 8, 8, 8, f1 - 0.5F);
      this.field_78195_c.func_78793_a(0.0F, 0.0F + f, 0.0F);
      this.field_78192_d = (new ModelRenderer(this, 32, 0)).func_78787_b(64, 64);
      this.field_78192_d.func_78790_a(-1.0F, 0.0F, -1.0F, 12, 2, 2, f1 - 0.5F);
      ...
      this.field_78193_e.func_78790_a(-1.0F, 0.0F, -1.0F, 12, 2, 2, f1 - 0.5F);
      ...
      this.field_78196_a.func_78790_a(-5.0F, -10.0F, -5.0F, 10, 10, 10, f1 - 0.5F);
      this.field_78196_a.func_78793_a(0.0F, 0.0F + f + 9.0F, 0.0F);
      this.field_78194_b = (new ModelRenderer(this, 0, 36)).func_78787_b(64, 64);
      this.field_78194_b.func_78790_a(-6.0F, -12.0F, -6.0F, 12, 12, 12, f1 - 0.5F);
