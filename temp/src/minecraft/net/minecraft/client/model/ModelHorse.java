...
public class ModelHorse extends ModelBase {
   ...
   public void func_78088_a(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_) {
      ...
      float f = entityhorse.func_110258_o(0.0F);
      ...
      float f1 = entityhorse.func_110254_bY();
   ...
   public void func_78086_a(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_) {
      ...
      float f5 = entityhorse.func_110258_o(p_78086_4_);
      float f6 = entityhorse.func_110223_p(p_78086_4_);
      float f7 = 1.0F - f6;
      float f8 = entityhorse.func_110201_q(p_78086_4_);
      ...
      this.field_110709_a.field_78796_g = f3 / 57.295776F;
      this.field_110709_a.field_78795_f = f6 * (0.2617994F + f4) + f5 * 2.18166F + (1.0F - Math.max(f6, f5)) * this.field_110709_a.field_78795_f;
      this.field_110709_a.field_78796_g = f6 * f3 / 57.295776F + (1.0F - Math.max(f6, f5)) * this.field_110709_a.field_78796_g;
      ...
      this.field_110715_k.field_78795_f = f6 * -45.0F / 57.295776F + f7 * this.field_110715_k.field_78795_f;
      ...
      this.field_178711_b.field_78798_e = 0.02F - f8 * 1.0F;
      this.field_178712_c.field_78798_e = 0.0F + f8 * 1.0F;
      ...
      this.field_178711_b.field_78795_f = 0.0F - 0.09424778F * f8;
      this.field_178712_c.field_78795_f = 0.0F + 0.15707964F * f8;
      ...
      float f16 = MathHelper.func_76134_b(f9 * 0.6F + 3.1415927F);
      ...
      this.field_110719_v.field_78797_d = this.field_110711_o.field_78797_d + MathHelper.func_76126_a(1.5707964F + f15 + f7 * -f10 * 0.5F * p_78086_3_) * 7.0F;
      this.field_110719_v.field_78798_e = this.field_110711_o.field_78798_e + MathHelper.func_76134_b(4.712389F + f15 + f7 * -f10 * 0.5F * p_78086_3_) * 7.0F;
      this.field_110721_y.field_78797_d = this.field_110722_x.field_78797_d + MathHelper.func_76126_a(1.5707964F + f15 + f7 * f10 * 0.5F * p_78086_3_) * 7.0F;
      this.field_110721_y.field_78798_e = this.field_110722_x.field_78798_e + MathHelper.func_76134_b(4.712389F + f15 + f7 * f10 * 0.5F * p_78086_3_) * 7.0F;
      float f17 = (-1.0471976F + f16) * f6 + f11 * f7;
      float f18 = (-1.0471976F + -f16) * f6 + -f11 * f7;
      this.field_110689_B.field_78797_d = this.field_110688_A.field_78797_d + MathHelper.func_76126_a(1.5707964F + f17) * 7.0F;
      this.field_110689_B.field_78798_e = this.field_110688_A.field_78798_e + MathHelper.func_76134_b(4.712389F + f17) * 7.0F;
      this.field_110685_E.field_78797_d = this.field_110684_D.field_78797_d + MathHelper.func_76126_a(1.5707964F + f18) * 7.0F;
      this.field_110685_E.field_78798_e = this.field_110684_D.field_78798_e + MathHelper.func_76134_b(4.712389F + f18) * 7.0F;
      this.field_110711_o.field_78795_f = f15 + -f10 * 0.5F * p_78086_3_ * f7;
      ...
      this.field_110722_x.field_78795_f = f15 + f10 * 0.5F * p_78086_3_ * f7;
      ...
      this.field_110688_A.field_78795_f = f17;
      this.field_110689_B.field_78795_f = (this.field_110688_A.field_78795_f + 3.1415927F * Math.max(0.0F, 0.2F + f16 * 0.2F)) * f6 + (f11 + Math.max(0.0F, f10 * 0.5F * p_78086_3_)) * f7;
      this.field_110690_C.field_78795_f = this.field_110689_B.field_78795_f;
      this.field_110684_D.field_78795_f = f18;
      this.field_110685_E.field_78795_f = (this.field_110684_D.field_78795_f + 3.1415927F * Math.max(0.0F, 0.2F - f16 * 0.2F)) * f6 + (-f11 + Math.max(0.0F, -f10 * 0.5F * p_78086_3_)) * f7;
      ...
      this.field_110710_n.field_78795_f = -0.2618F + f12;
   }
}
