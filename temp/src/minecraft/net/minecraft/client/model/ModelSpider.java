...
public class ModelSpider extends ModelBase {
   ...
   public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_) {
      ...
      float f = 0.7853982F;
      this.field_78205_d.field_78808_h = -f;
      this.field_78206_e.field_78808_h = f;
      this.field_78203_f.field_78808_h = -f * 0.74F;
      this.field_78204_g.field_78808_h = f * 0.74F;
      this.field_78212_h.field_78808_h = -f * 0.74F;
      this.field_78213_i.field_78808_h = f * 0.74F;
      this.field_78210_j.field_78808_h = -f;
      this.field_78211_k.field_78808_h = f;
      float f1 = -0.0F;
      float f2 = 0.3926991F;
      this.field_78205_d.field_78796_g = f2 * 2.0F + f1;
      this.field_78206_e.field_78796_g = -f2 * 2.0F - f1;
      this.field_78203_f.field_78796_g = f2 * 1.0F + f1;
      this.field_78204_g.field_78796_g = -f2 * 1.0F - f1;
      this.field_78212_h.field_78796_g = -f2 * 1.0F + f1;
      this.field_78213_i.field_78796_g = f2 * 1.0F - f1;
      this.field_78210_j.field_78796_g = -f2 * 2.0F + f1;
      this.field_78211_k.field_78796_g = f2 * 2.0F - f1;
