...
public class ChatController {
   ...
   protected HashMap<String, ChatController.ChatChannelListener> field_175998_i = new HashMap<String, ChatController.ChatChannelListener>();
   ...
   public class ChatChannelListener implements IChatChannelListener {
      ...
      protected LinkedList<ChatRawMessage> field_176045_e = new LinkedList<ChatRawMessage>();
      protected LinkedList<ChatTokenizedMessage> field_176042_f = new LinkedList<ChatTokenizedMessage>();
