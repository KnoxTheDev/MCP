...
public class BroadcastController {
   ...
   public long func_177946_b(String p_177946_1_, long p_177946_2_, String p_177946_4_, String p_177946_5_) {
      long i = this.field_152873_i.sendStartSpanMetaData(this.field_152885_u, p_177946_1_, p_177946_2_, p_177946_4_, p_177946_5_);
      if (i == -1L) {
   ...
   public boolean func_177947_a(String p_177947_1_, long p_177947_2_, long p_177947_4_, String p_177947_6_, String p_177947_7_) {
      if (p_177947_4_ == -1L) {
         ...
         ErrorCode errorcode = this.field_152873_i.sendEndSpanMetaData(this.field_152885_u, p_177947_1_, p_177947_2_, p_177947_4_, p_177947_6_, p_177947_7_);
         if (ErrorCode.failed(errorcode)) {
            String s = ErrorCode.getString(errorcode);
   ...
   public void func_152846_a(FrameBuffer p_152846_1_) {
      try {
         ...
         CrashReport crashreport = CrashReport.func_85055_a(throwable, "Trying to submit a frame to Twitch");
         CrashReportCategory crashreportcategory = crashreport.func_85058_a("Broadcast State");
         crashreportcategory.func_71507_a("Last reported errors", Arrays.toString(field_152862_C.func_152756_c()));
         crashreportcategory.func_71507_a("Buffer", p_152846_1_);
         crashreportcategory.func_71507_a("Free buffer count", Integer.valueOf(this.field_152875_k.size()));
         crashreportcategory.func_71507_a("Capture buffer count", Integer.valueOf(this.field_152874_j.size()));
