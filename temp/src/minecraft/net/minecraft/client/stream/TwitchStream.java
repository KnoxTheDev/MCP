...
public class TwitchStream implements BroadcastController.BroadcastListener, ChatController.ChatListener, IngestServerTester.IngestTestListener, IStream {
            ...
            public void run() {
               try {
                  ...
                  if (JsonUtils.func_151212_i(jsonobject1, "valid")) {
                     ...
                     TwitchStream.field_152950_b.debug(TwitchStream.field_152949_a, "Authenticated with twitch; username is {}", s1);
                  ...
                  TwitchStream.field_152950_b.error(TwitchStream.field_152949_a, "Could not authenticate with twitch", (Throwable)ioexception);
               }
   ...
   protected void func_152942_I() {
      ...
      if (chatcontroller$chatstate != ChatController.ChatState.Initialized) {
         field_152950_b.warn("Invalid twitch chat state {}", chatcontroller$chatstate);
   ...
   public void func_152911_a(Metadata p_152911_1_, long p_152911_2_) {
      if (this.func_152934_n() && this.field_152957_i) {
         ...
         if (!this.field_152951_c.func_152840_a(p_152911_1_.func_152810_c(), i + p_152911_2_, p_152911_1_.func_152809_a(), p_152911_1_.func_152806_b())) {
            field_152950_b.warn(field_152949_a, "Couldn't send stream metadata action at {}: {}", i + p_152911_2_, p_152911_1_);
         } else {
            field_152950_b.debug(field_152949_a, "Sent stream metadata action at {}: {}", i + p_152911_2_, p_152911_1_);
         }
   ...
   public void func_176026_a(Metadata p_176026_1_, long p_176026_2_, long p_176026_4_) {
      if (this.func_152934_n() && this.field_152957_i) {
         ...
         if (j < 0L) {
            field_152950_b.warn(field_152949_a, "Could not send stream metadata sequence from {} to {}: {}", i + p_176026_2_, i + p_176026_4_, p_176026_1_);
         } else if (this.field_152951_c.func_177947_a(p_176026_1_.func_152810_c(), i + p_176026_4_, j, s, s1)) {
            field_152950_b.debug(field_152949_a, "Sent stream metadata sequence from {} to {}: {}", i + p_176026_2_, i + p_176026_4_, p_176026_1_);
         } else {
            field_152950_b.warn(field_152949_a, "Half-sent stream metadata sequence from {} to {}: {}", i + p_176026_2_, i + p_176026_4_, p_176026_1_);
         }
   ...
   public void func_152930_t() {
      ...
      field_152950_b.info(field_152949_a, "Streaming at {}/{} at {} kbps to {}", videoparams.outputWidth, videoparams.outputHeight, videoparams.maxKbps, this.field_152951_c.func_152833_s().serverUrl);
   ...
   private boolean func_176028_a(Set<ChatUserMode> p_176028_1_, Set<ChatUserSubscription> p_176028_2_, int p_176028_3_) {
      if (p_176028_1_.contains(ChatUserMode.TTV_CHAT_USERMODE_BANNED)) {
         return false;
      } else if (p_176028_1_.contains(ChatUserMode.TTV_CHAT_USERMODE_ADMINSTRATOR)) {
         return true;
      } else if (p_176028_1_.contains(ChatUserMode.TTV_CHAT_USERMODE_MODERATOR)) {
         return true;
      } else if (p_176028_1_.contains(ChatUserMode.TTV_CHAT_USERMODE_STAFF)) {
         return true;
      } else if (p_176028_3_ == 0) {
         return true;
      } else {
