   ...
   public ItemStack func_75144_a(int p_75144_1_, int p_75144_2_, int p_75144_3_, EntityPlayer p_75144_4_) {
      ...
      if (p_75144_3_ == 5) {
         ...
         if (p_75144_1_ == -999) {
            ...
            Slot slot6 = this.field_75151_b.get(p_75144_1_);
            ...
            Slot slot7 = this.field_75151_b.get(p_75144_1_);
            if (slot7 != null) {
         ...
         Slot slot5 = this.field_75151_b.get(p_75144_1_);
         ...
         Slot slot4 = this.field_75151_b.get(p_75144_1_);
         ...
         Slot slot3 = this.field_75151_b.get(p_75144_1_);
         ...
         Slot slot2 = this.field_75151_b.get(p_75144_1_);
         ...
         if (itemstack4 != null && (slot2 == null || !slot2.func_75216_d() || !slot2.func_82869_a(p_75144_4_))) {
            ...
            for(int l2 = 0; l2 < 2; ++l2) {
               for(int i3 = i1; i3 >= 0 && i3 < this.field_75151_b.size() && itemstack4.field_77994_a < itemstack4.func_77976_d(); i3 += j1) {
                  Slot slot8 = this.field_75151_b.get(i3);
