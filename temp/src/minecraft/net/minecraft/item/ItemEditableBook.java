...
public class ItemEditableBook extends Item {
   ...
   public static boolean func_77828_a(NBTTagCompound p_77828_0_) {
      if (!ItemWritableBook.func_150930_a(p_77828_0_)) {
         ...
         if (s != null && s.length() <= 32) {
            return p_77828_0_.func_150297_b("author", 8);
         } else {
            return false;
         }
      }
   ...
   public void func_77624_a(ItemStack p_77624_1_, EntityPlayer p_77624_2_, List<String> p_77624_3_, boolean p_77624_4_) {
      if (p_77624_1_.func_77942_o()) {
         ...
         if (!StringUtils.func_151246_b(s)) {
            p_77624_3_.add(EnumChatFormatting.GRAY + StatCollector.func_74837_a("book.byAuthor", s));
         }
         ...
         if (!nbttagcompound.func_74767_n("resolved")) {
            ...
            if (func_77828_a(nbttagcompound)) {
               ...
               for(int i = 0; i < nbttaglist.func_74745_c(); ++i) {
                  ...
                  try {
                     lvt_7_1_ = IChatComponent.Serializer.func_150699_a(s);
                     lvt_7_1_ = ChatComponentProcessor.func_179985_a(p_179229_2_, lvt_7_1_, p_179229_2_);
                  } catch (Exception var9) {
                     lvt_7_1_ = new ChatComponentText(s);
                  }

                  nbttaglist.func_150304_a(i, new NBTTagString(IChatComponent.Serializer.func_150696_a(lvt_7_1_)));
               }
