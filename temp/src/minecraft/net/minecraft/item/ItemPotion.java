      ...
      if (p_77624_1_.func_77960_j() != 0) {
         ...
         if (!multimap.isEmpty()) {
            ...
            for(Entry<String, AttributeModifier> entry1 : multimap.entries()) {
               ...
               if (d0 > 0.0D) {
                  p_77624_3_.add(EnumChatFormatting.BLUE + StatCollector.func_74837_a("attribute.modifier.plus." + attributemodifier2.func_111169_c(), ItemStack.field_111284_a.format(d1), StatCollector.func_74838_a("attribute.name." + (String)entry1.getKey())));
               } else if (d0 < 0.0D) {
                  d1 = d1 * -1.0D;
                  p_77624_3_.add(EnumChatFormatting.RED + StatCollector.func_74837_a("attribute.modifier.take." + attributemodifier2.func_111169_c(), ItemStack.field_111284_a.format(d1), StatCollector.func_74838_a("attribute.name." + (String)entry1.getKey())));
               }
            }
         }
