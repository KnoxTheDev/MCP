...
public class RecipesBanners {
   void func_179534_a(CraftingManager p_179534_1_) {
      for(EnumDyeColor enumdyecolor : EnumDyeColor.values()) {
         p_179534_1_.func_92103_a(new ItemStack(Items.field_179564_cE, 1, enumdyecolor.func_176767_b()), "###", "###", " | ", '#', new ItemStack(Blocks.field_150325_L, 1, enumdyecolor.func_176765_a()), '|', Items.field_151055_y);
      }
               ...
               if (tileentitybanner$enumbannerpattern.func_177269_e()) {
                  ...
                  for(int k = 0; k < p_179533_1_.func_70302_i_() && flag; ++k) {
                     ...
                     if (itemstack1 != null && itemstack1.func_77973_b() != Items.field_179564_cE) {
                        ...
                        if (tileentitybanner$enumbannerpattern.func_177267_c()[l].charAt(i1) == ' ') {
                           flag = false;
                           break;
                        }

                        j = itemstack1.func_77960_j();
                     } else if (tileentitybanner$enumbannerpattern.func_177267_c()[l].charAt(i1) != ' ') {
                        flag = false;
                        break;
                     }
                  }
