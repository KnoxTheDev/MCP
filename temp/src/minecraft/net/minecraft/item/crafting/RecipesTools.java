   ...
   public void func_77586_a(CraftingManager p_77586_1_) {
      for(int i = 0; i < this.field_77587_b[0].length; ++i) {
         ...
         for(int j = 0; j < this.field_77587_b.length - 1; ++j) {
            ...
            p_77586_1_.func_92103_a(new ItemStack(item), this.field_77588_a[j], '#', Items.field_151055_y, 'X', object);
         }
      }

      p_77586_1_.func_92103_a(new ItemStack(Items.field_151097_aZ), " #", "# ", '#', Items.field_151042_j);
   }
}
