...
public class Teleporter {
   ...
   private final LongHashMap<Teleporter.PortalPosition> field_85191_c = new LongHashMap<Teleporter.PortalPosition>();
   private final List<Long> field_85190_d = Lists.<Long>newArrayList();
   ...
   public boolean func_180620_b(Entity p_180620_1_, float p_180620_2_) {
      ...
      long l = ChunkCoordIntPair.func_77272_a(j, k);
      if (this.field_85191_c.func_76161_b(l)) {
         Teleporter.PortalPosition teleporter$portalposition = this.field_85191_c.func_76164_a(l);
         d0 = 0.0D;
      ...
      if (d0 >= 0.0D) {
         if (flag) {
            this.field_85191_c.func_76163_a(l, new Teleporter.PortalPosition(blockpos, this.field_85192_a.func_82737_E()));
            this.field_85190_d.add(Long.valueOf(l));
         }

         double d5 = (double)blockpos.func_177958_n() + 0.5D;
         double d6 = (double)blockpos.func_177956_o() + 0.5D;
         ...
         d6 = (double)(blockpattern$patternhelper.func_181117_a().func_177956_o() + 1) - p_180620_1_.func_181014_aG().field_72448_b * (double)blockpattern$patternhelper.func_181119_e();
         if (flag1) {
            ++d2;
         }
   ...
   public boolean func_85188_a(Entity p_85188_1_) {
                     ...
                     for(int j4 = 0; j4 < 3; ++j4) {
                        for(int k4 = 0; k4 < 4; ++k4) {
                           for(int l4 = -1; l4 < 4; ++l4) {
                              ...
                              if (l4 < 0 && !this.field_85192_a.func_180495_p(blockpos$mutableblockpos).func_177230_c().func_149688_o().func_76220_a() || l4 >= 0 && !this.field_85192_a.func_175623_d(blockpos$mutableblockpos)) {
                                 continue label293;
                              }
                           }
                        }
                     ...
                     for(int k7 = i2; k7 < i2 + 2; ++k7) {
                        ...
                        for(int j10 = 0; j10 < 4; ++j10) {
                           for(int j11 = -1; j11 < 4; ++j11) {
                              ...
                              if (j11 < 0 && !this.field_85192_a.func_180495_p(blockpos$mutableblockpos).func_177230_c().func_149688_o().func_76220_a() || j11 >= 0 && !this.field_85192_a.func_175623_d(blockpos$mutableblockpos)) {
                                 continue label231;
                              }
                           }
                        }
      ...
      IBlockState iblockstate = Blocks.field_150427_aO.func_176223_P().func_177226_a(BlockPortal.field_176550_a, l6 != 0 ? EnumFacing.Axis.X : EnumFacing.Axis.Z);
   ...
   public void func_85189_a(long p_85189_1_) {
      if (p_85189_1_ % 100L == 0L) {
         Iterator<Long> iterator = this.field_85190_d.iterator();
         long i = p_85189_1_ - 300L;

         while(iterator.hasNext()) {
            Long olong = iterator.next();
            Teleporter.PortalPosition teleporter$portalposition = this.field_85191_c.func_76164_a(olong.longValue());
