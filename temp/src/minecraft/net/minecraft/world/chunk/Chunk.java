...
public class Chunk {
   ...
   public int func_177413_a(EnumSkyBlock p_177413_1_, BlockPos p_177413_2_) {
      ...
      if (extendedblockstorage == null) {
         ...
         return this.field_76637_e.field_73011_w.func_177495_o() ? 0 : extendedblockstorage.func_76670_c(i, j & 15, k);
      } else {
   ...
   public void func_76612_a(Entity p_76612_1_) {
      ...
      if (i != this.field_76635_g || j != this.field_76647_h) {
         field_150817_t.warn("Wrong location! (" + i + ", " + j + ") should be (" + this.field_76635_g + ", " + this.field_76647_h + "), " + p_76612_1_, p_76612_1_);
