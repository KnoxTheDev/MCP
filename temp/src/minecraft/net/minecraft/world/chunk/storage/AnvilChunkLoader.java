...
public class AnvilChunkLoader implements IChunkLoader, IThreadedFileIO {
   ...
   private Map<ChunkCoordIntPair, NBTTagCompound> field_75828_a = new ConcurrentHashMap<ChunkCoordIntPair, NBTTagCompound>();
   ...
   public Chunk func_75815_a(World p_75815_1_, int p_75815_2_, int p_75815_3_) throws IOException {
      ...
      NBTTagCompound nbttagcompound = this.field_75828_a.get(chunkcoordintpair);
   ...
   public boolean func_75814_c() {
      if (this.field_75828_a.isEmpty()) {
         ...
         ChunkCoordIntPair chunkcoordintpair = this.field_75828_a.keySet().iterator().next();

         boolean lvt_3_1_;
         try {
            this.field_75826_b.add(chunkcoordintpair);
            NBTTagCompound nbttagcompound = this.field_75828_a.remove(chunkcoordintpair);
            if (nbttagcompound != null) {
               try {
