...
public class AnvilSaveConverter extends SaveFormatOld {
         ...
         for(File file1 : afile) {
            if (file1.isDirectory()) {
               ...
               if (worldinfo != null && (worldinfo.func_76088_k() == 19132 || worldinfo.func_76088_k() == 19133)) {
                  ...
                  long i = 0L;
                  list.add(new SaveFormatComparator(s, s1, worldinfo.func_76057_l(), i, worldinfo.func_76077_q(), flag, worldinfo.func_76093_s(), worldinfo.func_76086_u()));
               }
            }
         }
   ...
   public boolean func_75805_a(String p_75805_1_, IProgressUpdate p_75805_2_) {
      ...
      if (worldinfo.func_76067_t() == WorldType.field_77138_c) {
         worldchunkmanager = new WorldChunkManagerHell(BiomeGenBase.field_76772_c, 0.5F);
      } else {
         worldchunkmanager = new WorldChunkManager(worldinfo.func_76063_b(), worldinfo.func_76067_t(), worldinfo.func_82571_y());
      }

      this.func_75813_a(new File(file1, "region"), list, worldchunkmanager, 0, i, p_75805_2_);
      this.func_75813_a(new File(file2, "region"), list1, new WorldChunkManagerHell(BiomeGenBase.field_76778_j, 0.0F), list.size(), i, p_75805_2_);
      this.func_75813_a(new File(file3, "region"), list2, new WorldChunkManagerHell(BiomeGenBase.field_76779_k, 0.0F), list.size() + list1.size(), i, p_75805_2_);
