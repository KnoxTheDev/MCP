   ...
   public RegionFile(File p_i2001_1_) {
      ...
      try {
         ...
         if ((this.field_76719_c.length() & 4095L) != 0L) {
            for(int j1 = 0; (long)j1 < (this.field_76719_c.length() & 4095L); ++j1) {
               this.field_76719_c.write(0);
            }
         }

         int k1 = (int)this.field_76719_c.length() / 4096;
         this.field_76714_f = Lists.<Boolean>newArrayListWithCapacity(k1);
         ...
         for(int i2 = 0; i2 < 1024; ++i2) {
            int j2 = this.field_76719_c.readInt();
            this.field_76717_e[i2] = j2;
         }
