...
public class IntCache {
   ...
   private static List<int[]> field_76449_b = Lists.<int[]>newArrayList();
   private static List<int[]> field_76450_c = Lists.<int[]>newArrayList();
   private static List<int[]> field_76447_d = Lists.<int[]>newArrayList();
   private static List<int[]> field_76448_e = Lists.<int[]>newArrayList();
