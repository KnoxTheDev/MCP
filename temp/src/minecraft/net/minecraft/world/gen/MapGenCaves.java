...
public class MapGenCaves extends MapGenBase {
   ...
   protected void func_180702_a(long p_180702_1_, int p_180702_3_, int p_180702_4_, ChunkPrimer p_180702_5_, double p_180702_6_, double p_180702_8_, double p_180702_10_, float p_180702_12_, float p_180702_13_, float p_180702_14_, int p_180702_15_, int p_180702_16_, double p_180702_17_) {
      ...
      for(boolean flag = random.nextInt(6) == 0; p_180702_15_ < p_180702_16_; ++p_180702_15_) {
         double d2 = 1.5D + (double)(MathHelper.func_76126_a((float)p_180702_15_ * 3.1415927F / (float)p_180702_16_) * p_180702_12_ * 1.0F);
                        ...
                        if (d10 * d10 + d8 * d8 < 1.0D) {
                           for(int j2 = l; j2 > l2; --j2) {
                              ...
                              if (d9 > -0.7D && d10 * d10 + d9 * d9 + d8 * d8 < 1.0D) {
                                 ...
                                 IBlockState iblockstate2 = (IBlockState)Objects.firstNonNull(p_180702_5_.func_177856_a(j3, j2 + 1, i2), Blocks.field_150350_a.func_176223_P());
                                 ...
                                 if (this.func_175793_a(iblockstate1, iblockstate2)) {
                                    if (j2 - 1 < 10) {
                                       p_180702_5_.func_177855_a(j3, j2, i2, Blocks.field_150353_l.func_176223_P());
                                    } else {
                                       p_180702_5_.func_177855_a(j3, j2, i2, Blocks.field_150350_a.func_176223_P());
                                       if (iblockstate2.func_177230_c() == Blocks.field_150354_m) {
                                          p_180702_5_.func_177855_a(j3, j2 + 1, i2, iblockstate2.func_177229_b(BlockSand.field_176504_a) == BlockSand.EnumType.RED_SAND ? Blocks.field_180395_cM.func_176223_P() : Blocks.field_150322_A.func_176223_P());
                                       }
   ...
   protected boolean func_175793_a(IBlockState p_175793_1_, IBlockState p_175793_2_) {
      if (p_175793_1_.func_177230_c() == Blocks.field_150348_b) {
         ...
         return (p_175793_1_.func_177230_c() == Blocks.field_150354_m || p_175793_1_.func_177230_c() == Blocks.field_150351_n) && p_175793_2_.func_177230_c().func_149688_o() != Material.field_151586_h;
      }
   }
