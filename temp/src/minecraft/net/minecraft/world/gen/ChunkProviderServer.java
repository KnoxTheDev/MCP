...
public class ChunkProviderServer implements IChunkProvider {
   ...
   private LongHashMap<Chunk> field_73244_f = new LongHashMap<Chunk>();
   ...
   public Chunk func_73158_c(int p_73158_1_, int p_73158_2_) {
      ...
      Chunk chunk = this.field_73244_f.func_76164_a(i);
      if (chunk == null) {
   ...
   public Chunk func_73154_d(int p_73154_1_, int p_73154_2_) {
      Chunk chunk = this.field_73244_f.func_76164_a(ChunkCoordIntPair.func_77272_a(p_73154_1_, p_73154_2_));
      if (chunk == null) {
         return !this.field_73251_h.func_175686_ad() && !this.field_73250_a ? this.field_73249_c : this.func_73158_c(p_73154_1_, p_73154_2_);
      } else {
         return chunk;
      }
   }
      ...
      if (!this.field_73251_h.field_73058_d) {
         for(int i = 0; i < 100; ++i) {
            if (!this.field_73248_b.isEmpty()) {
               Long olong = this.field_73248_b.iterator().next();
               Chunk chunk = this.field_73244_f.func_76164_a(olong.longValue());
               if (chunk != null) {
                  chunk.func_76623_d();
                  this.func_73242_b(chunk);
                  this.func_73243_a(chunk);
