...
public class MapGenCavesHell extends MapGenBase {
   ...
   protected void func_180704_a(long p_180704_1_, int p_180704_3_, int p_180704_4_, ChunkPrimer p_180704_5_, double p_180704_6_, double p_180704_8_, double p_180704_10_, float p_180704_12_, float p_180704_13_, float p_180704_14_, int p_180704_15_, int p_180704_16_, double p_180704_17_) {
      ...
      for(boolean flag = random.nextInt(6) == 0; p_180704_15_ < p_180704_16_; ++p_180704_15_) {
         double d2 = 1.5D + (double)(MathHelper.func_76126_a((float)p_180704_15_ * 3.1415927F / (float)p_180704_16_) * p_180704_12_ * 1.0F);
         double d3 = d2 * p_180704_17_;
         float f2 = MathHelper.func_76134_b(p_180704_14_);
         float f3 = MathHelper.func_76126_a(p_180704_14_);
         p_180704_6_ += (double)(MathHelper.func_76134_b(p_180704_13_) * f2);
         p_180704_8_ += (double)f3;
         p_180704_10_ += (double)(MathHelper.func_76126_a(p_180704_13_) * f2);
         if (flag) {
         ...
         if (!flag1 && p_180704_15_ == j && p_180704_12_ > 1.0F) {
            this.func_180704_a(random.nextLong(), p_180704_3_, p_180704_4_, p_180704_5_, p_180704_6_, p_180704_8_, p_180704_10_, random.nextFloat() * 0.5F + 0.5F, p_180704_13_ - 1.5707964F, p_180704_14_ / 3.0F, p_180704_15_, p_180704_16_, 1.0D);
            this.func_180704_a(random.nextLong(), p_180704_3_, p_180704_4_, p_180704_5_, p_180704_6_, p_180704_8_, p_180704_10_, random.nextFloat() * 0.5F + 0.5F, p_180704_13_ + 1.5707964F, p_180704_14_ / 3.0F, p_180704_15_, p_180704_16_, 1.0D);
            return;
         }
         ...
         if (flag1 || random.nextInt(4) != 0) {
            ...
            if (p_180704_6_ >= d0 - 16.0D - d2 * 2.0D && p_180704_10_ >= d1 - 16.0D - d2 * 2.0D && p_180704_6_ <= d0 + 16.0D + d2 * 2.0D && p_180704_10_ <= d1 + 16.0D + d2 * 2.0D) {
               int j2 = MathHelper.func_76128_c(p_180704_6_ - d2) - p_180704_3_ * 16 - 1;
               int k = MathHelper.func_76128_c(p_180704_6_ + d2) - p_180704_3_ * 16 + 1;
               int k2 = MathHelper.func_76128_c(p_180704_8_ - d3) - 1;
               int l = MathHelper.func_76128_c(p_180704_8_ + d3) + 1;
               int l2 = MathHelper.func_76128_c(p_180704_10_ - d2) - p_180704_4_ * 16 - 1;
               int i1 = MathHelper.func_76128_c(p_180704_10_ + d2) - p_180704_4_ * 16 + 1;
               if (j2 < 0) {
                  j2 = 0;
               }
                  ...
                  for(int k1 = l2; !flag2 && k1 < i1; ++k1) {
                     for(int l1 = l + 1; !flag2 && l1 >= k2 - 1; --l1) {
                        if (l1 >= 0 && l1 < 128) {
                           ...
                           if (iblockstate.func_177230_c() == Blocks.field_150356_k || iblockstate.func_177230_c() == Blocks.field_150353_l) {
                              flag2 = true;
                           }
                     ...
                     for(int j3 = l2; j3 < i1; ++j3) {
                        ...
                        for(int i2 = l; i2 > k2; --i2) {
                           ...
                           if (d9 > -0.7D && d10 * d10 + d9 * d9 + d8 * d8 < 1.0D) {
                              ...
                              if (iblockstate1.func_177230_c() == Blocks.field_150424_aL || iblockstate1.func_177230_c() == Blocks.field_150346_d || iblockstate1.func_177230_c() == Blocks.field_150349_c) {
                                 p_180704_5_.func_177855_a(i3, i2, j3, Blocks.field_150350_a.func_176223_P());
                              }
                           }
                        }
                     }
   ...
   protected void func_180701_a(World p_180701_1_, int p_180701_2_, int p_180701_3_, int p_180701_4_, int p_180701_5_, ChunkPrimer p_180701_6_) {
      ...
      for(int j = 0; j < i; ++j) {
         ...
         for(int l = 0; l < k; ++l) {
            float f = this.field_75038_b.nextFloat() * 3.1415927F * 2.0F;
