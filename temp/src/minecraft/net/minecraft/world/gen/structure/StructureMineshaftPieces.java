         ...
         if (this.func_74860_a(p_74875_1_, p_74875_3_)) {
            ...
            for(int j1 = 0; j1 < this.field_74955_d; ++j1) {
               ...
               if (p_74875_2_.nextInt(100) == 0) {
                  this.func_180778_a(p_74875_1_, p_74875_3_, p_74875_2_, 2, 0, k1 - 1, WeightedRandomChestContent.func_177629_a(StructureMineshaftPieces.field_175893_a, Items.field_151134_bR.func_92114_b(p_74875_2_)), 3 + p_74875_2_.nextInt(4));
               }

               if (p_74875_2_.nextInt(100) == 0) {
                  this.func_180778_a(p_74875_1_, p_74875_3_, p_74875_2_, 0, 0, k1 + 1, WeightedRandomChestContent.func_177629_a(StructureMineshaftPieces.field_175893_a, Items.field_151134_bR.func_92114_b(p_74875_2_)), 3 + p_74875_2_.nextInt(4));
               }
