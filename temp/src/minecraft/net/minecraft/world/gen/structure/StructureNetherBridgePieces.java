...
public class StructureNetherBridgePieces {
   ...
   public static class Corridor3 extends StructureNetherBridgePieces.Piece {
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         for(int j = 0; j <= 9; ++j) {
            ...
            int i1 = j;
            this.func_175804_a(p_74875_1_, p_74875_3_, 0, 0, j, 4, k, j, Blocks.field_150385_bj.func_176223_P(), Blocks.field_150385_bj.func_176223_P(), false);
            this.func_175804_a(p_74875_1_, p_74875_3_, 1, k + 1, j, 3, l - 1, j, Blocks.field_150350_a.func_176223_P(), Blocks.field_150350_a.func_176223_P(), false);
            if (j <= 6) {
               this.func_175811_a(p_74875_1_, Blocks.field_150387_bl.func_176203_a(i), 1, k + 1, j, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_150387_bl.func_176203_a(i), 2, k + 1, j, p_74875_3_);
               this.func_175811_a(p_74875_1_, Blocks.field_150387_bl.func_176203_a(i), 3, k + 1, j, p_74875_3_);
            }

            this.func_175804_a(p_74875_1_, p_74875_3_, 0, l, j, 4, l, j, Blocks.field_150385_bj.func_176223_P(), Blocks.field_150385_bj.func_176223_P(), false);
            this.func_175804_a(p_74875_1_, p_74875_3_, 0, k + 1, j, 0, l - 1, j, Blocks.field_150385_bj.func_176223_P(), Blocks.field_150385_bj.func_176223_P(), false);
            this.func_175804_a(p_74875_1_, p_74875_3_, 4, k + 1, j, 4, l - 1, j, Blocks.field_150385_bj.func_176223_P(), Blocks.field_150385_bj.func_176223_P(), false);
            if ((j & 1) == 0) {
               this.func_175804_a(p_74875_1_, p_74875_3_, 0, k + 2, j, 0, k + 3, j, Blocks.field_150386_bk.func_176223_P(), Blocks.field_150386_bk.func_176223_P(), false);
               this.func_175804_a(p_74875_1_, p_74875_3_, 4, k + 2, j, 4, k + 3, j, Blocks.field_150386_bk.func_176223_P(), Blocks.field_150386_bk.func_176223_P(), false);
            }

            for(int j1 = 0; j1 <= 4; ++j1) {
               this.func_175808_b(p_74875_1_, Blocks.field_150385_bj.func_176223_P(), j1, -1, i1, p_74875_3_);
            }
         }
   ...
   public static class Entrance extends StructureNetherBridgePieces.Piece {
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         if (p_74875_3_.func_175898_b(blockpos)) {
            p_74875_1_.func_175637_a(Blocks.field_150356_k, blockpos, p_74875_2_);
         }
   ...
   public static class NetherStalkRoom extends StructureNetherBridgePieces.Piece {
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         int k1 = this.func_151555_a(Blocks.field_150387_bl, 3);

         for(int j = 0; j <= 6; ++j) {
            int k = j + 4;

            for(int l = 5; l <= 7; ++l) {
               this.func_175811_a(p_74875_1_, Blocks.field_150387_bl.func_176203_a(k1), l, 5 + j, k, p_74875_3_);
            }
         ...
         for(int l1 = 5; l1 <= 7; ++l1) {
            this.func_175811_a(p_74875_1_, Blocks.field_150387_bl.func_176203_a(k1), l1, 12, 11, p_74875_3_);
         }
         ...
         int i2 = this.func_151555_a(Blocks.field_150387_bl, 0);
         int j2 = this.func_151555_a(Blocks.field_150387_bl, 1);
         this.func_175811_a(p_74875_1_, Blocks.field_150387_bl.func_176203_a(j2), 4, 5, 2, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150387_bl.func_176203_a(j2), 4, 5, 3, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150387_bl.func_176203_a(j2), 4, 5, 9, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150387_bl.func_176203_a(j2), 4, 5, 10, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150387_bl.func_176203_a(i2), 8, 5, 2, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150387_bl.func_176203_a(i2), 8, 5, 3, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150387_bl.func_176203_a(i2), 8, 5, 9, p_74875_3_);
         this.func_175811_a(p_74875_1_, Blocks.field_150387_bl.func_176203_a(i2), 8, 5, 10, p_74875_3_);
         ...
         for(int k2 = 4; k2 <= 8; ++k2) {
            for(int i1 = 0; i1 <= 2; ++i1) {
               this.func_175808_b(p_74875_1_, Blocks.field_150385_bj.func_176223_P(), k2, -1, i1, p_74875_3_);
               this.func_175808_b(p_74875_1_, Blocks.field_150385_bj.func_176223_P(), k2, -1, 12 - i1, p_74875_3_);
            }
         }

         for(int l2 = 0; l2 <= 2; ++l2) {
            for(int i3 = 4; i3 <= 8; ++i3) {
               this.func_175808_b(p_74875_1_, Blocks.field_150385_bj.func_176223_P(), l2, -1, i3, p_74875_3_);
               this.func_175808_b(p_74875_1_, Blocks.field_150385_bj.func_176223_P(), 12 - l2, -1, i3, p_74875_3_);
            }
         }
         ...
         if (!this.field_74976_a) {
            ...
            if (p_74875_3_.func_175898_b(blockpos)) {
               ...
               if (tileentity instanceof TileEntityMobSpawner) {
                  ((TileEntityMobSpawner)tileentity).func_145881_a().func_98272_a("Blaze");
               }
            }
         }
