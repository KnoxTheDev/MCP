...
public class MapGenStructureIO {
   ...
   private static Map<String, Class<? extends StructureStart>> field_143040_a = Maps.<String, Class<? extends StructureStart>>newHashMap();
   private static Map<Class<? extends StructureStart>, String> field_143038_b = Maps.<Class<? extends StructureStart>, String>newHashMap();
   private static Map<String, Class<? extends StructureComponent>> field_143039_c = Maps.<String, Class<? extends StructureComponent>>newHashMap();
   private static Map<Class<? extends StructureComponent>, String> field_143037_d = Maps.<Class<? extends StructureComponent>, String>newHashMap();
