...
public class StructureOceanMonumentPieces {
      ...
      public MonumentBuilding(Random p_i45599_1_, int p_i45599_2_, int p_i45599_3_, EnumFacing p_i45599_4_) {
         ...
         for(StructureOceanMonumentPieces.RoomDefinition structureoceanmonumentpieces$roomdefinition : list) {
            if (!structureoceanmonumentpieces$roomdefinition.field_175963_d && !structureoceanmonumentpieces$roomdefinition.func_175961_b()) {
               ...
               this.field_175843_q.add(structureoceanmonumentpieces$monumentroomfithelper.func_175968_a(this.field_74885_f, structureoceanmonumentpieces$roomdefinition, p_i45599_1_));
            }
         }
         ...
         this.field_175843_q.add(new StructureOceanMonumentPieces.WingRoom(this.field_74885_f, structureboundingbox1, i++));
         this.field_175843_q.add(new StructureOceanMonumentPieces.WingRoom(this.field_74885_f, structureboundingbox2, i++));
         this.field_175843_q.add(new StructureOceanMonumentPieces.Penthouse(this.field_74885_f, structureboundingbox));
      }
   ...
   public static class MonumentCoreRoom extends StructureOceanMonumentPieces.Piece {
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         IBlockState iblockstate = field_175826_b;
         this.func_175804_a(p_74875_1_, p_74875_3_, 0, i, 0, 0, i, 15, iblockstate, iblockstate, false);
         this.func_175804_a(p_74875_1_, p_74875_3_, 15, i, 0, 15, i, 15, iblockstate, iblockstate, false);
         this.func_175804_a(p_74875_1_, p_74875_3_, 1, i, 0, 15, i, 0, iblockstate, iblockstate, false);
         this.func_175804_a(p_74875_1_, p_74875_3_, 1, i, 15, 14, i, 15, iblockstate, iblockstate, false);
   ...
   public abstract static class Piece extends StructureComponent {
         ...
         for(int i = p_181655_4_; i <= p_181655_7_; ++i) {
            for(int j = p_181655_3_; j <= p_181655_6_; ++j) {
               for(int k = p_181655_5_; k <= p_181655_8_; ++k) {
                  if (!p_181655_9_ || this.func_175807_a(p_181655_1_, j, i, k, p_181655_2_).func_177230_c().func_149688_o() != Material.field_151579_a) {
      ...
      protected boolean func_175817_a(World p_175817_1_, StructureBoundingBox p_175817_2_, int p_175817_3_, int p_175817_4_, int p_175817_5_) {
         ...
         if (p_175817_2_.func_175898_b(new BlockPos(i, j, k))) {
            EntityGuardian entityguardian = new EntityGuardian(p_175817_1_);
            entityguardian.func_175467_a(true);
            entityguardian.func_70691_i(entityguardian.func_110138_aP());
            entityguardian.func_70012_b((double)i + 0.5D, (double)j, (double)k + 0.5D, 0.0F, 0.0F);
            entityguardian.func_180482_a(p_175817_1_.func_175649_E(new BlockPos(entityguardian)), (IEntityLivingData)null);
            p_175817_1_.func_72838_d(entityguardian);
            return true;
         } else {
            return false;
         }
   ...
   public static class WingRoom extends StructureOceanMonumentPieces.Piece {
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         if (this.field_175834_o == 0) {
            ...
            for(int l = 0; l < 2; ++l) {
               this.func_175811_a(p_74875_1_, field_175826_b, j1, k + 1, j, p_74875_3_);
               this.func_175811_a(p_74875_1_, field_175825_e, j1, k, j, p_74875_3_);
               this.func_175811_a(p_74875_1_, field_175826_b, j1, k - 1, j, p_74875_3_);
               j1 = 13;
            }
