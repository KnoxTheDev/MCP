...
public class ComponentScatteredFeaturePieces {
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         ...
         for(EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
            if (!this.field_74940_h[enumfacing.func_176736_b()]) {
               ...
               this.field_74940_h[enumfacing.func_176736_b()] = this.func_180778_a(p_74875_1_, p_74875_3_, p_74875_2_, 10 + l1, -11, 10 + i2, WeightedRandomChestContent.func_177629_a(field_74941_i, Items.field_151134_bR.func_92114_b(p_74875_2_)), 2 + p_74875_2_.nextInt(5));
            }
         }
   ...
   public static class JunglePyramid extends ComponentScatteredFeaturePieces.Feature {
      ...
      private static final List<WeightedRandomChestContent> field_175815_j = Lists.newArrayList(new WeightedRandomChestContent(Items.field_151032_g, 0, 2, 7, 30));
      ...
      public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
         if (!this.func_74935_a(p_74875_1_, p_74875_3_, 0)) {
            ...
            if (!this.field_74947_h) {
               this.field_74947_h = this.func_180778_a(p_74875_1_, p_74875_3_, p_74875_2_, 8, -3, 3, WeightedRandomChestContent.func_177629_a(field_175816_i, Items.field_151134_bR.func_92114_b(p_74875_2_)), 2 + p_74875_2_.nextInt(5));
            }
            ...
            if (!this.field_74948_i) {
               this.field_74948_i = this.func_180778_a(p_74875_1_, p_74875_3_, p_74875_2_, 9, -3, 10, WeightedRandomChestContent.func_177629_a(field_175816_i, Items.field_151134_bR.func_92114_b(p_74875_2_)), 2 + p_74875_2_.nextInt(5));
            }
