            ...
            for(int i1 = -l; i1 <= l; ++i1) {
               ...
               for(int j1 = -l; j1 <= l; ++j1) {
                  ...
                  if ((i1 == 0 && j1 == 0 || f1 * f1 + f2 * f2 <= f * f) && (i1 != -l && i1 != l && j1 != -l && j1 != l || p_180709_2_.nextFloat() <= 0.75F)) {
                     Block block = p_180709_1_.func_180495_p(p_180709_3_.func_177982_a(i1, k, j1)).func_177230_c();
                     ...
                     if (k != 0 && l > 1) {
                        block = p_180709_1_.func_180495_p(p_180709_3_.func_177982_a(i1, -k, j1)).func_177230_c();
                        if (block.func_149688_o() == Material.field_151579_a || block == Blocks.field_150346_d || block == Blocks.field_150433_aE || block == Blocks.field_150432_aD) {
                           this.func_175903_a(p_180709_1_, p_180709_3_.func_177982_a(i1, -k, j1), Blocks.field_150403_cj.func_176223_P());
                        }
                     }
         ...
         for(int l1 = -k1; l1 <= k1; ++l1) {
            for(int i2 = -k1; i2 <= k1; ++i2) {
               ...
               while(blockpos.func_177956_o() > 50) {
                  Block block1 = p_180709_1_.func_180495_p(blockpos).func_177230_c();
