   ...
   public ChunkProviderFlat(World p_i2004_1_, long p_i2004_2_, boolean p_i2004_4_, String p_i2004_5_) {
      ...
      if (p_i2004_4_) {
         ...
         if (map.containsKey("biome_1")) {
            this.field_82696_f.add(new MapGenScatteredFeature(map.get("biome_1")));
         }

         if (map.containsKey("mineshaft")) {
            this.field_82696_f.add(new MapGenMineshaft(map.get("mineshaft")));
         }

         if (map.containsKey("stronghold")) {
            this.field_82696_f.add(new MapGenStronghold(map.get("stronghold")));
         }

         if (map.containsKey("oceanmonument")) {
            this.field_82696_f.add(new StructureOceanMonument(map.get("oceanmonument")));
         }
      }
