...
public class WorldInfo {
   ...
   private double field_176151_B = 0.0D;
   private double field_176152_C = 0.0D;
   private double field_176146_D = 6.0E7D;
   private long field_176147_E = 0L;
   private double field_176148_F = 0.0D;
   ...
   public WorldInfo(NBTTagCompound p_i2157_1_) {
      ...
      if (p_i2157_1_.func_150297_b("generatorName", 8)) {
         String s = p_i2157_1_.func_74779_i("generatorName");
   ...
   public NBTTagCompound func_76066_a() {
      ...
      this.func_76064_a(nbttagcompound, this.field_76108_i);
   ...
   public void func_85118_a(CrashReportCategory p_85118_1_) {
      p_85118_1_.func_71500_a("Level seed", new Callable<String>() {
         public String call() throws Exception {
            return String.valueOf(WorldInfo.this.func_76063_b());
         }
      });
      p_85118_1_.func_71500_a("Level generator", new Callable<String>() {
         public String call() throws Exception {
      ...
      p_85118_1_.func_71500_a("Level generator options", new Callable<String>() {
         public String call() throws Exception {
            return WorldInfo.this.field_82576_c;
         }
      });
      p_85118_1_.func_71500_a("Level spawn location", new Callable<String>() {
         public String call() throws Exception {
      ...
      p_85118_1_.func_71500_a("Level time", new Callable<String>() {
         public String call() throws Exception {
            return String.format("%d game time, %d day time", WorldInfo.this.field_82575_g, WorldInfo.this.field_76094_f);
         }
      });
      p_85118_1_.func_71500_a("Level dimension", new Callable<String>() {
         public String call() throws Exception {
            return String.valueOf(WorldInfo.this.field_76105_j);
         }
      });
      p_85118_1_.func_71500_a("Level storage version", new Callable<String>() {
         public String call() throws Exception {
            String s = "Unknown?";
      ...
      p_85118_1_.func_71500_a("Level weather", new Callable<String>() {
         public String call() throws Exception {
      ...
      p_85118_1_.func_71500_a("Level game mode", new Callable<String>() {
         public String call() throws Exception {
