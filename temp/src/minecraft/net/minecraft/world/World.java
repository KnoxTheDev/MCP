...
public abstract class World implements IBlockAccess {
      ...
      if (!this.field_72995_K) {
         ...
         try {
            ...
            crashreportcategory.func_71500_a("Source block type", new Callable<String>() {
               public String call() throws Exception {
                  try {
                     return String.format("ID #%d (%s // %s)", Block.func_149682_b(p_180496_2_), p_180496_2_.func_149739_a(), p_180496_2_.getClass().getCanonicalName());
   ...
   public List<AxisAlignedBB> func_72945_a(Entity p_72945_1_, AxisAlignedBB p_72945_2_) {
      ...
      for(int j2 = 0; j2 < list1.size(); ++j2) {
         if (p_72945_1_.field_70153_n != list1 && p_72945_1_.field_70154_o != list1) {
            ...
            axisalignedbb = p_72945_1_.func_70114_g(list1.get(j2));
            if (axisalignedbb != null && axisalignedbb.func_72326_a(p_72945_2_)) {
               list.add(axisalignedbb);
            }
         }
      ...
      if (!this.func_175701_a(p_175625_1_)) {
         ...
         if (tileentity == null) {
            for(int j = 0; j < this.field_147484_a.size(); ++j) {
               TileEntity tileentity2 = this.field_147484_a.get(j);
   ...
   public static boolean func_175683_a(IBlockAccess p_175683_0_, BlockPos p_175683_1_) {
      ...
      if (block.func_149688_o().func_76218_k() && block.func_149686_d()) {
         ...
         return iblockstate.func_177229_b(BlockStairs.field_176308_b) == BlockStairs.EnumHalf.TOP;
      } else if (block instanceof BlockSlab) {
         return iblockstate.func_177229_b(BlockSlab.field_176554_a) == BlockSlab.EnumBlockHalf.TOP;
      } else if (block instanceof BlockHopper) {
         return true;
      } else if (block instanceof BlockSnow) {
         return ((Integer)iblockstate.func_177229_b(BlockSnow.field_176315_a)).intValue() == 7;
      } else {
         return false;
      }
   }
   ...
   protected void func_72903_x() {
      ...
      if (!this.field_73010_i.isEmpty()) {
         ...
         EntityPlayer entityplayer1 = this.field_73010_i.get(k1);
   ...
   public boolean func_175716_a(Block p_175716_1_, BlockPos p_175716_2_, boolean p_175716_3_, EnumFacing p_175716_4_, Entity p_175716_5_, ItemStack p_175716_6_) {
      ...
      if (axisalignedbb != null && !this.func_72917_a(axisalignedbb, p_175716_5_)) {
         return false;
      } else if (block.func_149688_o() == Material.field_151594_q && p_175716_1_ == Blocks.field_150467_bQ) {
         return true;
      } else {
         return block.func_149688_o().func_76222_j() && p_175716_1_.func_176193_a(this, p_175716_2_, p_175716_4_, p_175716_6_);
      }
   }
   ...
   public boolean func_175727_C(BlockPos p_175727_1_) {
      if (!this.func_72896_J()) {
         ...
         if (biomegenbase.func_76746_c()) {
            ...
            return this.func_175708_f(p_175727_1_, false) ? false : biomegenbase.func_76738_d();
         }
      }
   }
   ...
   public void func_175715_c(int p_175715_1_, BlockPos p_175715_2_, int p_175715_3_) {
      for(int i = 0; i < this.field_73021_x.size(); ++i) {
         IWorldAccess iworldaccess = this.field_73021_x.get(i);
