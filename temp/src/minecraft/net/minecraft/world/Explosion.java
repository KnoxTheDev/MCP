...
public class Explosion {
   ...
   public Explosion(World p_i45754_1_, Entity p_i45754_2_, double p_i45754_3_, double p_i45754_5_, double p_i45754_7_, float p_i45754_9_, boolean p_i45754_10_, boolean p_i45754_11_) {
      ...
      this.field_77288_k = Maps.<EntityPlayer, Vec3>newHashMap();
         ...
         if (!entity.func_180427_aV()) {
            ...
            if (d12 <= 1.0D) {
               ...
               if (d13 != 0.0D) {
                  ...
                  d7 = d7 / d13;
                  d9 = d9 / d13;
                  double d14 = (double)this.field_77287_j.func_72842_a(vec3, entity.func_174813_aQ());
                  double d10 = (1.0D - d12) * d14;
                  entity.func_70097_a(DamageSource.func_94539_a(this), (float)((int)((d10 * d10 + d10) / 2.0D * 8.0D * (double)f3 + 1.0D)));
   ...
   public void func_77279_a(boolean p_77279_1_) {
      ...
      if (this.field_82755_b) {
         for(BlockPos blockpos : this.field_77281_g) {
            Block block = this.field_77287_j.func_180495_p(blockpos).func_177230_c();
            if (p_77279_1_) {
               ...
               d4 = d4 * d7;
               d5 = d5 * d7;
               this.field_77287_j.func_175688_a(EnumParticleTypes.EXPLOSION_NORMAL, (d0 + this.field_77284_b * 1.0D) / 2.0D, (d1 + this.field_77285_c * 1.0D) / 2.0D, (d2 + this.field_77282_d * 1.0D) / 2.0D, d3, d4, d5);
      ...
      if (this.field_77286_a) {
         for(BlockPos blockpos1 : this.field_77281_g) {
            if (this.field_77287_j.func_180495_p(blockpos1).func_177230_c().func_149688_o() == Material.field_151579_a && this.field_77287_j.func_180495_p(blockpos1.func_177977_b()).func_177230_c().func_149730_j() && this.field_77290_i.nextInt(3) == 0) {
