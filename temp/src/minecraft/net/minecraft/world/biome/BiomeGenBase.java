...
public abstract class BiomeGenBase {
   ...
   public boolean func_150569_a(BiomeGenBase p_150569_1_) {
      if (p_150569_1_ == this) {
         return true;
      } else if (p_150569_1_ == null) {
         return false;
      } else {
         return this.func_150562_l() == p_150569_1_.func_150562_l();
      }
   }
      ...
      for(BiomeGenBase biomegenbase : field_76773_a) {
         if (biomegenbase != null) {
            if (field_180278_o.containsKey(biomegenbase.field_76791_y)) {
               throw new Error("Biome \"" + biomegenbase.field_76791_y + "\" is defined as both ID " + (field_180278_o.get(biomegenbase.field_76791_y)).field_76756_M + " and " + biomegenbase.field_76756_M);
            }
