...
public class NBTTagCompound extends NBTBase {
   private Map<String, NBTBase> field_74784_a = Maps.<String, NBTBase>newHashMap();
   ...
   public String toString() {
      ...
      for(Entry<String, NBTBase> entry : this.field_74784_a.entrySet()) {
   ...
   private CrashReport func_82581_a(final String p_82581_1_, final int p_82581_2_, ClassCastException p_82581_3_) {
      ...
      crashreportcategory.func_71500_a("Tag type found", new Callable<String>() {
         public String call() throws Exception {
            return NBTBase.field_82578_b[((NBTBase)NBTTagCompound.this.field_74784_a.get(p_82581_1_)).func_74732_a()];
         }
      });
      crashreportcategory.func_71500_a("Tag type expected", new Callable<String>() {
         public String call() throws Exception {
