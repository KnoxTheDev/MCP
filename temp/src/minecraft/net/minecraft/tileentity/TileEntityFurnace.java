...
public class TileEntityFurnace extends TileEntityLockable implements ITickable, ISidedInventory {
   ...
   private boolean func_145948_k() {
      if (this.field_145957_n[0] == null) {
         ...
         if (itemstack == null) {
            ...
            return true;
         } else if (!this.field_145957_n[2].func_77969_a(itemstack)) {
            return false;
            ...
            return this.field_145957_n[2].field_77994_a < itemstack.func_77976_d();
         }
      }
   }
   ...
   public static int func_145952_a(ItemStack p_145952_0_) {
      if (p_145952_0_ == null) {
         ...
         if (item instanceof ItemTool && ((ItemTool)item).func_77861_e().equals("WOOD")) {
            ...
            return item == Items.field_151072_bj ? 2400 : 0;
         }
      }
   }
   ...
   public boolean func_94041_b(int p_94041_1_, ItemStack p_94041_2_) {
      if (p_94041_1_ == 2) {
         ...
         return func_145954_b(p_94041_2_) || SlotFurnaceFuel.func_178173_c_(p_94041_2_);
      }
   }
