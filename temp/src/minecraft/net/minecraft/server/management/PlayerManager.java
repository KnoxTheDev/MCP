...
public class PlayerManager {
   ...
   private final LongHashMap<PlayerManager.PlayerInstance> field_72700_c = new LongHashMap<PlayerManager.PlayerInstance>();
   ...
   public void func_72693_b() {
      ...
      if (i - this.field_111192_g > 8000L) {
         ...
         for(int k = 0; k < this.field_72697_d.size(); ++k) {
            PlayerManager.PlayerInstance playermanager$playerinstance1 = this.field_72697_d.get(k);
   ...
   private PlayerManager.PlayerInstance func_72690_a(int p_72690_1_, int p_72690_2_, boolean p_72690_3_) {
      ...
      PlayerManager.PlayerInstance playermanager$playerinstance = this.field_72700_c.func_76164_a(i);
   ...
   class PlayerInstance {
      ...
      public void func_151251_a(Packet p_151251_1_) {
         for(int i = 0; i < this.field_73263_b.size(); ++i) {
            EntityPlayerMP entityplayermp = this.field_73263_b.get(i);
