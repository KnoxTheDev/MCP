...
public class DataWatcher {
   ...
   public <T> void func_75682_a(int p_75682_1_, T p_75682_2_) {
      Integer integer = field_75697_a.get(p_75682_2_.getClass());
      if (integer == null) {
   ...
   private DataWatcher.WatchableObject func_75691_i(int p_75691_1_) {
      ...
      try {
         datawatcher$watchableobject = this.field_75695_b.get(Integer.valueOf(p_75691_1_));
   ...
   public void func_75687_a(List<DataWatcher.WatchableObject> p_75687_1_) {
      ...
      for(DataWatcher.WatchableObject datawatcher$watchableobject : p_75687_1_) {
         DataWatcher.WatchableObject datawatcher$watchableobject1 = this.field_75695_b.get(Integer.valueOf(datawatcher$watchableobject.func_75672_a()));
