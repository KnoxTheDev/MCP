...
public class EntityDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob {
   ...
   public void func_70636_d() {
      ...
      if (this.func_110143_aJ() <= 0.0F) {
         ...
         this.field_70170_p.func_175688_a(EnumParticleTypes.EXPLOSION_LARGE, this.field_70165_t + (double)f11, this.field_70163_u + 2.0D + (double)f13, this.field_70161_v + (double)f14, 0.0D, 0.0D, 0.0D);
      } else {
         this.func_70969_j();
   ...
   private void func_70967_k() {
      ...
      if (this.field_70146_Z.nextInt(2) == 0 && !list.isEmpty()) {
         this.field_70993_bI = list.get(this.field_70146_Z.nextInt(list.size()));
      } else {
         while(true) {
