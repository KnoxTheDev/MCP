...
public class EntityGuardian extends EntityMob {
   ...
   public EntityGuardian(World p_i45835_1_) {
      ...
      this.field_70714_bg.func_75776_a(5, entityaimovetowardsrestriction = new EntityAIMoveTowardsRestriction(this, 1.0D));
   ...
   private void func_175473_a(int p_175473_1_, boolean p_175473_2_) {
      ...
      if (p_175473_2_) {
         this.field_70180_af.func_75692_b(16, Integer.valueOf(i | p_175473_1_));
      } else {
         this.field_70180_af.func_75692_b(16, Integer.valueOf(i & ~p_175473_1_));
      }
   ...
   public void func_70636_d() {
      if (this.field_70170_p.field_72995_K) {
         ...
         if (this.func_175472_n() && this.func_70090_H()) {
            ...
            for(int i = 0; i < 2; ++i) {
               this.field_70170_p.func_175688_a(EnumParticleTypes.WATER_BUBBLE, this.field_70165_t + (this.field_70146_Z.nextDouble() - 0.5D) * (double)this.field_70130_N - vec3.field_72450_a * 1.5D, this.field_70163_u + this.field_70146_Z.nextDouble() * (double)this.field_70131_O - vec3.field_72448_b * 1.5D, this.field_70161_v + (this.field_70146_Z.nextDouble() - 0.5D) * (double)this.field_70130_N - vec3.field_72449_c * 1.5D, 0.0D, 0.0D, 0.0D);
            }
         }
   ...
   protected void func_70619_bc() {
      ...
      if (this.func_175461_cl()) {
         ...
         if ((this.field_70173_aa + this.func_145782_y()) % 1200 == 0) {
            ...
            for(EntityPlayerMP entityplayermp : this.field_70170_p.func_175661_b(EntityPlayerMP.class, new Predicate<EntityPlayerMP>() {
   ...
   protected void func_70628_a(boolean p_70628_1_, int p_70628_2_) {
      int i = this.field_70146_Z.nextInt(3) + this.field_70146_Z.nextInt(p_70628_2_ + 1);
      if (i > 0) {
         this.func_70099_a(new ItemStack(Items.field_179562_cC, i, 0), 1.0F);
      }
   ...
   protected void func_82164_bB() {
      ItemStack itemstack = ((WeightedRandomFishable)WeightedRandom.func_76271_a(this.field_70146_Z, EntityFishHook.func_174855_j())).func_150708_a(this.field_70146_Z);
   ...
   static class GuardianMoveHelper extends EntityMoveHelper {
      ...
      public void func_75641_c() {
         if (this.field_75643_f && !this.field_179930_g.func_70661_as().func_75500_f()) {
            ...
            this.field_179930_g.field_70177_z = this.func_75639_a(this.field_179930_g.field_70177_z, f, 30.0F);
            ...
            double d5 = Math.cos((double)(this.field_179930_g.field_70177_z * 3.1415927F / 180.0F));
            double d6 = Math.sin((double)(this.field_179930_g.field_70177_z * 3.1415927F / 180.0F));
            ...
            double d8 = (double)this.field_179930_g.func_70047_e() + this.field_179930_g.field_70163_u + d1 / d3 * 1.0D;
