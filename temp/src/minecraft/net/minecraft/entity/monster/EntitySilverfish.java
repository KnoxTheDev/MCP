   ...
   static class AIHideInStone extends EntityAIWander {
      ...
      public boolean func_75250_a() {
         if (this.field_179485_a.func_70638_az() != null) {
            ...
            Random random = this.field_179485_a.func_70681_au();
            if (random.nextInt(10) == 0) {
               ...
               IBlockState iblockstate = this.field_179485_a.field_70170_p.func_180495_p(blockpos);
      ...
      public void func_75249_e() {
         if (!this.field_179484_c) {
            ...
            World world = this.field_179485_a.field_70170_p;
            BlockPos blockpos = (new BlockPos(this.field_179485_a.field_70165_t, this.field_179485_a.field_70163_u + 0.5D, this.field_179485_a.field_70161_v)).func_177972_a(this.field_179483_b);
