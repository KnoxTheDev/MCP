...
public class EntitySlime extends EntityLiving implements IMob {
   ...
   public void func_70071_h_() {
      ...
      if (this.field_70122_E && !this.field_175452_bi) {
         ...
         for(int j = 0; j < i * 8; ++j) {
            float f = this.field_70146_Z.nextFloat() * 3.1415927F * 2.0F;
   ...
   public boolean func_70601_bi() {
      ...
      if (this.field_70170_p.func_72912_H().func_76067_t() == WorldType.field_77138_c && this.field_70146_Z.nextInt(4) != 1) {
         ...
         if (this.field_70170_p.func_175659_aa() != EnumDifficulty.PEACEFUL) {
            BiomeGenBase biomegenbase = this.field_70170_p.func_180494_b(blockpos);
            if (biomegenbase == BiomeGenBase.field_76780_h && this.field_70163_u > 50.0D && this.field_70163_u < 70.0D && this.field_70146_Z.nextFloat() < 0.5F && this.field_70146_Z.nextFloat() < this.field_70170_p.func_130001_d() && this.field_70170_p.func_175671_l(new BlockPos(this)) <= this.field_70146_Z.nextInt(8)) {
