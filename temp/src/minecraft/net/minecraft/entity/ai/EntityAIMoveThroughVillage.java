...
public class EntityAIMoveThroughVillage extends EntityAIBase {
   ...
   private List<VillageDoorInfo> field_75415_f = Lists.<VillageDoorInfo>newArrayList();
         ...
         if (village == null) {
            ...
            if (this.field_75416_d == null) {
               ...
               if (this.field_75419_c != null) {
                  ...
                  Vec3 vec3 = RandomPositionGenerator.func_75464_a(this.field_75420_a, 10, 7, new Vec3((double)this.field_75416_d.func_179852_d().func_177958_n(), (double)this.field_75416_d.func_179852_d().func_177956_o(), (double)this.field_75416_d.func_179852_d().func_177952_p()));
                  if (vec3 == null) {
                     return false;
                  } else {
                     pathnavigateground.func_179688_b(false);
