...
public class EntityAIPlay extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      if (this.field_75262_a.func_70874_b() >= 0) {
         ...
         if (this.field_75260_b == null) {
            Vec3 vec3 = RandomPositionGenerator.func_75463_a(this.field_75262_a, 16, 3);
            if (vec3 == null) {
               return false;
            }
         }
   ...
   public void func_75246_d() {
      ...
      if (this.field_75260_b != null) {
         ...
         this.field_75262_a.func_70661_as().func_75492_a(vec3.field_72450_a, vec3.field_72448_b, vec3.field_72449_c, this.field_75261_c);
      }
