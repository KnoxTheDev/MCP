...
public abstract class EntityAIDoorInteract extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      if (!this.field_75356_a.field_70123_F) {
         ...
         PathEntity pathentity = pathnavigateground.func_75505_d();
         if (pathentity != null && !pathentity.func_75879_b() && pathnavigateground.func_179686_g()) {
   ...
   private BlockDoor func_179506_a(BlockPos p_179506_1_) {
      Block block = this.field_75356_a.field_70170_p.func_180495_p(p_179506_1_).func_177230_c();
      return block instanceof BlockDoor && block.func_149688_o() == Material.field_151575_d ? (BlockDoor)block : null;
   }
}
