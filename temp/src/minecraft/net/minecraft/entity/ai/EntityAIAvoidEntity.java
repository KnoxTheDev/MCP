...
public class EntityAIAvoidEntity<T extends Entity> extends EntityAIBase {
   ...
   public EntityAIAvoidEntity(EntityCreature p_i46405_1_, Class<T> p_i46405_2_, Predicate<? super T> p_i46405_3_, float p_i46405_4_, double p_i46405_5_, double p_i46405_7_) {
      this.field_179509_a = new Predicate<Entity>() {
         public boolean apply(Entity p_apply_1_) {
            return p_apply_1_.func_70089_S() && EntityAIAvoidEntity.this.field_75380_a.func_70635_at().func_75522_a(p_apply_1_);
         }
      };
   ...
   public boolean func_75250_a() {
      List<T> list = this.field_75380_a.field_70170_p.<T>func_175647_a(this.field_181064_i, this.field_75380_a.func_174813_aQ().func_72314_b((double)this.field_179508_f, 3.0D, (double)this.field_179508_f), Predicates.and(EntitySelectors.field_180132_d, this.field_179509_a, this.field_179510_i));
      if (list.isEmpty()) {
         return false;
      } else {
         ...
         if (vec3 == null) {
            ...
            if (this.field_75374_f == null) {
               ...
               return this.field_75374_f.func_75880_b(vec3);
            }
         }
      }
   }
