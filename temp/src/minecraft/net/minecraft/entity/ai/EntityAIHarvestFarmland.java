...
public class EntityAIHarvestFarmland extends EntityAIMoveToBlock {
   ...
   public void func_75246_d() {
      ...
      if (this.func_179487_f()) {
         ...
         if (this.field_179501_f == 0 && block instanceof BlockCrops && ((Integer)iblockstate.func_177229_b(BlockCrops.field_176488_a)).intValue() == 7) {
            world.func_175655_b(blockpos, true);
         } else if (this.field_179501_f == 1 && block == Blocks.field_150350_a) {
   ...
   protected boolean func_179488_a(World p_179488_1_, BlockPos p_179488_2_) {
      ...
      if (block == Blocks.field_150458_ak) {
         ...
         if (block instanceof BlockCrops && ((Integer)iblockstate.func_177229_b(BlockCrops.field_176488_a)).intValue() == 7 && this.field_179503_e && (this.field_179501_f == 0 || this.field_179501_f < 0)) {
            this.field_179501_f = 0;
            return true;
         }

         if (block == Blocks.field_150350_a && this.field_179502_d && (this.field_179501_f == 1 || this.field_179501_f < 0)) {
            this.field_179501_f = 1;
            return true;
         }
      }
