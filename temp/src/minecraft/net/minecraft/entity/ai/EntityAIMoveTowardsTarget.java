...
public class EntityAIMoveTowardsTarget extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      ...
      if (this.field_75429_b == null) {
         ...
         Vec3 vec3 = RandomPositionGenerator.func_75464_a(this.field_75431_a, 16, 7, new Vec3(this.field_75429_b.field_70165_t, this.field_75429_b.field_70163_u, this.field_75429_b.field_70161_v));
         if (vec3 == null) {
            return false;
         } else {
            this.field_75430_c = vec3.field_72450_a;
            this.field_75427_d = vec3.field_72448_b;
            this.field_75428_e = vec3.field_72449_c;
            return true;
         }
      }
   }
