...
public class EntityAIMoveIndoors extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      ...
      if ((!this.field_75424_a.field_70170_p.func_72935_r() || this.field_75424_a.field_70170_p.func_72896_J() && !this.field_75424_a.field_70170_p.func_180494_b(blockpos).func_76738_d()) && !this.field_75424_a.field_70170_p.field_73011_w.func_177495_o()) {
   ...
   public void func_75249_e() {
      ...
      if (this.field_75424_a.func_174818_b(blockpos) > 256.0D) {
         Vec3 vec3 = RandomPositionGenerator.func_75464_a(this.field_75424_a, 14, 3, new Vec3((double)i + 0.5D, (double)j, (double)k + 0.5D));
         if (vec3 != null) {
