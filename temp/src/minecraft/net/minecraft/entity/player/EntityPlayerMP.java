...
public class EntityPlayerMP extends EntityPlayer implements ICrafting {
   ...
   public void func_70071_h_() {
      ...
      if (!this.field_71129_f.isEmpty()) {
         ...
         if (!list.isEmpty()) {
            if (list.size() == 1) {
               this.field_71135_a.func_147359_a(new S21PacketChunkData(list.get(0), true, 65535));
            } else {
      ...
      try {
         ...
         if (this.func_110143_aJ() + this.func_110139_bj() != this.field_130068_bO) {
            ...
            for(ScoreObjective scoreobjective : this.func_96123_co().func_96520_a(IScoreObjectiveCriteria.field_96638_f)) {
               this.func_96123_co().func_96529_a(this.func_70005_c_(), scoreobjective).func_96651_a(Arrays.asList(this));
            }
         }
   ...
   public void func_70645_a(DamageSource p_70645_1_) {
      ...
      if (entitylivingbase != null) {
         EntityList.EntityEggInfo entitylist$entityegginfo = EntityList.field_75627_a.get(Integer.valueOf(EntityList.func_75619_a(entitylivingbase)));
