...
public abstract class EntityPlayer extends EntityLivingBase {
      ...
      if (p_71010_1_.func_77975_n() == EnumAction.EAT) {
         for(int i = 0; i < p_71010_2_; ++i) {
            ...
            if (p_71010_1_.func_77981_g()) {
               this.field_70170_p.func_175688_a(EnumParticleTypes.ITEM_CRACK, vec31.field_72450_a, vec31.field_72448_b, vec31.field_72449_c, vec3.field_72450_a, vec3.field_72448_b + 0.05D, vec3.field_72449_c, Item.func_150891_b(p_71010_1_.func_77973_b()), p_71010_1_.func_77960_j());
            } else {
               this.field_70170_p.func_175688_a(EnumParticleTypes.ITEM_CRACK, vec31.field_72450_a, vec31.field_72448_b, vec31.field_72449_c, vec3.field_72450_a, vec3.field_72448_b + 0.05D, vec3.field_72449_c, Item.func_150891_b(p_71010_1_.func_77973_b()));
            }
         }
   ...
   public void func_70074_a(EntityLivingBase p_70074_1_) {
      ...
      EntityList.EntityEggInfo entitylist$entityegginfo = EntityList.field_75627_a.get(Integer.valueOf(EntityList.func_75619_a(p_70074_1_)));
