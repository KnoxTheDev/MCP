            ...
            if (!this.field_70170_p.field_72995_K && d10 > 0.0D) {
               ...
               if (this.field_146045_ax > 0) {
                  ...
                  if (this.field_146038_az <= 0) {
                     ...
                     worldserver.func_175739_a(EnumParticleTypes.WATER_BUBBLE, this.field_70165_t, (double)(f8 + 1.0F), this.field_70161_v, (int)(1.0F + this.field_70130_N * 20.0F), (double)this.field_70130_N, 0.0D, (double)this.field_70130_N, 0.20000000298023224D);
                     worldserver.func_175739_a(EnumParticleTypes.WATER_WAKE, this.field_70165_t, (double)(f8 + 1.0F), this.field_70161_v, (int)(1.0F + this.field_70130_N * 20.0F), (double)this.field_70130_N, 0.0D, (double)this.field_70130_N, 0.20000000298023224D);
                     ...
                     if (block1 == Blocks.field_150355_j || block1 == Blocks.field_150358_i) {
                        if (this.field_70146_Z.nextFloat() < 0.15F) {
                           worldserver.func_175739_a(EnumParticleTypes.WATER_BUBBLE, d13, d15 - 0.10000000149011612D, d16, 1, (double)f10, 0.1D, (double)f11, 0.0D);
                        }

                        float f3 = f10 * 0.04F;
                        float f4 = f11 * 0.04F;
                        worldserver.func_175739_a(EnumParticleTypes.WATER_WAKE, d13, d15, d16, 0, (double)f4, 0.01D, (double)(-f3), 1.0D);
                        worldserver.func_175739_a(EnumParticleTypes.WATER_WAKE, d13, d15, d16, 0, (double)(-f4), 0.01D, (double)f3, 1.0D);
                     }
                  }
                  ...
                  if (this.field_70146_Z.nextFloat() < f1) {
                     ...
                     if (block == Blocks.field_150355_j || block == Blocks.field_150358_i) {
                        worldserver.func_175739_a(EnumParticleTypes.WATER_SPLASH, d12, d14, d6, 2 + this.field_70146_Z.nextInt(2), 0.10000000149011612D, 0.0D, 0.10000000149011612D, 0.0D);
                     }
                  }
