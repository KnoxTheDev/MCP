      ...
      if (this.field_70254_i) {
         ...
         if (this.func_70090_H()) {
            for(int i1 = 0; i1 < 4; ++i1) {
               float f8 = 0.25F;
               this.field_70170_p.func_175688_a(EnumParticleTypes.WATER_BUBBLE, this.field_70165_t - this.field_70159_w * (double)f8, this.field_70163_u - this.field_70181_x * (double)f8, this.field_70161_v - this.field_70179_y * (double)f8, this.field_70159_w, this.field_70181_x, this.field_70179_y);
            }
