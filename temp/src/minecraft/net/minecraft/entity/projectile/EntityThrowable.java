...
public abstract class EntityThrowable extends Entity implements IProjectile {
   ...
   public void func_70071_h_() {
      ...
      if (this.func_70090_H()) {
         for(int i = 0; i < 4; ++i) {
            float f4 = 0.25F;
            this.field_70170_p.func_175688_a(EnumParticleTypes.WATER_BUBBLE, this.field_70165_t - this.field_70159_w * (double)f4, this.field_70163_u - this.field_70181_x * (double)f4, this.field_70161_v - this.field_70179_y * (double)f4, this.field_70159_w, this.field_70181_x, this.field_70179_y);
         }
