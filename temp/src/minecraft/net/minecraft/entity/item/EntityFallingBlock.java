      ...
      if (block.func_149688_o() == Material.field_151579_a) {
         ...
         if (!this.field_70170_p.field_72995_K) {
            ...
            if (this.field_70122_E) {
               ...
               if (this.field_70170_p.func_180495_p(blockpos1).func_177230_c() != Blocks.field_180384_M) {
                  this.func_70106_y();
                  if (!this.field_145808_f) {
                     if (this.field_70170_p.func_175716_a(block, blockpos1, true, EnumFacing.UP, (Entity)null, (ItemStack)null) && !BlockFalling.func_180685_d(this.field_70170_p, blockpos1.func_177977_b()) && this.field_70170_p.func_180501_a(blockpos1, this.field_175132_d, 3)) {
