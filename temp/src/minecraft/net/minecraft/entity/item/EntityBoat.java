      ...
      if (d9 > 0.2975D) {
         ...
         for(int k = 0; (double)k < 1.0D + d9 * 60.0D; ++k) {
            ...
            if (this.field_70146_Z.nextBoolean()) {
               ...
               this.field_70170_p.func_175688_a(EnumParticleTypes.WATER_SPLASH, d7, this.field_70163_u - 0.125D, d8, this.field_70159_w, this.field_70181_x, this.field_70179_y);
            } else {
               double d24 = this.field_70165_t + d2 + d4 * d5 * 0.7D;
               double d25 = this.field_70161_v + d4 - d2 * d5 * 0.7D;
               this.field_70170_p.func_175688_a(EnumParticleTypes.WATER_SPLASH, d24, this.field_70163_u - 0.125D, d25, this.field_70159_w, this.field_70181_x, this.field_70179_y);
            }
         }
      }
