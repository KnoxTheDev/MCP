...
public class EntitySquid extends EntityWaterMob {
   ...
   public void func_70636_d() {
      ...
      if (this.field_70171_ac) {
         ...
         this.field_70861_d += (-((float)MathHelper.func_181159_b((double)f1, this.field_70181_x)) * 180.0F / 3.1415927F - this.field_70861_d) * 0.1F;
      } else {
   ...
   static class AIMoveRandom extends EntityAIBase {
      ...
      public void func_75246_d() {
         ...
         if (i > 100) {
            ...
            float f = this.field_179476_a.func_70681_au().nextFloat() * 3.1415927F * 2.0F;
