...
public abstract class EntityLivingBase extends Entity {
   ...
   protected void func_180433_a(double p_180433_1_, boolean p_180433_3_, Block p_180433_4_, BlockPos p_180433_5_) {
      ...
      if (!this.field_70170_p.field_72995_K && this.field_70143_R > 3.0F && p_180433_3_) {
         ...
         if (block.func_149688_o() != Material.field_151579_a) {
            ...
            int i = (int)(150.0D * d0);
            ((WorldServer)this.field_70170_p).func_175739_a(EnumParticleTypes.BLOCK_DUST, this.field_70165_t, this.field_70163_u, this.field_70161_v, i, 0.0D, 0.0D, 0.0D, 0.15000000596046448D, Block.func_176210_f(iblockstate));
         }
      }
            ...
            if (!this.func_70648_aU() && !this.func_82165_m(Potion.field_76427_o.field_76415_H) && !flag1) {
               ...
               if (this.func_70086_ai() == -20) {
                  ...
                  for(int i = 0; i < 8; ++i) {
                     ...
                     this.field_70170_p.func_175688_a(EnumParticleTypes.WATER_BUBBLE, this.field_70165_t + (double)f, this.field_70163_u + (double)f1, this.field_70161_v + (double)f2, this.field_70159_w, this.field_70181_x, this.field_70179_y);
                  }
   ...
   protected void func_70679_bo() {
      ...
      while(iterator.hasNext()) {
         ...
         PotionEffect potioneffect = this.field_70713_bf.get(integer);
   ...
   public PotionEffect func_70660_b(Potion p_70660_1_) {
      return this.field_70713_bf.get(Integer.valueOf(p_70660_1_.field_76415_H));
   }
   ...
   public void func_70690_d(PotionEffect p_70690_1_) {
      if (this.func_70687_e(p_70690_1_)) {
         if (this.field_70713_bf.containsKey(Integer.valueOf(p_70690_1_.func_76456_a()))) {
            ...
            this.func_70695_b(this.field_70713_bf.get(Integer.valueOf(p_70690_1_.func_76456_a())), true);
         } else {
   ...
   public void func_82170_o(int p_82170_1_) {
      PotionEffect potioneffect = this.field_70713_bf.remove(Integer.valueOf(p_82170_1_));
      if (potioneffect != null) {
         this.func_70688_c(potioneffect);
      }
   ...
   public void func_70669_a(ItemStack p_70669_1_) {
      ...
      for(int i = 0; i < 5; ++i) {
         ...
         this.field_70170_p.func_175688_a(EnumParticleTypes.ITEM_CRACK, vec31.field_72450_a, vec31.field_72448_b, vec31.field_72449_c, vec3.field_72450_a, vec3.field_72448_b + 0.05D, vec3.field_72449_c, Item.func_150891_b(p_70669_1_.func_77973_b()));
      }
   ...
   protected void func_85033_bc() {
      List<Entity> list = this.field_70170_p.func_175674_a(this, this.func_174813_aQ().func_72314_b(0.20000000298023224D, 0.0D, 0.20000000298023224D), Predicates.and(EntitySelectors.field_180132_d, new Predicate<Entity>() {
