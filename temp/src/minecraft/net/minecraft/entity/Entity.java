...
public abstract class Entity implements ICommandSender {
   ...
   protected void func_71061_d_() {
      ...
      for(int i = 0; (float)i < 1.0F + this.field_70130_N * 20.0F; ++i) {
         ...
         this.field_70170_p.func_175688_a(EnumParticleTypes.WATER_BUBBLE, this.field_70165_t + (double)f2, (double)(f1 + 1.0F), this.field_70161_v + (double)f3, this.field_70159_w, this.field_70181_x - (double)(this.field_70146_Z.nextFloat() * 0.2F), this.field_70179_y);
      }
      ...
      for(int j = 0; (float)j < 1.0F + this.field_70130_N * 20.0F; ++j) {
         ...
         this.field_70170_p.func_175688_a(EnumParticleTypes.WATER_SPLASH, this.field_70165_t + (double)f4, (double)(f1 + 1.0F), this.field_70161_v + (double)f5, this.field_70159_w, this.field_70181_x, this.field_70179_y);
      }
   ...
   public void func_70109_d(NBTTagCompound p_70109_1_) {
      try {
         p_70109_1_.func_74782_a("Pos", this.func_70087_a(this.field_70165_t, this.field_70163_u, this.field_70161_v));
         p_70109_1_.func_74782_a("Motion", this.func_70087_a(this.field_70159_w, this.field_70181_x, this.field_70179_y));
         p_70109_1_.func_74782_a("Rotation", this.func_70049_a(this.field_70177_z, this.field_70125_A));
