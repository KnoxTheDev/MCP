...
public class S26PacketMapChunkBulk implements Packet<INetHandlerPlayClient> {
   ...
   public S26PacketMapChunkBulk(List<Chunk> p_i45197_1_) {
      ...
      for(int j = 0; j < i; ++j) {
         Chunk chunk = p_i45197_1_.get(j);
         S21PacketChunkData.Extracted s21packetchunkdata$extracted = S21PacketChunkData.func_179756_a(chunk, true, this.field_149267_h, 65535);
