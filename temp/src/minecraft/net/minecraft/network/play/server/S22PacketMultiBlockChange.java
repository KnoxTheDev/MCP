...
public class S22PacketMultiBlockChange implements Packet<INetHandlerPlayClient> {
   ...
   public void func_148837_a(PacketBuffer p_148837_1_) throws IOException {
      ...
      for(int i = 0; i < this.field_179845_b.length; ++i) {
         this.field_179845_b[i] = new S22PacketMultiBlockChange.BlockUpdateData(p_148837_1_.readShort(), Block.field_176229_d.func_148745_a(p_148837_1_.func_150792_a()));
      }
