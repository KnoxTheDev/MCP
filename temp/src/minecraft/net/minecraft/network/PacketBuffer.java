...
public class PacketBuffer extends ByteBuf {
   ...
   public byte[] func_179251_a() {
      byte[] abyte = new byte[this.func_150792_a()];
   ...
   public void func_179256_a(IChatComponent p_179256_1_) throws IOException {
   ...
   public PacketBuffer func_180714_a(String p_180714_1_) {
      byte[] abyte = p_180714_1_.getBytes(Charsets.UTF_8);
