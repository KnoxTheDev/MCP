            ...
            public void run() {
               if (PlayerUsageSnooper.this.field_76478_d.func_70002_Q()) {
                  ...
                  synchronized(PlayerUsageSnooper.this.field_76476_f) {
                     ...
                     map.put("snooper_count", Integer.valueOf(PlayerUsageSnooper.this.field_76483_h++));
                     map.put("snooper_token", PlayerUsageSnooper.this.field_76480_b);
                  }

                  HttpUtil.func_151226_a(PlayerUsageSnooper.this.field_76481_c, map, true);
               }
            }
         }, 0L, 900000L);
      }
